...
a[2]:a[3].get("number")===a[4].get("number")?a[3]:!1},getFeature:function(){var a=this.get("hands"),b=[];_.each(a,function(a){b.push(a)},this);for(a=this.get("hands").length;a<MAX_HAND;a++)b.push(new PokerCardModel({number:-a,suit:4+a}));var c,d;this.isFlushStraight(b)?(a=1E4+10*b[0].get("number")+(10-b[0].get("suit")),c="flush-straight",d=50):(a=this.is4ofAKind(b))?(a=9E3+10*a.get("number")+(10-a.get("suit")),c="four-of-a-kind",d=40):(a=this.isFullHouse(b))?(a=8E3+10*a.get("number")+(10-a.get("suit")),
