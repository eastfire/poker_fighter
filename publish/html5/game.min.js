...
0,"core");for(var t=0,s=m.length;t<s;t++){var v=b._getJsListOfModule(p,m[t],e);v&&(r=r.concat(v))}r=r.concat(g);cc.loader.loadJsWithImg(r,function(c){if(c)throw Error(c);b._prepared=!0;a&&a()})}))}};cc.game._initConfig();
...
Object.defineProperty(d.prototype,"constructor",h);this.__getters__&&(d.__getters__=cc.clone(this.__getters__));this.__setters__&&(d.__setters__=cc.clone(this.__setters__));for(var k=0,m=arguments.length;k<m;++k){var p=arguments[k],r;for(r in p){var t="function"===typeof p[r],s="function"===typeof e[r],v=a.test(p[r]);b&&t&&s&&v?(h.value=ClassManager.compileSuper(p[r],r,g),Object.defineProperty(f,r,h)):t&&s&&v?(h.value=function(a,b){return function(){var c=this._super;this._super=e[a];var d=b.apply(this,
arguments);this._super=c;return d}}(r,p[r]),Object.defineProperty(f,r,h)):t?(h.value=p[r],Object.defineProperty(f,r,h)):f[r]=p[r];if(t){var u,w;if(this.__getters__&&this.__getters__[r]){var t=this.__getters__[r],n;for(n in this.__setters__)if(this.__setters__[n]===t){w=n;break}cc.defineGetterSetter(f,t,p[r],p[w]?p[w]:f[w],r,w)}if(this.__setters__&&this.__setters__[r]){t=this.__setters__[r];for(n in this.__getters__)if(this.__getters__[n]===t){u=n;break}cc.defineGetterSetter(f,t,p[u]?p[u]:f[u],p[r],
...
cc.pSubIn=function(a,b){a.x-=b.x;a.y-=b.y};cc.pAddIn=function(a,b){a.x+=b.x;a.y+=b.y};cc.pNormalizeIn=function(a){cc.pMultIn(a,1/Math.sqrt(a.x*a.x+a.y*a.y))};cc.vertexLineToPolygon=function(a,b,c,d,e){e+=d;if(!(1>=e)){b*=0.5;for(var f,g=e-1,h=d;h<e;h++){f=2*h;var k=cc.p(a[2*h],a[2*h+1]),m;if(0===h)m=cc.pPerp(cc.pNormalize(cc.pSub(k,cc.p(a[2*(h+1)],a[2*(h+1)+1]))));else if(h===g)m=cc.pPerp(cc.pNormalize(cc.pSub(cc.p(a[2*(h-1)],a[2*(h-1)+1]),k)));else{m=cc.p(a[2*(h-1)],a[2*(h-1)+1]);var p=cc.p(a[2*(h+1)],a[2*(h+1)+1]),r=cc.pNormalize(cc.pSub(p,k)),t=cc.pNormalize(cc.pSub(m,k)),s=Math.acos(cc.pDot(r,t));m=s<cc.degreesToRadians(70)?cc.pPerp(cc.pNormalize(cc.pMidpoint(r,
t))):s<cc.degreesToRadians(170)?cc.pNormalize(cc.pMidpoint(r,t)):cc.pPerp(cc.pNormalize(cc.pSub(p,m)))}m=cc.pMult(m,b);c[2*f]=k.x+m.x;c[2*f+1]=k.y+m.y;c[2*(f+1)]=k.x-m.x;c[2*(f+1)+1]=k.y-m.y}for(h=0===d?0:d-1;h<g;h++)f=2*h,a=f+2,b=cc.vertex2(c[2*f],c[2*f+1]),e=cc.vertex2(c[2*(f+1)],c[2*(f+1)+1]),f=cc.vertex2(c[2*a],c[2*a]),d=cc.vertex2(c[2*(a+1)],c[2*(a+1)+1]),b=!cc.vertexLineIntersect(b.x,b.y,d.x,d.y,e.x,e.y,f.x,f.y),!b.isSuccess&&(0>b.value||1<b.value)&&(b.isSuccess=!0),b.isSuccess&&(c[2*a]=d.x,
...
k;a[6]=b;a[7]=g;return this};b.determinant=function(){var a=this.mat,c=a[0]*a[4]*a[8]+a[1]*a[5]*a[6]+a[2]*a[3]*a[7];return c-=a[2]*a[4]*a[6]+a[0]*a[5]*a[7]+a[1]*a[3]*a[8]};b.multiply=function(a){var c=this.mat,b=a.mat;a=c[0];var g=c[1],h=c[2],k=c[3],m=c[4],p=c[5],r=c[6],t=c[7],s=c[8],v=b[0],u=b[1],w=b[2],n=b[3],A=b[4],x=b[5],B=b[6],y=b[7],b=b[8];c[0]=a*v+k*u+r*w;c[1]=g*v+m*u+t*w;c[2]=h*v+p*u+s*w;c[3]=h*v+p*u+s*w;c[4]=g*n+m*A+t*x;c[5]=h*n+p*A+s*x;c[6]=a*B+k*y+r*b;c[7]=g*B+m*y+t*b;c[8]=h*B+p*y+s*b;
...
return this};b.get=function(a,c){return this.mat[a+4*c]};b.set=function(a,c,b){this.mat[a+4*c]=b};b.swap=function(a,c,b,d){var k=this.mat,m=k[a+4*c];k[a+4*c]=k[b+4*d];k[b+4*d]=m};a.math.Matrix4._gaussj=function(a,c){var b,d=0,k=0,m,p,r,t,s=[0,0,0,0],v=[0,0,0,0],u=[0,0,0,0];for(b=0;4>b;b++){for(m=t=0;4>m;m++)if(1!==u[m])for(p=0;4>p;p++)0===u[p]&&(r=Math.abs(a.get(m,p)),r>=t&&(t=r,k=m,d=p));++u[d];if(k!==d){for(m=0;4>m;m++)a.swap(k,m,d,m);for(m=0;4>m;m++)c.swap(k,m,d,m)}v[b]=k;s[b]=d;if(0===a.get(d,
d))return!1;p=1/a.get(d,d);a.set(d,d,1);for(m=0;4>m;m++)a.set(d,m,a.get(d,m)*p);for(m=0;4>m;m++)c.set(d,m,c.get(d,m)*p);for(p=0;4>p;p++)if(p!==d){r=a.get(p,d);a.set(p,d,0);for(m=0;4>m;m++)a.set(p,m,a.get(p,m)-a.get(d,m)*r);for(m=0;4>m;m++)c.set(p,m,a.get(p,m)-c.get(d,m)*r)}}for(m=3;0<=m;m--)if(v[m]!==s[m])for(p=0;4>p;p++)a.swap(p,v[m],p,s[m]);return!0};var c=(new a.math.Matrix4).identity();a.kmMat4Inverse=function(b,d){var g=new a.math.Matrix4(d),h=new a.math.Matrix4(c);if(!1===a.math.Matrix4._gaussj(g,
h))return null;b.assignFrom(g);return b};b.inverse=function(){var b=new a.math.Matrix4(this),d=new a.math.Matrix4(c);return!1===a.math.Matrix4._gaussj(b,d)?null:b};b.isIdentity=function(){var a=this.mat;return 1===a[0]&&0===a[1]&&0===a[2]&&0===a[3]&&0===a[4]&&1===a[5]&&0===a[6]&&0===a[7]&&0===a[8]&&0===a[9]&&1===a[10]&&0===a[11]&&0===a[12]&&0===a[13]&&0===a[14]&&1===a[15]};b.transpose=function(){var a=this.mat,c=a[1],b=a[2],d=a[3],k=a[6],m=a[7],p=a[8],r=a[9],t=a[11],s=a[12],v=a[13],u=a[14];a[1]=a[4];
a[2]=p;a[3]=s;a[4]=c;a[6]=r;a[7]=v;a[8]=b;a[9]=k;a[11]=u;a[12]=d;a[13]=m;a[14]=t;return this};a.kmMat4Multiply=function(a,c,b){var d=a.mat,k=c.mat,m=b.mat;b=k[0];c=k[1];var p=k[2],r=k[3],t=k[4],s=k[5],v=k[6],u=k[7],w=k[8],n=k[9],A=k[10],x=k[11],B=k[12],y=k[13],G=k[14],k=k[15],E=m[0],D=m[1],z=m[2],I=m[3],F=m[4],K=m[5],J=m[6],H=m[7],C=m[8],M=m[9],L=m[10],N=m[11],O=m[12],P=m[13],Q=m[14],m=m[15];d[0]=E*b+D*t+z*w+I*B;d[1]=E*c+D*s+z*n+I*y;d[2]=E*p+D*v+z*A+I*G;d[3]=E*r+D*u+z*x+I*k;d[4]=F*b+K*t+J*w+H*B;d[5]=
F*c+K*s+J*n+H*y;d[6]=F*p+K*v+J*A+H*G;d[7]=F*r+K*u+J*x+H*k;d[8]=C*b+M*t+L*w+N*B;d[9]=C*c+M*s+L*n+N*y;d[10]=C*p+M*v+L*A+N*G;d[11]=C*r+M*u+L*x+N*k;d[12]=O*b+P*t+Q*w+m*B;d[13]=O*c+P*s+Q*n+m*y;d[14]=O*p+P*v+Q*A+m*G;d[15]=O*r+P*u+Q*x+m*k;return a};b.multiply=function(a){var c=this.mat,b=a.mat;a=c[0];var d=c[1],k=c[2],m=c[3],p=c[4],r=c[5],t=c[6],s=c[7],v=c[8],u=c[9],w=c[10],n=c[11],A=c[12],x=c[13],B=c[14],y=c[15],G=b[0],E=b[1],D=b[2],z=b[3],I=b[4],F=b[5],K=b[6],J=b[7],H=b[8],C=b[9],M=b[10],L=b[11],N=b[12],
O=b[13],P=b[14],b=b[15];c[0]=G*a+E*p+D*v+z*A;c[1]=G*d+E*r+D*u+z*x;c[2]=G*k+E*t+D*w+z*B;c[3]=G*m+E*s+D*n+z*y;c[4]=I*a+F*p+K*v+J*A;c[5]=I*d+F*r+K*u+J*x;c[6]=I*k+F*t+K*w+J*B;c[7]=I*m+F*s+K*n+J*y;c[8]=H*a+C*p+M*v+L*A;c[9]=H*d+C*r+M*u+L*x;c[10]=H*k+C*t+M*w+L*B;c[11]=H*m+C*s+M*n+L*y;c[12]=N*a+O*p+P*v+b*A;c[13]=N*d+O*r+P*u+b*x;c[14]=N*k+O*t+P*w+b*B;c[15]=N*m+O*s+P*n+b*y;return this};a.getMat4MultiplyValue=function(a,c){var b=a.mat,d=c.mat,k=new Float32Array(16);k[0]=b[0]*d[0]+b[4]*d[1]+b[8]*d[2]+b[12]*d[3];
k[1]=b[1]*d[0]+b[5]*d[1]+b[9]*d[2]+b[13]*d[3];k[2]=b[2]*d[0]+b[6]*d[1]+b[10]*d[2]+b[14]*d[3];k[3]=b[3]*d[0]+b[7]*d[1]+b[11]*d[2]+b[15]*d[3];k[4]=b[0]*d[4]+b[4]*d[5]+b[8]*d[6]+b[12]*d[7];k[5]=b[1]*d[4]+b[5]*d[5]+b[9]*d[6]+b[13]*d[7];k[6]=b[2]*d[4]+b[6]*d[5]+b[10]*d[6]+b[14]*d[7];k[7]=b[3]*d[4]+b[7]*d[5]+b[11]*d[6]+b[15]*d[7];k[8]=b[0]*d[8]+b[4]*d[9]+b[8]*d[10]+b[12]*d[11];k[9]=b[1]*d[8]+b[5]*d[9]+b[9]*d[10]+b[13]*d[11];k[10]=b[2]*d[8]+b[6]*d[9]+b[10]*d[10]+b[14]*d[11];k[11]=b[3]*d[8]+b[7]*d[9]+b[11]*
d[10]+b[15]*d[11];k[12]=b[0]*d[12]+b[4]*d[13]+b[8]*d[14]+b[12]*d[15];k[13]=b[1]*d[12]+b[5]*d[13]+b[9]*d[14]+b[13]*d[15];k[14]=b[2]*d[12]+b[6]*d[13]+b[10]*d[14]+b[14]*d[15];k[15]=b[3]*d[12]+b[7]*d[13]+b[11]*d[14]+b[15]*d[15];return k};a.kmMat4Assign=function(c,b){if(c===b)return a.log("cc.kmMat4Assign(): pOut equals pIn"),c;var d=c.mat,h=b.mat;d[0]=h[0];d[1]=h[1];d[2]=h[2];d[3]=h[3];d[4]=h[4];d[5]=h[5];d[6]=h[6];d[7]=h[7];d[8]=h[8];d[9]=h[9];d[10]=h[10];d[11]=h[11];d[12]=h[12];d[13]=h[13];d[14]=h[14];
d[15]=h[15];return c};b.assignFrom=function(c){if(this===c)return a.log("cc.mat.Matrix4.assignFrom(): mat4 equals current matrix"),this;var b=this.mat;c=c.mat;b[0]=c[0];b[1]=c[1];b[2]=c[2];b[3]=c[3];b[4]=c[4];b[5]=c[5];b[6]=c[6];b[7]=c[7];b[8]=c[8];b[9]=c[9];b[10]=c[10];b[11]=c[11];b[12]=c[12];b[13]=c[13];b[14]=c[14];b[15]=c[15];return this};b.equals=function(c){if(this===c)return a.log("cc.kmMat4AreEqual(): pMat1 and pMat2 are same object."),!0;var b=this.mat;c=c.mat;for(var d=a.math.EPSILON,h=0;16>
h;h++)if(!(b[h]+d>c[h]&&b[h]-d<c[h]))return!1;return!0};a.math.Matrix4.createByRotationX=function(c,b){b=b||new a.math.Matrix4;var d=b.mat;d[0]=1;d[3]=d[2]=d[1]=0;d[4]=0;d[5]=Math.cos(c);d[6]=Math.sin(c);d[7]=0;d[8]=0;d[9]=-Math.sin(c);d[10]=Math.cos(c);d[11]=0;d[14]=d[13]=d[12]=0;d[15]=1;return b};a.math.Matrix4.createByRotationY=function(c,b){b=b||new a.math.Matrix4;var d=b.mat;d[0]=Math.cos(c);d[1]=0;d[2]=-Math.sin(c);d[3]=0;d[7]=d[6]=d[4]=0;d[5]=1;d[8]=Math.sin(c);d[9]=0;d[10]=Math.cos(c);d[11]=
0;d[14]=d[13]=d[12]=0;d[15]=1;return b};a.math.Matrix4.createByRotationZ=function(c,b){b=b||new a.math.Matrix4;var d=b.mat;d[0]=Math.cos(c);d[1]=Math.sin(c);d[3]=d[2]=0;d[4]=-Math.sin(c);d[5]=Math.cos(c);d[7]=d[6]=0;d[11]=d[9]=d[8]=0;d[10]=1;d[14]=d[13]=d[12]=0;d[15]=1;return b};a.math.Matrix4.createByPitchYawRoll=function(c,b,d,h){h=h||new a.math.Matrix4;var k=Math.cos(c);c=Math.sin(c);var m=Math.cos(b);b=Math.sin(b);var p=Math.cos(d);d=Math.sin(d);var r=c*b,t=k*b,s=h.mat;s[0]=m*p;s[4]=m*d;s[8]=
-b;s[1]=r*p-k*d;s[5]=r*d+k*p;s[9]=c*m;s[2]=t*p+c*d;s[6]=t*d-c*p;s[10]=k*m;s[3]=s[7]=s[11]=0;s[15]=1;return h};a.math.Matrix4.createByQuaternion=function(c,b){b=b||new a.math.Matrix4;var d=b.mat;d[0]=1-2*(c.y*c.y+c.z*c.z);d[1]=2*(c.x*c.y+c.z*c.w);d[2]=2*(c.x*c.z-c.y*c.w);d[3]=0;d[4]=2*(c.x*c.y-c.z*c.w);d[5]=1-2*(c.x*c.x+c.z*c.z);d[6]=2*(c.z*c.y+c.x*c.w);d[7]=0;d[8]=2*(c.x*c.z+c.y*c.w);d[9]=2*(c.y*c.z-c.x*c.w);d[10]=1-2*(c.x*c.x+c.y*c.y);d[11]=0;d[14]=d[13]=d[12]=0;d[15]=1;return b};a.math.Matrix4.createByRotationTranslation=
function(c,b,d){d=d||new a.math.Matrix4;var h=d.mat;c=c.mat;h[0]=c[0];h[1]=c[1];h[2]=c[2];h[3]=0;h[4]=c[3];h[5]=c[4];h[6]=c[5];h[7]=0;h[8]=c[6];h[9]=c[7];h[10]=c[8];h[11]=0;h[12]=b.x;h[13]=b.y;h[14]=b.z;h[15]=1;return d};a.math.Matrix4.createByScale=function(c,b,d,h){h=h||new a.math.Matrix4;var k=h.mat;k[0]=c;k[5]=b;k[10]=d;k[15]=1;k[1]=k[2]=k[3]=k[4]=k[6]=k[7]=k[8]=k[9]=k[11]=k[12]=k[13]=k[14]=0;return h};a.kmMat4Translation=function(a,c,b,d){a.mat[0]=a.mat[5]=a.mat[10]=a.mat[15]=1;a.mat[1]=a.mat[2]=
a.mat[3]=a.mat[4]=a.mat[6]=a.mat[7]=a.mat[8]=a.mat[9]=a.mat[11]=0;a.mat[12]=c;a.mat[13]=b;a.mat[14]=d;return a};a.math.Matrix4.createByTranslation=function(c,b,d,h){h=h||new a.math.Matrix4;h.identity();h.mat[12]=c;h.mat[13]=b;h.mat[14]=d;return h};b.getUpVec3=function(){var c=this.mat;return(new a.math.Vec3(c[4],c[5],c[6])).normalize()};b.getRightVec3=function(){var c=this.mat;return(new a.math.Vec3(c[0],c[1],c[2])).normalize()};b.getForwardVec3=function(){var c=this.mat;return(new a.math.Vec3(c[8],
c[9],c[10])).normalize()};a.kmMat4PerspectiveProjection=function(c,b,d,h,k){var m=a.degreesToRadians(b/2);b=k-h;var p=Math.sin(m);if(0===b||0===p||0===d)return null;m=Math.cos(m)/p;c.identity();c.mat[0]=m/d;c.mat[5]=m;c.mat[10]=-(k+h)/b;c.mat[11]=-1;c.mat[14]=-2*h*k/b;c.mat[15]=0;return c};a.math.Matrix4.createPerspectiveProjection=function(c,b,d,h){var k=a.degreesToRadians(c/2);c=h-d;var m=Math.sin(k);if(0===c||0===m||0===b)return null;var k=Math.cos(k)/m,m=new a.math.Matrix4,p=m.mat;m.identity();
p[0]=k/b;p[5]=k;p[10]=-(h+d)/c;p[11]=-1;p[14]=-2*d*h/c;p[15]=0;return m};a.kmMat4OrthographicProjection=function(a,c,b,d,k,m,p){a.identity();a.mat[0]=2/(b-c);a.mat[5]=2/(k-d);a.mat[10]=-2/(p-m);a.mat[12]=-((b+c)/(b-c));a.mat[13]=-((k+d)/(k-d));a.mat[14]=-((p+m)/(p-m));return a};a.math.Matrix4.createOrthographicProjection=function(c,b,d,h,k,m){var p=new a.math.Matrix4,r=p.mat;p.identity();r[0]=2/(b-c);r[5]=2/(h-d);r[10]=-2/(m-k);r[12]=-((b+c)/(b-c));r[13]=-((h+d)/(h-d));r[14]=-((m+k)/(m-k));return p};
a.kmMat4LookAt=function(c,b,d,h){d=new a.math.Vec3(d);var k=new a.math.Vec3(h);d.subtract(b);d.normalize();k.normalize();h=new a.math.Vec3(d);h.cross(k);h.normalize();k=new a.math.Vec3(h);k.cross(d);h.normalize();c.identity();c.mat[0]=h.x;c.mat[4]=h.y;c.mat[8]=h.z;c.mat[1]=k.x;c.mat[5]=k.y;c.mat[9]=k.z;c.mat[2]=-d.x;c.mat[6]=-d.y;c.mat[10]=-d.z;b=a.math.Matrix4.createByTranslation(-b.x,-b.y,-b.z);c.multiply(b);return c};var d=new a.math.Matrix4;b.lookAt=function(c,b,g){b=new a.math.Vec3(b);var h=
new a.math.Vec3(g);g=this.mat;b.subtract(c);b.normalize();h.normalize();var k=new a.math.Vec3(b);k.cross(h);k.normalize();h=new a.math.Vec3(k);h.cross(b);k.normalize();this.identity();g[0]=k.x;g[4]=k.y;g[8]=k.z;g[1]=h.x;g[5]=h.y;g[9]=h.z;g[2]=-b.x;g[6]=-b.y;g[10]=-b.z;d=a.math.Matrix4.createByTranslation(-c.x,-c.y,-c.z,d);this.multiply(d);return this};a.kmMat4RotationAxisAngle=function(c,b,d){var h=Math.cos(d);d=Math.sin(d);b=new a.math.Vec3(b);b.normalize();c.mat[0]=h+b.x*b.x*(1-h);c.mat[1]=b.z*
d+b.y*b.x*(1-h);c.mat[2]=-b.y*d+b.z*b.x*(1-h);c.mat[3]=0;c.mat[4]=-b.z*d+b.x*b.y*(1-h);c.mat[5]=h+b.y*b.y*(1-h);c.mat[6]=b.x*d+b.z*b.y*(1-h);c.mat[7]=0;c.mat[8]=b.y*d+b.x*b.z*(1-h);c.mat[9]=-b.x*d+b.y*b.z*(1-h);c.mat[10]=h+b.z*b.z*(1-h);c.mat[11]=0;c.mat[12]=0;c.mat[13]=0;c.mat[14]=0;c.mat[15]=1;return c};a.math.Matrix4.createByAxisAndAngle=function(c,b,d){d=d||new a.math.Matrix4;var h=this.mat,k=Math.cos(b);b=Math.sin(b);c=new a.math.Vec3(c);c.normalize();h[0]=k+c.x*c.x*(1-k);h[1]=c.z*b+c.y*c.x*
(1-k);h[2]=-c.y*b+c.z*c.x*(1-k);h[3]=0;h[4]=-c.z*b+c.x*c.y*(1-k);h[5]=k+c.y*c.y*(1-k);h[6]=c.x*b+c.z*c.y*(1-k);h[7]=0;h[8]=c.y*b+c.x*c.z*(1-k);h[9]=-c.x*b+c.y*c.z*(1-k);h[10]=k+c.z*c.z*(1-k);h[11]=0;h[12]=h[13]=h[14]=0;h[15]=1;return d};b.extractRotation=function(){var c=new a.math.Matrix3,b=this.mat,d=c.mat;d[0]=b[0];d[1]=b[1];d[2]=b[2];d[3]=b[4];d[4]=b[5];d[5]=b[6];d[6]=b[8];d[7]=b[9];d[8]=b[10];return c};b.extractPlane=function(c){var b=new a.math.Plane,d=this.mat;switch(c){case a.math.Plane.RIGHT:b.a=
d[3]-d[0];b.b=d[7]-d[4];b.c=d[11]-d[8];b.d=d[15]-d[12];break;case a.math.Plane.LEFT:b.a=d[3]+d[0];b.b=d[7]+d[4];b.c=d[11]+d[8];b.d=d[15]+d[12];break;case a.math.Plane.BOTTOM:b.a=d[3]+d[1];b.b=d[7]+d[5];b.c=d[11]+d[9];b.d=d[15]+d[13];break;case a.math.Plane.TOP:b.a=d[3]-d[1];b.b=d[7]-d[5];b.c=d[11]-d[9];b.d=d[15]-d[13];break;case a.math.Plane.FAR:b.a=d[3]-d[2];b.b=d[7]-d[6];b.c=d[11]-d[10];b.d=d[15]-d[14];break;case a.math.Plane.NEAR:b.a=d[3]+d[2];b.b=d[7]+d[6];b.c=d[11]+d[10];b.d=d[15]+d[14];break;
default:a.log("cc.math.Matrix4.extractPlane: Invalid plane index")}c=Math.sqrt(b.a*b.a+b.b*b.b+b.c*b.c);b.a/=c;b.b/=c;b.c/=c;b.d/=c;return b};b.toAxisAndAngle=function(){var c=this.extractRotation();return a.math.Quaternion.rotationMatrix(c).toAxisAndAngle()}})(cc);(function(a){a.math.Plane=function(a,b,e,f){a&&void 0===b?(this.a=a.a,this.b=a.b,this.c=a.c,this.d=a.d):(this.a=a||0,this.b=b||0,this.c=e||0,this.d=f||0)};a.kmPlane=a.math.Plane;var b=a.math.Plane.prototype;a.math.Plane.LEFT=0;a.math.Plane.RIGHT=1;a.math.Plane.BOTTOM=2;a.math.Plane.TOP=3;a.math.Plane.NEAR=4;a.math.Plane.FAR=5;a.math.Plane.POINT_INFRONT_OF_PLANE=0;a.math.Plane.POINT_BEHIND_PLANE=1;a.math.Plane.POINT_ON_PLANE=2;b.dot=function(a){return this.a*a.x+this.b*a.y+this.c*a.z+this.d*a.w};b.dotCoord=
...
function(c,b,e){var f,g,h,k,m;f=a.degreesToRadians(b)/2;g=a.degreesToRadians(c)/2;h=a.degreesToRadians(e)/2;e=Math.cos(f);c=Math.cos(g);b=Math.cos(h);f=Math.sin(f);g=Math.sin(g);h=Math.sin(h);k=c*b;m=g*h;var p=new a.math.Quaternion;p.w=e*k+f*m;p.x=f*k-e*m;p.y=e*g*b+f*c*h;p.z=e*c*h-f*g*b;p.normalize();return p};b.slerp=function(c,b){if(this.x===c.x&&this.y===c.y&&this.z===c.z&&this.w===c.w)return this;var e=this.dot(c),f=Math.acos(e),g=Math.sqrt(1-a.math.square(e)),e=Math.sin(b*f)/g,f=Math.sin((1-
b)*f)/g,g=new a.math.Quaternion(c);this.scale(f);g.scale(e);this.add(g);return this};b.toAxisAndAngle=function(){var b,d,e=new a.math.Vec3;b=Math.acos(this.w);d=Math.sqrt(a.math.square(this.x)+a.math.square(this.y)+a.math.square(this.z));d>-a.math.EPSILON&&d<a.math.EPSILON||d<2*Math.PI+a.math.EPSILON&&d>2*Math.PI-a.math.EPSILON?(b=0,e.x=0,e.y=0,e.z=1):(b*=2,e.x=this.x/d,e.y=this.y/d,e.z=this.z/d,e.normalize());return{axis:e,angle:b}};b.scale=function(a){this.x*=a;this.y*=a;this.z*=a;this.w*=a;return this};
...
window.mozAudioContext);a.DELAY_CREATE_CTX&&setTimeout(function(){f=new (window.AudioContext||window.webkitAudioContext||window.mozAudioContext)},0)}}catch(g){b=!1,cc.log("browser don't support web audio")}var h={cache:{},load:function(c,d,g,k){if(0===e.length)return k("can not support audio!");cc.loader.audioPath&&(c=cc.path.join(cc.loader.audioPath,c));var s=cc.path.extname(c),v=[s];for(g=0;g<e.length;g++)s!==e[g]&&v.push(e[g]);var u;if(h.cache[d])return k(null,h.cache[d]);if(b)try{var w=f.createGain();
w.gain.value=1;w.connect(f.destination);u=new cc.Audio(f,w,c);a.NEED_MANUAL_LOOP&&(u._manualLoop=!0)}catch(n){b=!1,cc.log("browser don't support web audio"),u=new cc.Audio(null,null,c)}else u=new cc.Audio(null,null,c);this.loadAudioFromExtList(c,v,u,k);h.cache[d]=u},loadAudioFromExtList:function(c,d,g,k){if(0===d.length){var s="can not found the resource of audio! Last match url is : ",s=s+c.replace(/\.(.*)?$/,"(");e.forEach(function(a){s+=a+"|"});s=s.replace(/\|$/,")");return k({status:520,errorMessage:s},
null)}c=cc.path.changeExtname(c,d.splice(0,1));if(b){a.webAudioCallback&&a.webAudioCallback(c);var v=new XMLHttpRequest;v.open("GET",c,!0);v.responseType="arraybuffer";v.onload=function(){f.decodeAudioData(v.response,function(a){g.setBuffer(a);k(null,g)},function(){h.loadAudioFromExtList(c,d,g,k)})};v.onerror=function(){k({status:520,errorMessage:s},null)};v.send()}else{var u=document.createElement("audio"),w=!1,n=!1,A=setTimeout(function(){0===u.readyState?y():(n=!0,u.pause(),document.body.removeChild(u),
k("audio load timeout : "+c,g))},1E4),x=function(){if(!w){u.pause();try{u.currentTime=0,u.volume=1}catch(a){}document.body.removeChild(u);g.setElement(u);u.removeEventListener("canplaythrough",x,!1);u.removeEventListener("error",B,!1);u.removeEventListener("emptied",y,!1);!n&&k(null,g);w=!0;clearTimeout(A)}},B=function(){w&&(u.pause(),document.body.removeChild(u),u.removeEventListener("canplaythrough",x,!1),u.removeEventListener("error",B,!1),u.removeEventListener("emptied",y,!1),!n&&h.loadAudioFromExtList(c,
d,g,k),w=!0,clearTimeout(A))},y=function(){n=!0;x();k(null,g)};cc._addEventListener(u,"canplaythrough",x,!1);cc._addEventListener(u,"error",B,!1);a.USE_EMPTIED_EVENT&&cc._addEventListener(u,"emptied",y,!1);u.src=c;document.body.appendChild(u);u.volume=0;u.play()}}};cc.loader.register(["mp3","ogg","wav","mp4","m4a"],h);cc.audioEngine={_currMusic:null,_musicVolume:1,features:a,willPlayMusic:function(){return!1},playMusic:function(a,b){var c=this._currMusic;c&&c.src!==a&&c.getPlaying()&&c.stop();c=h.cache[a];
...
this._children;if(m&&0<m.length)for(b=0,k=m.length;b<k;b++)d>=a.length||!(g=a[d])||(h=m[b].height,e=e>=h||isNaN(h)?e:h,++f,f>=g&&(c+=e+5,e=f=0,++d));var p=cc.director.getWinSize(),r=g=e=d=0,t=0,c=c/2;if(m&&0<m.length)for(b=0,k=m.length;b<k;b++){var s=m[b];0===g&&(g=a[d],t=r=p.width/(1+g));h=s._getHeight();e=e>=h||isNaN(h)?e:h;s.setPosition(t-p.width/2,c-h/2);t+=r;++f;f>=g&&(c-=e+5,e=g=f=0,++d)}},alignItemsInRows:function(){0<arguments.length&&null==arguments[arguments.length-1]&&cc.log("parameters should not be ending with null in Javascript");
var a=[],b;for(b=0;b<arguments.length;b++)a.push(arguments[b]);var c=[],d=[],e=-10,f=-5,g=0,h=0,k=0,m,p,r,t,s=this._children;if(s&&0<s.length)for(b=0,r=s.length;b<r;b++)(p=s[b],g>=a.length||!(m=a[g]))||(t=p.width,h=h>=t||isNaN(t)?h:t,f+=p.height+5,++k,k>=m&&(c.push(h),d.push(f),e+=h+10,h=k=0,f=-5,++g));f=cc.director.getWinSize();m=h=g=0;var e=-e/2,v=0;if(s&&0<s.length)for(b=0,r=s.length;b<r;b++)p=s[b],0===m&&(m=a[g],v=d[g]),t=p._getWidth(),h=h>=t||isNaN(t)?h:t,p.setPosition(e+c[g]/2,v-f.height/2),
...
f=c.rect();f.x=0;f.y=0;if(cc.rectContainsPoint(f,e))return c}return null}});_p=cc.Menu.prototype;cc.Menu.create=function(a){var b=arguments.length;0<b&&null==arguments[b-1]&&cc.log("parameters should not be ending with null in Javascript");return 0===b?new cc.Menu:1===b?new cc.Menu(a):new cc.Menu(Array.prototype.slice.call(arguments,0))};(function(){function a(a){return function(b,c,d,e){c=A(c,e,4);var f=!z(b)&&n.keys(b),g=(f||b).length,h=0<a?0:g-1;3>arguments.length&&(d=b[f?f[h]:h],h+=a);for(var k=c,m=d;0<=h&&g>h;h+=a)var C=f?f[h]:h,m=k(m,b[C],C,b);return m}}function b(a){return function(b,c,d){c=x(c,d);d=D(b);for(var e=0<a?0:d-1;0<=e&&d>e;e+=a)if(c(b[e],e,b))return e;return-1}}function c(a,b,c){return function(d,e,f){var g=0,h=D(d);if("number"==typeof f)0<a?g=0<=f?f:Math.max(f+h,g):h=0<=f?Math.min(f+1,h):f+h+1;else if(c&&f&&h)return f=
c(d,e),d[f]===e?f:-1;if(e!==e)return f=b(m.call(d,g,h),n.isNaN),0<=f?f+g:-1;for(f=0<a?g:h-1;0<=f&&h>f;f+=a)if(d[f]===e)return f;return-1}}function d(a,b){var c=H.length,d=a.constructor,d=n.isFunction(d)&&d.prototype||h,e="constructor";for(n.has(a,e)&&!n.contains(b,e)&&b.push(e);c--;)e=H[c],e in a&&a[e]!==d[e]&&!n.contains(b,e)&&b.push(e)}var e=this,f=e._,g=Array.prototype,h=Object.prototype,k=g.push,m=g.slice,p=h.toString,r=h.hasOwnProperty,t=Array.isArray,s=Object.keys,v=Function.prototype.bind,
u=Object.create,w=function(){},n=function(a){return a instanceof n?a:this instanceof n?void(this._wrapped=a):new n(a)};"undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=n),exports._=n):e._=n;n.VERSION="1.8.3";var A=function(a,b,c){if(void 0===b)return a;switch(null==c?3:c){case 1:return function(c){return a.call(b,c)};case 2:return function(c,d){return a.call(b,c,d)};case 3:return function(c,d,e){return a.call(b,c,d,e)};case 4:return function(c,d,e,f){return a.call(b,
c,d,e,f)}}return function(){return a.apply(b,arguments)}},x=function(a,b,c){return null==a?n.identity:n.isFunction(a)?A(a,b,c):n.isObject(a)?n.matcher(a):n.property(a)};n.iteratee=function(a,b){return x(a,b,1/0)};var B=function(a,b){return function(c){var d=arguments.length;if(2>d||null==c)return c;for(var e=1;d>e;e++)for(var f=arguments[e],g=a(f),h=g.length,k=0;h>k;k++){var m=g[k];b&&void 0!==c[m]||(c[m]=f[m])}return c}},y=function(a){if(!n.isObject(a))return{};if(u)return u(a);w.prototype=a;a=new w;
return w.prototype=null,a},G=function(a){return function(b){return null==b?void 0:b[a]}},E=Math.pow(2,53)-1,D=G("length"),z=function(a){a=D(a);return"number"==typeof a&&0<=a&&E>=a};n.each=n.forEach=function(a,b,c){b=A(b,c);var d;if(z(a))for(c=0,d=a.length;d>c;c++)b(a[c],c,a);else{var e=n.keys(a);c=0;for(d=e.length;d>c;c++)b(a[e[c]],e[c],a)}return a};n.map=n.collect=function(a,b,c){b=x(b,c);c=!z(a)&&n.keys(a);for(var d=(c||a).length,e=Array(d),f=0;d>f;f++){var g=c?c[f]:f;e[f]=b(a[g],g,a)}return e};
n.reduce=n.foldl=n.inject=a(1);n.reduceRight=n.foldr=a(-1);n.find=n.detect=function(a,b,c){var d;return d=z(a)?n.findIndex(a,b,c):n.findKey(a,b,c),void 0!==d&&-1!==d?a[d]:void 0};n.filter=n.select=function(a,b,c){var d=[];return b=x(b,c),n.each(a,function(a,c,e){b(a,c,e)&&d.push(a)}),d};n.reject=function(a,b,c){return n.filter(a,n.negate(x(b)),c)};n.every=n.all=function(a,b,c){b=x(b,c);c=!z(a)&&n.keys(a);for(var d=(c||a).length,e=0;d>e;e++){var f=c?c[e]:e;if(!b(a[f],f,a))return!1}return!0};n.some=
n.any=function(a,b,c){b=x(b,c);c=!z(a)&&n.keys(a);for(var d=(c||a).length,e=0;d>e;e++){var f=c?c[e]:e;if(b(a[f],f,a))return!0}return!1};n.contains=n.includes=n.include=function(a,b,c,d){return z(a)||(a=n.values(a)),("number"!=typeof c||d)&&(c=0),0<=n.indexOf(a,b,c)};n.invoke=function(a,b){var c=m.call(arguments,2),d=n.isFunction(b);return n.map(a,function(a){var e=d?b:a[b];return null==e?e:e.apply(a,c)})};n.pluck=function(a,b){return n.map(a,n.property(b))};n.where=function(a,b){return n.filter(a,
n.matcher(b))};n.findWhere=function(a,b){return n.find(a,n.matcher(b))};n.max=function(a,b,c){var d,e=-1/0,f=-1/0;if(null==b&&null!=a){a=z(a)?a:n.values(a);for(var g=0,h=a.length;h>g;g++)c=a[g],c>e&&(e=c)}else b=x(b,c),n.each(a,function(a,c,g){d=b(a,c,g);(d>f||d===-1/0&&e===-1/0)&&(e=a,f=d)});return e};n.min=function(a,b,c){var d,e=1/0,f=1/0;if(null==b&&null!=a){a=z(a)?a:n.values(a);for(var g=0,h=a.length;h>g;g++)c=a[g],e>c&&(e=c)}else b=x(b,c),n.each(a,function(a,c,g){d=b(a,c,g);(f>d||1/0===d&&1/
0===e)&&(e=a,f=d)});return e};n.shuffle=function(a){for(var b=z(a)?a:n.values(a),c=b.length,d=Array(c),e=0;c>e;e++)a=n.random(0,e),a!==e&&(d[e]=d[a]),d[a]=b[e];return d};n.sample=function(a,b,c){return null==b||c?(z(a)||(a=n.values(a)),a[n.random(a.length-1)]):n.shuffle(a).slice(0,Math.max(0,b))};n.sortBy=function(a,b,c){return b=x(b,c),n.pluck(n.map(a,function(a,c,d){return{value:a,index:c,criteria:b(a,c,d)}}).sort(function(a,b){var c=a.criteria,d=b.criteria;if(c!==d){if(c>d||void 0===c)return 1;
if(d>c||void 0===d)return-1}return a.index-b.index}),"value")};var I=function(a){return function(b,c,d){var e={};return c=x(c,d),n.each(b,function(d,f){var g=c(d,f,b);a(e,d,g)}),e}};n.groupBy=I(function(a,b,c){n.has(a,c)?a[c].push(b):a[c]=[b]});n.indexBy=I(function(a,b,c){a[c]=b});n.countBy=I(function(a,b,c){n.has(a,c)?a[c]++:a[c]=1});n.toArray=function(a){return a?n.isArray(a)?m.call(a):z(a)?n.map(a,n.identity):n.values(a):[]};n.size=function(a){return null==a?0:z(a)?a.length:n.keys(a).length};n.partition=
function(a,b,c){b=x(b,c);var d=[],e=[];return n.each(a,function(a,c,f){(b(a,c,f)?d:e).push(a)}),[d,e]};n.first=n.head=n.take=function(a,b,c){return null==a?void 0:null==b||c?a[0]:n.initial(a,a.length-b)};n.initial=function(a,b,c){return m.call(a,0,Math.max(0,a.length-(null==b||c?1:b)))};n.last=function(a,b,c){return null==a?void 0:null==b||c?a[a.length-1]:n.rest(a,Math.max(0,a.length-b))};n.rest=n.tail=n.drop=function(a,b,c){return m.call(a,null==b||c?1:b)};n.compact=function(a){return n.filter(a,
n.identity)};var F=function(a,b,c,d){var e=[],f=0;d=d||0;for(var g=D(a);g>d;d++){var h=a[d];if(z(h)&&(n.isArray(h)||n.isArguments(h))){b||(h=F(h,b,c));var k=0,m=h.length;for(e.length+=m;m>k;)e[f++]=h[k++]}else c||(e[f++]=h)}return e};n.flatten=function(a,b){return F(a,b,!1)};n.without=function(a){return n.difference(a,m.call(arguments,1))};n.uniq=n.unique=function(a,b,c,d){n.isBoolean(b)||(d=c,c=b,b=!1);null!=c&&(c=x(c,d));d=[];for(var e=[],f=0,g=D(a);g>f;f++){var h=a[f],k=c?c(h,f,a):h;b?(f&&e===
k||d.push(h),e=k):c?n.contains(e,k)||(e.push(k),d.push(h)):n.contains(d,h)||d.push(h)}return d};n.union=function(){return n.uniq(F(arguments,!0,!0))};n.intersection=function(a){for(var b=[],c=arguments.length,d=0,e=D(a);e>d;d++){var f=a[d];if(!n.contains(b,f)){for(var g=1;c>g&&n.contains(arguments[g],f);g++);g===c&&b.push(f)}}return b};n.difference=function(a){var b=F(arguments,!0,!0,1);return n.filter(a,function(a){return!n.contains(b,a)})};n.zip=function(){return n.unzip(arguments)};n.unzip=function(a){for(var b=
a&&n.max(a,D).length||0,c=Array(b),d=0;b>d;d++)c[d]=n.pluck(a,d);return c};n.object=function(a,b){for(var c={},d=0,e=D(a);e>d;d++)b?c[a[d]]=b[d]:c[a[d][0]]=a[d][1];return c};n.findIndex=b(1);n.findLastIndex=b(-1);n.sortedIndex=function(a,b,c,d){c=x(c,d,1);b=c(b);d=0;for(var e=D(a);e>d;){var f=Math.floor((d+e)/2);c(a[f])<b?d=f+1:e=f}return d};n.indexOf=c(1,n.findIndex,n.sortedIndex);n.lastIndexOf=c(-1,n.findLastIndex);n.range=function(a,b,c){null==b&&(b=a||0,a=0);c=c||1;b=Math.max(Math.ceil((b-a)/
c),0);for(var d=Array(b),e=0;b>e;e++,a+=c)d[e]=a;return d};var K=function(a,b,c,d,e){if(!(d instanceof b))return a.apply(c,e);b=y(a.prototype);a=a.apply(b,e);return n.isObject(a)?a:b};n.bind=function(a,b){if(v&&a.bind===v)return v.apply(a,m.call(arguments,1));if(!n.isFunction(a))throw new TypeError("Bind must be called on a function");var c=m.call(arguments,2),d=function(){return K(a,d,b,this,c.concat(m.call(arguments)))};return d};n.partial=function(a){var b=m.call(arguments,1),c=function(){for(var d=
0,e=b.length,f=Array(e),g=0;e>g;g++)f[g]=b[g]===n?arguments[d++]:b[g];for(;d<arguments.length;)f.push(arguments[d++]);return K(a,c,this,this,f)};return c};n.bindAll=function(a){var b,c,d=arguments.length;if(1>=d)throw Error("bindAll must be passed function names");for(b=1;d>b;b++)c=arguments[b],a[c]=n.bind(a[c],a);return a};n.memoize=function(a,b){var c=function(d){var e=c.cache,f=""+(b?b.apply(this,arguments):d);return n.has(e,f)||(e[f]=a.apply(this,arguments)),e[f]};return c.cache={},c};n.delay=
function(a,b){var c=m.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)};n.defer=n.partial(n.delay,n,1);n.throttle=function(a,b,c){var d,e,f,g=null,h=0;c||(c={});var k=function(){h=!1===c.leading?0:n.now();g=null;f=a.apply(d,e);g||(d=e=null)};return function(){var m=n.now();h||!1!==c.leading||(h=m);var C=b-(m-h);return d=this,e=arguments,0>=C||C>b?(g&&(clearTimeout(g),g=null),h=m,f=a.apply(d,e),g||(d=e=null)):g||!1===c.trailing||(g=setTimeout(k,C)),f}};n.debounce=function(a,
...
n.after=function(a,b){return function(){return 1>--a?b.apply(this,arguments):void 0}};n.before=function(a,b){var c;return function(){return 0<--a&&(c=b.apply(this,arguments)),1>=a&&(b=null),c}};n.once=n.partial(n.before,2);var J=!{toString:null}.propertyIsEnumerable("toString"),H="valueOf isPrototypeOf toString propertyIsEnumerable hasOwnProperty toLocaleString".split(" ");n.keys=function(a){if(!n.isObject(a))return[];if(s)return s(a);var b=[],c;for(c in a)n.has(a,c)&&b.push(c);return J&&d(a,b),b};
n.allKeys=function(a){if(!n.isObject(a))return[];var b=[],c;for(c in a)b.push(c);return J&&d(a,b),b};n.values=function(a){for(var b=n.keys(a),c=b.length,d=Array(c),e=0;c>e;e++)d[e]=a[b[e]];return d};n.mapObject=function(a,b,c){b=x(b,c);for(var d=n.keys(a),e=d.length,f={},g=0;e>g;g++)c=d[g],f[c]=b(a[c],c,a);return f};n.pairs=function(a){for(var b=n.keys(a),c=b.length,d=Array(c),e=0;c>e;e++)d[e]=[b[e],a[b[e]]];return d};n.invert=function(a){for(var b={},c=n.keys(a),d=0,e=c.length;e>d;d++)b[a[c[d]]]=
c[d];return b};n.functions=n.methods=function(a){var b=[],c;for(c in a)n.isFunction(a[c])&&b.push(c);return b.sort()};n.extend=B(n.allKeys);n.extendOwn=n.assign=B(n.keys);n.findKey=function(a,b,c){b=x(b,c);var d;c=n.keys(a);for(var e=0,f=c.length;f>e;e++)if(d=c[e],b(a[d],d,a))return d};n.pick=function(a,b,c){var d,e,f={},g=a;if(null==g)return f;n.isFunction(b)?(e=n.allKeys(g),d=A(b,c)):(e=F(arguments,!1,!1,1),d=function(a,b,c){return b in c},g=Object(g));for(var h=0,k=e.length;k>h;h++){var m=e[h],
C=g[m];d(C,m,g)&&(f[m]=C)}return f};n.omit=function(a,b,c){if(n.isFunction(b))b=n.negate(b);else{var d=n.map(F(arguments,!1,!1,1),String);b=function(a,b){return!n.contains(d,b)}}return n.pick(a,b,c)};n.defaults=B(n.allKeys,!0);n.create=function(a,b){var c=y(a);return b&&n.extendOwn(c,b),c};n.clone=function(a){return n.isObject(a)?n.isArray(a)?a.slice():n.extend({},a):a};n.tap=function(a,b){return b(a),a};n.isMatch=function(a,b){var c=n.keys(b),d=c.length;if(null==a)return!d;for(var e=Object(a),f=
...
a&&r.call(a,b)};n.noConflict=function(){return e._=f,this};n.identity=function(a){return a};n.constant=function(a){return function(){return a}};n.noop=function(){};n.property=G;n.propertyOf=function(a){return null==a?function(){}:function(b){return a[b]}};n.matcher=n.matches=function(a){return a=n.extendOwn({},a),function(b){return n.isMatch(b,a)}};n.times=function(a,b,c){var d=Array(Math.max(0,a));b=A(b,c,1);for(c=0;a>c;c++)d[c]=b(c);return d};n.random=function(a,b){return null==b&&(b=a,a=0),a+Math.floor(Math.random()*
(b-a+1))};n.now=Date.now||function(){return(new Date).getTime()};t={"\x26":"\x26amp;","\x3c":"\x26lt;","\x3e":"\x26gt;",'"':"\x26quot;","'":"\x26#x27;","`":"\x26#x60;"};B=n.invert(t);G=function(a){var b=function(b){return a[b]},c="(?:"+n.keys(a).join("|")+")",d=RegExp(c),e=RegExp(c,"g");return function(a){return a=null==a?"":""+a,d.test(a)?a.replace(e,b):a}};n.escape=G(t);n.unescape=G(B);n.result=function(a,b,c){b=null==a?void 0:a[b];return void 0===b&&(b=c),n.isFunction(b)?b.call(a):b};var M=0;n.uniqueId=
function(a){var b=++M+"";return a?a+b:b};n.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var L=/(.)^/,N={"'":"'","\\":"\\","\r":"r","\n":"n","\u2028":"u2028","\u2029":"u2029"},O=/\\|'|\r|\n|\u2028|\u2029/g,P=function(a){return"\\"+N[a]};n.template=function(a,b,c){!b&&c&&(b=c);b=n.defaults({},b,n.templateSettings);c=RegExp([(b.escape||L).source,(b.interpolate||L).source,(b.evaluate||L).source].join("|")+"|$","g");var d=0,e="__p+\x3d'";a.replace(c,
function(b,c,f,g,h){return e+=a.slice(d,h).replace(O,P),d=h+b.length,c?e+="'+\n((__t\x3d("+c+"))\x3d\x3dnull?'':_.escape(__t))+\n'":f?e+="'+\n((__t\x3d("+f+"))\x3d\x3dnull?'':__t)+\n'":g&&(e+="';\n"+g+"\n__p+\x3d'"),b});e+="';\n";b.variable||(e="with(obj||{}){\n"+e+"}\n");e="var __t,__p\x3d'',__j\x3dArray.prototype.join,print\x3dfunction(){__p+\x3d__j.call(arguments,'');};\n"+e+"return __p;\n";try{var f=new Function(b.variable||"obj","_",e)}catch(g){throw g.source=e,g;}c=function(a){return f.call(this,
a,n)};return c.source="function("+(b.variable||"obj")+"){\n"+e+"}",c};n.chain=function(a){a=n(a);return a._chain=!0,a};var Q=function(a,b){return a._chain?n(b).chain():b};n.mixin=function(a){n.each(n.functions(a),function(b){var c=n[b]=a[b];n.prototype[b]=function(){var a=[this._wrapped];return k.apply(a,arguments),Q(this,c.apply(n,a))}})};n.mixin(n);n.each("pop push reverse shift sort splice unshift".split(" "),function(a){var b=g[a];n.prototype[a]=function(){var c=this._wrapped;return b.apply(c,
arguments),"shift"!==a&&"splice"!==a||0!==c.length||delete c[0],Q(this,c)}});n.each(["concat","join","slice"],function(a){var b=g[a];n.prototype[a]=function(){return Q(this,b.apply(this._wrapped,arguments))}});n.prototype.value=function(){return this._wrapped};n.prototype.valueOf=n.prototype.toJSON=n.prototype.value;n.prototype.toString=function(){return""+this._wrapped};"function"==typeof define&&define.amd&&define("underscore",[],function(){return n})}).call(this);(function(a,b){if("function"===typeof define&&define.amd)define(["underscore","jquery","exports"],function(c,e,f){a.Backbone=b(a,f,c,e)});else if("undefined"!==typeof exports){var c=require("underscore");b(a,exports,c)}else a.Backbone=b(a,{},a._,a.jQuery||a.Zepto||a.ender||a.$)})(this,function(a,b,c,d){var e=a.Backbone,f=[].slice;b.VERSION="1.1.2";b.$=d;b.noConflict=function(){a.Backbone=e;return this};b.emulateHTTP=!1;b.emulateJSON=!1;var g=b.Events={on:function(a,b,c){if(!k(this,"on",a,[b,c])||
...
fetch:function(a){a=a?c.clone(a):{};void 0===a.parse&&(a.parse=!0);var b=this,d=a.success;a.success=function(c){if(!b.set(b.parse(c,a),a))return!1;d&&d(b,c,a);b.trigger("sync",b,c,a)};H(this,a);return this.sync("read",this,a)},save:function(a,b,d){var e,f=this.attributes;null==a||"object"===typeof a?(e=a,d=b):(e={})[a]=b;d=c.extend({validate:!0},d);if(e&&!d.wait){if(!this.set(e,d))return!1}else if(!this._validate(e,d))return!1;e&&d.wait&&(this.attributes=c.extend({},f,e));void 0===d.parse&&(d.parse=
!0);var g=this,h=d.success;d.success=function(a){g.attributes=f;var b=g.parse(a,d);d.wait&&(b=c.extend(e||{},b));if(c.isObject(b)&&!g.set(b,d))return!1;h&&h(g,a,d);g.trigger("sync",g,a,d)};H(this,d);a=this.isNew()?"create":d.patch?"patch":"update";"patch"===a&&(d.attrs=e);a=this.sync(a,this,d);e&&d.wait&&(this.attributes=f);return a},destroy:function(a){a=a?c.clone(a):{};var b=this,d=a.success,e=function(){b.trigger("destroy",b,b.collection,a)};a.success=function(c){(a.wait||b.isNew())&&e();d&&d(b,
c,a);b.isNew()||b.trigger("sync",b,c,a)};if(this.isNew())return a.success(),!1;H(this,a);var f=this.sync("delete",this,a);a.wait||e();return f},url:function(){var a=c.result(this,"urlRoot")||c.result(this.collection,"url")||J();return this.isNew()?a:a.replace(/([^\/])$/,"$1/")+encodeURIComponent(this.id)},parse:function(a,b){return a},clone:function(){return new this.constructor(this.attributes)},isNew:function(){return!this.has(this.idAttribute)},isValid:function(a){return this._validate({},c.extend(a||
...
void 0!==b.comparator&&(this.comparator=b.comparator);this._reset();this.initialize.apply(this,arguments);a&&this.reset(a,c.extend({silent:!0},b))},t={add:!0,remove:!0,merge:!0},s={add:!0,remove:!1};c.extend(r.prototype,g,{model:p,initialize:function(){},toJSON:function(a){return this.map(function(b){return b.toJSON(a)})},sync:function(){return b.sync.apply(this,arguments)},add:function(a,b){return this.set(a,c.extend({merge:!1},b,s))},remove:function(a,b){var d=!c.isArray(a);a=d?[a]:c.clone(a);b||
(b={});var e,f,g,h;e=0;for(f=a.length;e<f;e++)if(h=a[e]=this.get(a[e]))delete this._byId[h.id],delete this._byId[h.cid],g=this.indexOf(h),this.models.splice(g,1),this.length--,b.silent||(b.index=g,h.trigger("remove",h,this,b)),this._removeReference(h,b);return d?a[0]:a},set:function(a,b){b=c.defaults({},b,t);b.parse&&(a=this.parse(a,b));var d=!c.isArray(a);a=d?a?[a]:[]:c.clone(a);var e,f,g,h,k,m,n=b.at,r=this.model,s=this.comparator&&null==n&&!1!==b.sort,u=c.isString(this.comparator)?this.comparator:
null,v=[],w=[],x={},z=b.add,B=b.merge,A=b.remove,y=!s&&z&&A?[]:!1;e=0;for(f=a.length;e<f;e++){k=a[e]||{};g=k instanceof p?h=k:k[r.prototype.idAttribute||"id"];if(g=this.get(g))A&&(x[g.cid]=!0),B&&(k=k===h?h.attributes:k,b.parse&&(k=g.parse(k,b)),g.set(k,b),s&&!m&&g.hasChanged(u)&&(m=!0)),a[e]=g;else if(z){h=a[e]=this._prepareModel(k,b);if(!h)continue;v.push(h);this._addReference(h,b)}h=g||h;!y||!h.isNew()&&x[h.id]||y.push(h);x[h.id]=!0}if(A){e=0;for(f=this.length;e<f;++e)x[(h=this.models[e]).cid]||
w.push(h);w.length&&this.remove(w,b)}if(v.length||y&&y.length)if(s&&(m=!0),this.length+=v.length,null!=n)for(e=0,f=v.length;e<f;e++)this.models.splice(n+e,0,v[e]);else for(y&&(this.models.length=0),k=y||v,e=0,f=k.length;e<f;e++)this.models.push(k[e]);m&&this.sort({silent:!0});if(!b.silent){e=0;for(f=v.length;e<f;e++)(h=v[e]).trigger("add",h,this,b);(m||y&&y.length)&&this.trigger("sort",this,b)}return d?a[0]:a},reset:function(a,b){b||(b={});for(var d=0,e=this.models.length;d<e;d++)this._removeReference(this.models[d],
...
this));a.silent||this.trigger("sort",this,a);return this},pluck:function(a){return c.invoke(this.models,"get",a)},fetch:function(a){a=a?c.clone(a):{};void 0===a.parse&&(a.parse=!0);var b=a.success,d=this;a.success=function(c){d[a.reset?"reset":"set"](c,a);b&&b(d,c,a);d.trigger("sync",d,c,a)};H(this,a);return this.sync("read",this,a)},create:function(a,b){b=b?c.clone(b):{};if(!(a=this._prepareModel(a,b)))return!1;b.wait||this.add(a,b);var d=this,e=b.success;b.success=function(a,c){b.wait&&d.add(a,
...
function(a){r.prototype[a]=function(){var b=f.call(arguments);b.unshift(this.models);return c[a].apply(c,b)}});c.each(["groupBy","countBy","sortBy","indexBy"],function(a){r.prototype[a]=function(b,d){var e=c.isFunction(b)?b:function(a){return a.get(b)};return c[a](this.models,e,d)}});d=b.View=function(a){this.cid=c.uniqueId("view");a||(a={});c.extend(this,c.pick(a,u));this._ensureElement();this.initialize.apply(this,arguments);this.delegateEvents()};var v=/^(\S+)\s*(.*)$/,u="model collection el id attributes className tagName events".split(" ");
...
"\x3e").attr(a);this.setElement(a,!1)}}});b.sync=function(a,d,e){var f=n[a];c.defaults(e||(e={}),{emulateHTTP:b.emulateHTTP,emulateJSON:b.emulateJSON});var g={type:f,dataType:"json"};e.url||(g.url=c.result(d,"url")||J());null!=e.data||!d||"create"!==a&&"update"!==a&&"patch"!==a||(g.contentType="application/json",g.data=JSON.stringify(e.attrs||d.toJSON(e)));e.emulateJSON&&(g.contentType="application/x-www-form-urlencoded",g.data=g.data?{model:g.data}:{});if(e.emulateHTTP&&("PUT"===f||"DELETE"===f||
"PATCH"===f)){g.type="POST";e.emulateJSON&&(g.data._method=f);var h=e.beforeSend;e.beforeSend=function(a){a.setRequestHeader("X-HTTP-Method-Override",f);if(h)return h.apply(this,arguments)}}"GET"===g.type||e.emulateJSON||(g.processData=!1);"PATCH"===g.type&&w&&(g.xhr=function(){return new ActiveXObject("Microsoft.XMLHTTP")});a=e.xhr=b.ajax(c.extend(g,e));d.trigger("request",d,a,e);return a};var w="undefined"!==typeof window&&!!window.ActiveXObject&&!(window.XMLHttpRequest&&(new XMLHttpRequest).dispatchEvent),
n={create:"POST",update:"PUT",patch:"PATCH","delete":"DELETE",read:"GET"};b.ajax=function(){return b.$.ajax.apply(b.$,arguments)};var A=b.Router=function(a){a||(a={});a.routes&&(this.routes=a.routes);this._bindRoutes();this.initialize.apply(this,arguments)},x=/\((.*?)\)/g,B=/(\(\?)?:\w+/g,y=/\*\w+/g,G=/[\-{}\[\]+?.,\\\^$|#\s]/g;c.extend(A.prototype,g,{initialize:function(){},route:function(a,d,e){c.isRegExp(a)||(a=this._routeToRegExp(a));c.isFunction(d)&&(e=d,d="");e||(e=this[d]);var f=this;b.history.route(a,
function(c){c=f._extractParameters(a,c);f.execute(e,c);f.trigger.apply(f,["route:"+d].concat(c));f.trigger("route",d,c);b.history.trigger("route",f,d,c)});return this},execute:function(a,b){a&&a.apply(this,b)},navigate:function(a,c){b.history.navigate(a,c);return this},_bindRoutes:function(){if(this.routes){this.routes=c.result(this,"routes");for(var a,b=c.keys(this.routes);null!=(a=b.pop());)this.route(a,this.routes[a])}},_routeToRegExp:function(a){a=a.replace(G,"\\$\x26").replace(x,"(?:$1)?").replace(B,
function(a,b){return b?a:"([^/?]+)"}).replace(y,"([^?]*?)");return RegExp("^"+a+"(?:\\?([\\s\\S]*))?$")},_extractParameters:function(a,b){var d=a.exec(b).slice(1);return c.map(d,function(a,b){return b===d.length-1?a||null:a?decodeURIComponent(a):null})}});var E=b.History=function(){this.handlers=[];c.bindAll(this,"checkUrl");"undefined"!==typeof window&&(this.location=window.location,this.history=window.history)},D=/^[#\/]|\s+$/g,z=/^\/+|\/+$/g,I=/msie [\w.]+/,F=/\/$/,K=/#.*$/;E.started=!1;c.extend(E.prototype,
g,{interval:50,atRoot:function(){return this.location.pathname.replace(/[^\/]$/,"$\x26/")===this.root},getHash:function(a){return(a=(a||this).location.href.match(/#(.*)$/))?a[1]:""},getFragment:function(a,b){if(null==a)if(this._hasPushState||!this._wantsHashChange||b){a=decodeURI(this.location.pathname+this.location.search);var c=this.root.replace(F,"");a.indexOf(c)||(a=a.slice(c.length))}else a=this.getHash();return a.replace(D,"")},start:function(a){if(E.started)throw Error("Backbone.history has already been started");
E.started=!0;this.options=c.extend({root:"/"},this.options,a);this.root=this.options.root;this._wantsHashChange=!1!==this.options.hashChange;this._wantsPushState=!!this.options.pushState;this._hasPushState=!!(this.options.pushState&&this.history&&this.history.pushState);a=this.getFragment();var d=document.documentMode,d=I.exec(navigator.userAgent.toLowerCase())&&(!d||7>=d);this.root=("/"+this.root+"/").replace(z,"/");d&&this._wantsHashChange&&(this.iframe=b.$('\x3ciframe src\x3d"javascript:0" tabindex\x3d"-1"\x3e').hide().appendTo("body")[0].contentWindow,
...
this.atRoot()&&a.hash&&(this.fragment=this.getHash().replace(D,""),this.history.replaceState({},document.title,this.root+this.fragment))}if(!this.options.silent)return this.loadUrl()},stop:function(){b.$(window).off("popstate",this.checkUrl).off("hashchange",this.checkUrl);this._checkUrlInterval&&clearInterval(this._checkUrlInterval);E.started=!1},route:function(a,b){this.handlers.unshift({route:a,callback:b})},checkUrl:function(a){a=this.getFragment();a===this.fragment&&this.iframe&&(a=this.getFragment(this.getHash(this.iframe)));
if(a===this.fragment)return!1;this.iframe&&this.navigate(a);this.loadUrl()},loadUrl:function(a){a=this.fragment=this.getFragment(a);return c.any(this.handlers,function(b){if(b.route.test(a))return b.callback(a),!0})},navigate:function(a,b){if(!E.started)return!1;b&&!0!==b||(b={trigger:!!b});var c=this.root+(a=this.getFragment(a||""));a=a.replace(K,"");if(this.fragment!==a){this.fragment=a;""===a&&"/"!==c&&(c=c.slice(0,-1));if(this._hasPushState)this.history[b.replace?"replaceState":"pushState"]({},
document.title,c);else if(this._wantsHashChange)this._updateHash(this.location,a,b.replace),this.iframe&&a!==this.getFragment(this.getHash(this.iframe))&&(b.replace||this.iframe.document.open().close(),this._updateHash(this.iframe.location,a,b.replace));else return this.location.assign(c);if(b.trigger)return this.loadUrl(a)}},_updateHash:function(a,b,c){c?(c=a.href.replace(/(javascript:|#).*$/,""),a.replace(c+"#"+b)):a.hash="#"+b}});b.history=new E;p.extend=r.extend=A.extend=d.extend=E.extend=function(a,
b){var d=this,e;e=a&&c.has(a,"constructor")?a.constructor:function(){return d.apply(this,arguments)};c.extend(e,d,b);var f=function(){this.constructor=e};f.prototype=d.prototype;e.prototype=new f;a&&c.extend(e.prototype,a);e.__super__=d.prototype;return e};var J=function(){throw Error('A "url" property or function must be specified');},H=function(a,b){var c=b.error;b.error=function(d){c&&c(a,d,b);a.trigger("error",a,d,b)}};return b});Math.log10||(Math.log10=function(a){return Math.log(a)/Math.log(10)});String.prototype.contains||(String.prototype.contains=function(a){return-1<this.indexOf(a)});window.clone=function(a){return JSON.parse(JSON.stringify(a))};window.isInArray=function(a,b){for(var c=0;c<a.length;c++)if(a[c]==b)return!0;return!1};window.isValidInt=function(a){return 0==a.length||"NaN"===parseInt(a,10).toString()?!1:!0};window.isFunction=function(a){return"[object Function]"===Object.prototype.toString.call(a)};
...
this.addChild(this.numberDownSprite,0);this.listener=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,c){var d=c.getCurrentTarget(),e=d.convertToNodeSpace(a.getLocation()),f=d.getContentSize(),f=cc.rect(0,0,f.width,f.height);return cc.rectContainsPoint(f,e)?(d.stopAllActions(),d.speedX=0,d.speedY=d.y>=cc.winSize.height/2?1:-1,!0):!1},onTouchMoved:function(a,c){var d=c.getCurrentTarget();if(!d.alreadyTaken){var e=a.getDelta();d.x+=e.x;d.y+=
e.y;d.speedX=e.x;d.speedY=e.y}},onTouchEnded:function(a,c){var d=c.getCurrentTarget();if(!d.alreadyTaken)if(d.y<dimens.player1Y)d.playerTakeCard.call(d,gameModel.player1);else if(d.y>dimens.player2Y)d.playerTakeCard.call(d,gameModel.player2);else{var e=dimens.player1Y,f=dimens.player2Y,g=cc.winSize.height/2;if(0<d.speedY)if(d.y<g){var h=d.moveToLine.call(d,gameModel.player1,f,function(){this.playerTakeCard.call(this,gameModel.player2)},d),g=(d.y-g)*h/(d.y-f);d.runAction(new cc.sequence(new cc.delayTime(g),
new cc.callFunc(function(){if(this.getSpeedScale(gameModel.player2)!=this.speedScale){this.stopAllActions();var a=this.getSpeed(gameModel.player2),a=Math.sqrt((this.x-this.destX)*(this.x-this.destX)+(this.y-this.destY)*(this.y-this.destY))/a;this.runAction(new cc.sequence(new cc.moveTo(a,this.destX,this.destY),new cc.callFunc(function(){this.destX>-dimens.card_size.width/2&&this.destX<cc.winSize.width+dimens.card_size.width/2?this.playerTakeCard.call(this,gameModel.player2):gameModel.destroyCard(this.model)},
this)))}},d)))}else d.moveToLine.call(d,gameModel.player2,f,function(){d.playerTakeCard.call(d,gameModel.player2)},d);else 0>d.speedY?d.y>=g?(h=d.moveToLine.call(d,gameModel.player2,e,function(){this.playerTakeCard.call(this,gameModel.player1)},d),g=(d.y-g)*h/(d.y-e),d.runAction(new cc.sequence(new cc.delayTime(g),new cc.callFunc(function(){if(this.getSpeedScale(gameModel.player1)!=this.speedScale){this.stopAllActions();var a=this.getSpeed(gameModel.player1),a=Math.sqrt((this.x-this.destX)*(this.x-
this.destX)+(this.y-this.destY)*(this.y-this.destY))/a;this.runAction(new cc.sequence(new cc.moveTo(a,this.destX,this.destY),new cc.callFunc(function(){this.destX>-dimens.card_size.width/2&&this.destX<cc.winSize.width+dimens.card_size.width/2?this.playerTakeCard.call(this,gameModel.player1):gameModel.destroyCard(this.model)},this)))}},d)))):d.moveToLine.call(d,gameModel.player1,e,function(){d.playerTakeCard.call(d,gameModel.player1)},d):0==d.speedY&&(e=[],g=d.y<g?d.getSpeed(gameModel.player1):d.getSpeed(gameModel.player2),
0>d.speedX?(g=(d.x- -dimens.card_size.width/2)/g,e.push(new cc.moveTo(g,-dimens.card_size.width/2,d.y)),e.push(new cc.callFunc(function(){gameModel.destroyCard(d.model)},d))):0<d.speedX&&(g=(cc.winSize.width+dimens.card_size.width/2-d.x)/g,e.push(new cc.moveTo(g,cc.winSize.width+dimens.card_size.width/2,d.y)),e.push(new cc.callFunc(function(){gameModel.destroyCard(d.model)},d))),d.runAction(new cc.sequence(e)))}}})},playerTakeCard:function(a){a.canTakeCard()?(this.isNewHand=!0,this.setTag(0),a.addHand(this.model),
this.alreadyTaken=!0,cc.eventManager.removeListener(this.listener)):(this.stopAllActions(),gameModel.destroyCard(this.model))},getSpeedScale:function(a){var b=1;a.get("speedUp")&&(b*=2);a.get("speedDown")&&(b/=2);return b},getSpeed:function(a){var b=Math.max(0.1,Math.sqrt(this.speedX*this.speedX+this.speedY*this.speedY)),b=30*Math.min(MAX_SPEED,Math.max(MIN_SPEED,b));this.speedScale=this.getSpeedScale(a);return b*=this.speedScale},changeSpeed:function(){},moveToLine:function(a,b,c,d){var e=[],f=this.getCrossPointX.call(this,
b);a=this.getSpeed(a);a=Math.sqrt((this.x-f)*(this.x-f)+(this.y-b)*(this.y-b))/a;this.destX=f;this.destY=b;e.push(new cc.moveTo(a,f,b));f>-dimens.card_size.width/2&&f<cc.winSize.width+dimens.card_size.width/2?e.push(new cc.callFunc(c,d)):e.push(new cc.callFunc(function(){gameModel.destroyCard(this.model)},this));this.runAction(new cc.sequence(e));return a},getCrossPointX:function(a){return(a-this.y)*this.speedX/this.speedY+this.x},render:function(){this.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("card-"+
SUIT_ARRAY[this.model.get("suit")]+".png"));this.numberSprite.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("number-"+this.model.get("number")+".png"));this.numberDownSprite.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("number-"+this.model.get("number")+".png"))},onEnter:function(){this._super();this.initEvent();this.render()},onExit:function(){this.closeEvent();this._super()},initEvent:function(){cc.eventManager.addListener(this.listener,this);this.model.on("destroy",this.onDestroy,this)},
closeEvent:function(){cc.eventManager.removeListener(this.listener);this.model.off("destroy",this.onDestroy)},onDestroy:function(){this.removeFromParent(!0)},getFlipToFrontSequence:function(){return new cc.sequence(new cc.scaleTo(times.flip/2,0,1),new cc.callFunc(function(){this.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("card-"+SUIT_ARRAY[this.model.get("suit")]+".png"));this.numberSprite.setVisible(!0);this.numberDownSprite.setVisible(!0)},this),new cc.scaleTo(times.flip/2,1,1))},getFlipToBackSequence:function(){return new cc.sequence(new cc.scaleTo(times.flip/
2,0,1),new cc.callFunc(function(){this.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("card-back.png"));this.numberSprite.setVisible(!1);this.numberDownSprite.setVisible(!1)},this),new cc.scaleTo(times.flip/2,1,1))}});var STRAIGHT_MAP={"14-3-2":!0,"4-3-2":!0,"5-4-3":!0,"6-5-4":!0,"7-6-5":!0,"8-7-6":!0,"9-8-7":!0,"10-9-8":!0,"11-10-9":!0,"12-11-10":!0,"13-12-11":!0,"14-13-12":!0,"14-4-3-2":!0,"5-4-3-2":!0,"6-5-4-3":!0,"7-6-5-4":!0,"8-7-6-5":!0,"9-8-7-6":!0,"10-9-8-7":!0,"11-10-9-8":!0,"12-11-10-9":!0,"13-12-11-10":!0,"14-13-12-11":!0,"14-5-4-3-2":!0,"6-5-4-3-2":!0,"7-6-5-4-3":!0,"8-7-6-5-4":!0,"9-8-7-6-5":!0,"10-9-8-7-6":!0,"11-10-9-8-7":!0,"12-11-10-9-8":!0,"13-12-11-10-9":!0,"14-13-12-11-10":!0},PLAYER_POSITION_DOWN=
0,PLAYER_POSITION_UP=1,MAX_HAND=5,PlayerModel=Backbone.Model.extend({defaults:function(){return{money:1E3,hands:[],speedDown:0,speedUp:0}},addHand:function(a){a._owned=!0;this.get("hands").push(a);this.sortHand()},sortHand:function(){var a=this.get("hands"),a=_.sortBy(a,function(a){return 100*(100-a.get("number"))+a.get("suit")},this);this.set("hands",a);this.trigger("change:hands",this)},canTakeCard:function(){return this.get("hands").length<MAX_HAND},isFlushStraight:function(a){return this.isFlush(a)&&
this.isStraight(a)},is4ofAKind:function(a){return a[0].get("number")===a[1].get("number")&&a[0].get("number")===a[2].get("number")&&a[0].get("number")===a[3].get("number")?a[0]:a[1].get("number")===a[2].get("number")&&a[1].get("number")===a[3].get("number")&&a[1].get("number")===a[4].get("number")?a[1]:!1},isFullHouse:function(a){return a[0].get("number")===a[1].get("number")&&a[0].get("number")===a[2].get("number")&&a[3].get("number")===a[4].get("number")?a[0]:a[0].get("number")===a[1].get("number")&&
a[2].get("number")===a[3].get("number")&&a[3].get("number")===a[4].get("number")?a[2]:!1},isStraight:function(a){a=_.map(a,function(a){return a.get("number")},this).join("-");return STRAIGHT_MAP[a]},is3ofAKind:function(a){return a[0].get("number")===a[1].get("number")&&a[0].get("number")===a[2].get("number")?a[0]:a[1].get("number")===a[2].get("number")&&a[1].get("number")===a[3].get("number")?a[1]:a[2].get("number")===a[3].get("number")&&a[2].get("number")===a[4].get("number")?a[2]:!1},isFlush:function(a){for(var b=
a[0].get("suit"),c=1;c<a.length;c++)if(b!=a[c].get("suit"))return!1;return!0},is2Pair:function(a){return a[0].get("number")===a[1].get("number")&&a[2].get("number")===a[3].get("number")||a[0].get("number")===a[1].get("number")&&a[3].get("number")===a[4].get("number")?a[0]:a[1].get("number")===a[2].get("number")&&a[3].get("number")===a[4].get("number")?a[1]:!1},isPair:function(a){return a[0].get("number")===a[1].get("number")?a[0]:a[1].get("number")===a[2].get("number")?a[1]:a[2].get("number")===a[3].get("number")?
a[2]:a[3].get("number")===a[4].get("number")?a[3]:!1},getFeature:function(){var a=this.get("hands"),b=[];_.each(a,function(a){b.push(a)},this);for(a=this.get("hands").length;a<MAX_HAND;a++)b.push(new PokerCardModel({number:-a,suit:4+a}));var c,d;this.isFlushStraight(b)?(a=1E4+10*b[0].get("number")+(10-b[0].get("suit")),c="straight-flush",d=50):(a=this.is4ofAKind(b))?(a=9E3+10*a.get("number")+(10-a.get("suit")),c="four-of-a-kind",d=40):(a=this.isFullHouse(b))?(a=8E3+10*a.get("number")+(10-a.get("suit")),
c="full-house",d=30):this.isFlush(b)?(a=7E3+10*b[0].get("number")+(10-b[0].get("suit")),c="flush",d=20):this.isStraight(b)?(a=6E3+10*b[0].get("number")+(10-b[0].get("suit")),c="straight",d=15):(a=this.is3ofAKind(b))?(a=5E3+10*a.get("number")+(10-a.get("suit")),c="three-of-a-kind",d=10):(a=this.is2Pair(b))?(a=4E3+10*a.get("number")+(10-a.get("suit")),c="two-pair",d=4):(a=this.isPair(b))?(a=3E3+10*a.get("number")+(10-a.get("suit")),c="one-pair",d=2):(0<b[0].get("number")?(a=2E3+10*b[0].get("number")+
(10-b[0].get("suit")),c="high-card"):(a=0,c="no-card"),d=1);return{power:a,type:c,rate:d}}}),PlayerSprite=cc.Sprite.extend({ctor:function(a){this._super();this.model=a.model;this.showHand=!1;this.lookHand=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("show-hand.png"));a=this.model.get("position")==PLAYER_POSITION_DOWN?dimens.player1Y/2:(dimens.player2Y+cc.winSize.height)/2;this.lookHand.attr({x:cc.winSize.width/2,y:a});this.addChild(this.lookHand,40);var b=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("player-bound.png"));
...
a.runAction(a.getFlipToFrontSequence())},this)},render:function(){}});var IntroLayer=cc.Layer.extend({}),IntroScene=cc.Scene.extend({onEnter:function(){this._super();var a=new IntroLayer;this.addChild(a)}});var GENERATE_CARD_INTERVAL=5,MainLayer=cc.LayerColor.extend({sprite:null,ctor:function(a){this._super(colors.table);this.need_read_fight=a.need_read_fight;this.initAudio();this.model=a.model;this.player1=this.model.player1;this.player2=this.model.player2;this.addChild(this.player1Sprite=new PlayerSprite({model:this.player1}));this.addChild(this.player2Sprite=new PlayerSprite({model:this.player2}));a=new cc.MenuItemImage(cc.spriteFrameCache.getSpriteFrame("pause-default.png"),cc.spriteFrameCache.getSpriteFrame("pause-press.png"),
function(){},this);a.attr({x:0,y:cc.winSize.height/2,anchorX:0,anchorY:0.5});a=new cc.Menu([a]);a.x=0;a.y=0;this.addChild(a);this.betRateLabel1=new cc.LabelTTF("","Arial",30);this.betRateLabel1.attr({color:colors.tableLabel,x:cc.winSize.width/2,y:cc.winSize.height/2,anchorY:1});this.addChild(this.betRateLabel1,0);this.betRateLabel2=new cc.LabelTTF("","Arial",30);this.betRateLabel2.attr({color:colors.tableLabel,x:cc.winSize.width/2,y:cc.winSize.height/2,rotation:180,anchorY:1});this.addChild(this.betRateLabel2,
...
this.countDownLabel.attr({scaleX:1,scaleY:1})},this),new cc.scaleTo(1,3,3),new cc.callFunc(function(){this.countDownLabel.setVisible(!1);this.model.clearNotOwnedCards();this.compareHands()},this)))}},compareHands:function(){this.model.set("status","compare");this.unschedule(this.schedulePerSec);this.player1Sprite.forceShowHand();this.player2Sprite.forceShowHand();var a=this.player1.getFeature(),b=this.player2.getFeature();this.handTypeLabel1.setVisible(!0);this.handTypeLabel1.setString(texts.handTypeDisplayName[a.type]);
this.handTypeLabel2.setVisible(!0);this.handTypeLabel2.setString(texts.handTypeDisplayName[b.type]);this.winLoseLabel1.setVisible(!0);this.winLoseLabel2.setVisible(!0);var c=this.model.get("betRate")*(a.rate+b.rate);a.power>b.power?(this.winLoseLabel1.setString("WIN"),this.winLoseLabel2.setString("LOSE"),this.giveMoney(c,this.player2Sprite,this.player1Sprite),cc.audioEngine.playEffect(res[a.type],!1)):(this.winLoseLabel1.setString("LOSE"),this.winLoseLabel2.setString("WIN"),this.giveMoney(c,this.player1Sprite,
this.player2Sprite),cc.audioEngine.playEffect(res[b.type],!1));this.scheduleOnce(function(){this.model.set("betRate",this.model.get("betRate")+1);0>=this.player1.get("money")?this.gameOver():0>=this.player2.get("money")?this.gameOver():this.startNewRound()},times.compare)},giveMoney:function(a,b,c){var d=Math.min(10,Math.floor(a/100)),e=0;10>d&&(e=Math.min(10,a%100/10));var f=0;10>e+d&&(f=Math.min(10,a%10));var g=a-f-10*e-100*d,h=0;for(a=0;a<d;a++){var k=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("token-black.png"));
k.attr({x:b.moneyLabel.x+20*Math.random()-10,y:b.moneyLabel.y+20*Math.random()-10});this.addChild(k,h);(function(a){a.runAction(new cc.sequence(new cc.delayTime(h),new cc.callFunc(function(){b.model.set("money",b.model.get("money")-100)},this),new cc.moveTo(times.giveMoney,c.moneyLabel.x,c.moneyLabel.y),new cc.callFunc(function(){c.model.set("money",c.model.get("money")+100);a.removeFromParent(!0)},this)))})(k,h);h+=0.1}for(a=0;a<e;a++)k=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("token-red.png")),
k.attr({x:b.moneyLabel.x+20*Math.random()-10,y:b.moneyLabel.y+20*Math.random()-10}),this.addChild(k,h),function(a){a.runAction(new cc.sequence(new cc.delayTime(h),new cc.callFunc(function(){b.model.set("money",b.model.get("money")-10)},this),new cc.moveTo(times.giveMoney,c.moneyLabel.x,c.moneyLabel.y),new cc.callFunc(function(){c.model.set("money",c.model.get("money")+10);a.removeFromParent(!0)},this)))}(k,h),h+=0.1;for(a=0;a<f;a++)k=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("token-green.png")),
k.attr({x:b.moneyLabel.x+20*Math.random()-10,y:b.moneyLabel.y+20*Math.random()-10}),this.addChild(k,h),function(a){a.runAction(new cc.sequence(new cc.delayTime(h),new cc.callFunc(function(){b.model.set("money",b.model.get("money")-1)},this),new cc.moveTo(times.giveMoney,c.moneyLabel.x,c.moneyLabel.y),new cc.callFunc(function(){c.model.set("money",c.model.get("money")+1);a.removeFromParent(!0)},this)))}(k,h),h+=0.1;this.scheduleOnce(function(){b.model.set("money",b.model.get("money")-g);c.model.set("money",
c.model.get("money")+g)},h)},startNewRound:function(){this.model.set("status","game");this.model.generateCardCountDown=0;this.handTypeLabel1.setVisible(!1);this.handTypeLabel2.setVisible(!1);this.winLoseLabel1.setVisible(!1);this.winLoseLabel2.setVisible(!1);this.player1.set("hands",[]);this.player2.set("hands",[]);this.model.clearCards();this.model.newDeck();var a=this;null==this.schedulePerSec&&(this.schedulePerSec=function(){"game"==a.model.get("status")&&(0>=a.model.generateCardCountDown&&(a.generateCards.call(a),
a.model.generateCardCountDown=GENERATE_CARD_INTERVAL),a.model.generateCardCountDown--,a.model.totalTime++)});this.schedule(this.schedulePerSec,1)},speedAdjust:function(a,b){b.get("speedUp")&&(a/=2);b.get("speedDown")&&(a*=2);return a},generateCards:function(){var a=this.model.getPattern(),b=_.sample([0,1]),c=_.sample([0,1]),a=a.get("list");_.each(a,function(a){var e=this.model.drawCard();if(null!=e){var f=new PokerCardSprite({model:e});f.attr({x:b?cc.winSize.width-a.start.x:a.start.x,y:a.start.y});
this.addChild(f);var g=a.moveTime;14===e.get("number")&&(g/=2);g=f.y>cc.winSize.height/2?this.speedAdjust(g,gameModel.player2):this.speedAdjust(g,gameModel.player1);f.runAction(new cc.sequence(new cc.delayTime(a.time),new cc.moveTo(g,b?cc.winSize.width-a.end.x:a.end.x,a.end.y),new cc.callFunc(function(){gameModel.destroyCard(e)},this)));var h=this.model.drawCard();if(null!=h){var f=new PokerCardSprite({model:h}),k,m;c?(f.attr({x:a.start.x,y:cc.winSize.height-a.start.y}),k=a.end.x):(f.attr({x:cc.winSize.width-
a.start.x,y:cc.winSize.height-a.start.y}),k=cc.winSize.width-a.end.x);m=cc.winSize.height-a.end.y;this.addChild(f);g=a.moveTime;14===h.get("number")&&(g/=2);g=f.y>cc.winSize.height/2?this.speedAdjust(g,gameModel.player2):this.speedAdjust(g,gameModel.player1);f.runAction(new cc.sequence(new cc.delayTime(a.time),new cc.moveTo(g,k,m),new cc.callFunc(function(){gameModel.destroyCard(h)},this)))}}},this)},initAudio:function(){var a=cc.sys.localStorage.getItem("sound");this.sound=null!=a?a:0.5;cc.audioEngine.setEffectsVolume(this.sound)},
gameOver:function(){cc.audioEngine.playEffect(res.game_over_mp3,!1);this.betRateLabel1.setString("Game Over");this.betRateLabel2.setString("Game Over");this.betRateLabel1.runAction(new cc.spawn(new cc.moveTo(times.gameOver,cc.winSize.width/2,cc.winSize.height/2),new cc.scaleTo(times.gameOver,2,2)));this.betRateLabel2.runAction(new cc.spawn(new cc.moveTo(times.gameOver,cc.winSize.width/2,cc.winSize.height/2),new cc.scaleTo(times.gameOver,2,2)));this.handTypeLabel1.setVisible(!1);this.handTypeLabel2.setVisible(!1);
this.player1Sprite.moneyLabel.runAction(new cc.spawn(new cc.moveTo(times.gameOver,cc.winSize.width/2,cc.winSize.height/2-250),new cc.scaleTo(times.gameOver,2,2)));this.player2Sprite.moneyLabel.runAction(new cc.spawn(new cc.moveTo(times.gameOver,cc.winSize.width/2,cc.winSize.height/2+250),new cc.scaleTo(times.gameOver,2,2)));cc.eventManager.addListener(cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,b){return!0},onTouchMoved:function(a,b){},
onTouchEnded:function(a,b){cc.director.runScene(new IntroScene)}}),this)}}),GameModel=Backbone.Model.extend({initialize:function(){this.countDown=this.maxCountDown=60;this.generateCardCountDown=0;this.set("betRate",1);this.set("status","ready");this.totalTime=0;this.cidToModel={};this.player1=new PlayerModel({position:PLAYER_POSITION_DOWN,playerType:"player"});this.player2=new PlayerModel({position:PLAYER_POSITION_UP,playerType:"player"});this.patternPool=[new PatternModel,new Pattern2Model,new Pattern3Model,
new Pattern4Model,new Pattern5Model,new Pattern6Model]},newDeck:function(){this.deck=newDeck();this.discardDeck=[]},drawCard:function(){var a=this.deck.pop();a||(this.deck=_.shuffle(this.discardDeck),this.discardDeck=[],a=this.deck.pop());a&&(this.cidToModel[a.cid]=a,a._owned=!1);return a},clearNotOwnedCards:function(){var a=[];_.each(this.cidToModel,function(b){null==b||b._owned||a.push(b)},this);_.each(a,function(a){this.destroyCard(a)},this)},clearCards:function(){var a=[];_.each(this.cidToModel,
function(b){null!=b&&a.push(b)},this);_.each(a,function(a){this.destroyCard(a)},this);this.cidToModel={}},destroyCard:function(a){this.discardDeck.push(new PokerCardModel({number:a.get("number"),suit:a.get("suit")}));a.destroy();delete this.cidToModel[a.cid]},getPattern:function(){return _.sample(this.patternPool)}}),MainScene=cc.Scene.extend({onEnter:function(){this._super();if(!window.gameModel){window.gameModel=new GameModel;var a=new MainLayer({model:gameModel,need_read_fight:!0});this.addChild(a)}}});cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(!1);cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(450,800,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.spriteFrameCache.addSpriteFrames(res.game_plist);cc.director.runScene(new MainScene)},this)};cc.game.run();