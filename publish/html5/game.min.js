...
b)*f)/g,g=new a.math.Quaternion(c);this.scale(f);g.scale(e);this.add(g);return this};b.toAxisAndAngle=function(){var c,b,e=new a.math.Vec3;c=Math.acos(this.w);b=Math.sqrt(a.math.square(this.x)+a.math.square(this.y)+a.math.square(this.z));b>-a.math.EPSILON&&b<a.math.EPSILON||b<2*Math.PI+a.math.EPSILON&&b>2*Math.PI-a.math.EPSILON?(c=0,e.x=0,e.y=0,e.z=1):(c*=2,e.x=this.x/b,e.y=this.y/b,e.z=this.z/b,e.normalize());return{axis:e,angle:c}};b.scale=function(a){this.x*=a;this.y*=a;this.z*=a;this.w*=a;return this};
...
e.y;d.speedX=e.x;d.speedY=e.y}},onTouchEnded:function(a,c){var d=c.getCurrentTarget();if(!d.alreadyTaken)if(d.y<dimens.player1Y)d.playerTakeCard.call(d,gameModel.player1);else if(d.y>dimens.player2Y)d.playerTakeCard.call(d,gameModel.player2);else{var e=dimens.player1Y,f=dimens.player2Y,g=cc.winSize.height/2;if(0<d.speedY)d.y<g?d.moveToLine.call(d,gameModel.player1,g,function(){this.moveToLine.call(this,gameModel.player2,f,function(){this.playerTakeCard.call(this,gameModel.player2)},this)},d):d.moveToLine.call(d,
gameModel.player2,f,function(){d.playerTakeCard.call(d,gameModel.player2)},d);else if(0>d.speedY)d.y>=g?d.moveToLine.call(d,gameModel.player2,g,function(){this.moveToLine.call(this,gameModel.player1,e,function(){this.playerTakeCard.call(this,gameModel.player1)},this)},d):d.moveToLine.call(d,gameModel.player1,e,function(){d.playerTakeCard.call(d,gameModel.player1)},d);else if(0==d.speedY){var h=[],g=d.y<g?d.getSpeed(gameModel.player1):d.getSpeed(gameModel.player2);0>d.speedX?(g=(d.x- -dimens.card_size.width/
2)/g,h.push(new cc.moveTo(g,-dimens.card_size.width/2,d.y)),h.push(new cc.callFunc(function(){gameModel.destroyCard(d.model)},d))):0<d.speedX&&(g=(cc.winSize.width+dimens.card_size.width/2-d.x)/g,h.push(new cc.moveTo(g,cc.winSize.width+dimens.card_size.width/2,d.y)),h.push(new cc.callFunc(function(){gameModel.destroyCard(d.model)},d)));d.runAction(new cc.sequence(h))}}}})},playerTakeCard:function(a){a.canTakeCard()?(this.isNewHand=!0,this.setTag(0),a.addHand(this.model),this.alreadyTaken=!0,cc.eventManager.removeListener(this.listener)):
(this.stopAllActions(),gameModel.destroyCard(this.model))},getSpeed:function(a){var b=Math.max(0.1,Math.sqrt(this.speedX*this.speedX+this.speedY*this.speedY)),b=30*Math.min(MAX_SPEED,Math.max(MIN_SPEED,b));a.get("speedUp")&&(b*=2);a.get("speedDown")&&(b/=2);return b},moveToLine:function(a,b,c,d){var e=[],f=this.getCrossPointX.call(this,b);a=this.getSpeed(a);a=Math.sqrt((this.x-f)*(this.x-f)+(this.y-b)*(this.y-b))/a;e.push(new cc.moveTo(a,f,b));f>-dimens.card_size.width/2&&f<cc.winSize.width+dimens.card_size.width/
2?e.push(new cc.callFunc(c,d)):e.push(new cc.callFunc(function(){gameModel.destroyCard(this.model)},this));this.runAction(new cc.sequence(e))},getCrossPointX:function(a){return(a-this.y)*this.speedX/this.speedY+this.x},render:function(){this.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("card-"+SUIT_ARRAY[this.model.get("suit")]+".png"));this.numberSprite.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("number-"+this.model.get("number")+".png"));this.numberDownSprite.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("number-"+
this.model.get("number")+".png"))},onEnter:function(){this._super();this.initEvent();this.render()},onExit:function(){this.closeEvent();this._super()},initEvent:function(){cc.eventManager.addListener(this.listener,this);this.model.on("destroy",this.onDestroy,this)},closeEvent:function(){cc.eventManager.removeListener(this.listener);this.model.off("destroy",this.onDestroy)},onDestroy:function(){this.removeFromParent(!0)},getFlipToFrontSequence:function(){return new cc.sequence(new cc.scaleTo(times.flip/
2,0,1),new cc.callFunc(function(){this.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("card-"+SUIT_ARRAY[this.model.get("suit")]+".png"));this.numberSprite.setVisible(!0);this.numberDownSprite.setVisible(!0)},this),new cc.scaleTo(times.flip/2,1,1))},getFlipToBackSequence:function(){return new cc.sequence(new cc.scaleTo(times.flip/2,0,1),new cc.callFunc(function(){this.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("card-back.png"));this.numberSprite.setVisible(!1);this.numberDownSprite.setVisible(!1)},
this),new cc.scaleTo(times.flip/2,1,1))}});var STRAIGHT_MAP={"14-3-2":!0,"4-3-2":!0,"5-4-3":!0,"6-5-4":!0,"7-6-5":!0,"8-7-6":!0,"9-8-7":!0,"10-9-8":!0,"11-10-9":!0,"12-11-10":!0,"13-12-11":!0,"14-13-12":!0,"14-4-3-2":!0,"5-4-3-2":!0,"6-5-4-3":!0,"7-6-5-4":!0,"8-7-6-5":!0,"9-8-7-6":!0,"10-9-8-7":!0,"11-10-9-8":!0,"12-11-10-9":!0,"13-12-11-10":!0,"14-13-12-11":!0,"14-5-4-3-2":!0,"6-5-4-3-2":!0,"7-6-5-4-3":!0,"8-7-6-5-4":!0,"9-8-7-6-5":!0,"10-9-8-7-6":!0,"11-10-9-8-7":!0,"12-11-10-9-8":!0,"13-12-11-10-9":!0,"14-13-12-11-10":!0},PLAYER_POSITION_DOWN=
