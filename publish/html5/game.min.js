...
!1;var d=window,e=d.navigator,f=document,g=f.documentElement,h=e.userAgent.toLowerCase();c.isMobile=-1!==h.indexOf("mobile")||-1!==h.indexOf("android");c.platform=c.isMobile?c.MOBILE_BROWSER:c.DESKTOP_BROWSER;var k=e.language,k=(k=k?k:e.browserLanguage)?k.split("-")[0]:c.LANGUAGE_ENGLISH;c.language=k;var k=h.match(/(iPad|iPhone|iPod)/i)?!0:!1,m=h.match(/android/i)||e.platform.match(/android/i)?!0:!1,p=c.OS_UNKNOWN;-1!==e.appVersion.indexOf("Win")?p=c.OS_WINDOWS:k?p=c.OS_IOS:-1!==e.appVersion.indexOf("Mac")?
p=c.OS_OSX:-1!==e.appVersion.indexOf("X11")&&-1===e.appVersion.indexOf("Linux")?p=c.OS_UNIX:m?p=c.OS_ANDROID:-1!==e.appVersion.indexOf("Linux")&&(p=c.OS_LINUX);c.os=p;k=c.BROWSER_TYPE_UNKNOWN;(m=h.match(/sogou|qzone|liebao|micromessenger|qqbrowser|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|trident|oupeng|opera|miuibrowser|firefox/i)||h.match(/chrome|safari/i))&&0<m.length?(k=m[0],"micromessenger"===k?k=c.BROWSER_TYPE_WECHAT:"safari"===k&&h.match(/android.*applewebkit/)?k=c.BROWSER_TYPE_ANDROID:
...
cc._supportRender=!0}catch(p){}})(c,a);c._canUseCanvasNewBlendModes=function(){var a=document.createElement("canvas");a.width=1;a.height=1;a=a.getContext("2d");a.fillStyle="#000";a.fillRect(0,0,1,1);a.globalCompositeOperation="multiply";var b=document.createElement("canvas");b.width=1;b.height=1;var c=b.getContext("2d");c.fillStyle="#fff";c.fillRect(0,0,1,1);a.drawImage(b,0,0,1,1);return 0===a.getImageData(0,0,1,1).data[0]};c._supportCanvasNewBlendModes=c._canUseCanvasNewBlendModes();try{var r=c.localStorage=
d.localStorage;r.setItem("storage","");r.removeItem("storage");r=null}catch(t){r=function(){cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option")},c.localStorage={getItem:r,setItem:r,removeItem:r,clear:r}}r=c.capabilities={canvas:!0};cc._renderType===cc._RENDER_TYPE_WEBGL&&(r.opengl=!0);if(void 0!==g.ontouchstart||void 0!==f.ontouchstart||e.msPointerEnabled)r.touches=!0;void 0!==g.onmouseup&&(r.mouse=!0);void 0!==g.onkeyup&&(r.keyboard=!0);if(d.DeviceMotionEvent||
d.DeviceOrientationEvent)r.accelerometer=!0;c.garbageCollect=function(){};c.dumpRoot=function(){};c.restartVM=function(){};c.cleanScript=function(a){};c.isObjectValid=function(a){return a?!0:!1};c.dump=function(){var a;a=""+("isMobile : "+this.isMobile+"\r\n");a+="language : "+this.language+"\r\n";a+="browserType : "+this.browserType+"\r\n";a+="capabilities : "+JSON.stringify(this.capabilities)+"\r\n";a+="os : "+this.os+"\r\n";a+="platform : "+this.platform+"\r\n";cc.log(a)};c.openURL=function(a){window.open(a)}};
...
Object.defineProperty(d.prototype,"constructor",h);this.__getters__&&(d.__getters__=cc.clone(this.__getters__));this.__setters__&&(d.__setters__=cc.clone(this.__setters__));for(var k=0,m=arguments.length;k<m;++k){var p=arguments[k],r;for(r in p){var t="function"===typeof p[r],u="function"===typeof e[r],x=a.test(p[r]);b&&t&&u&&x?(h.value=ClassManager.compileSuper(p[r],r,g),Object.defineProperty(f,r,h)):t&&u&&x?(h.value=function(a,b){return function(){var c=this._super;this._super=e[a];var d=b.apply(this,
arguments);this._super=c;return d}}(r,p[r]),Object.defineProperty(f,r,h)):t?(h.value=p[r],Object.defineProperty(f,r,h)):f[r]=p[r];if(t){var w,E;if(this.__getters__&&this.__getters__[r]){var t=this.__getters__[r],n;for(n in this.__setters__)if(this.__setters__[n]===t){E=n;break}cc.defineGetterSetter(f,t,p[r],p[E]?p[E]:f[E],r,E)}if(this.__setters__&&this.__setters__[r]){t=this.__setters__[r];for(n in this.__getters__)if(this.__getters__[n]===t){w=n;break}cc.defineGetterSetter(f,t,p[w]?p[w]:f[w],p[r],
w,r)}}}}d.extend=cc.Class.extend;d.implement=function(a){for(var b in a)f[b]=a[b]};return d}})();
cc.defineGetterSetter=function(a,b,c,d,e,f){if(a.__defineGetter__)c&&a.__defineGetter__(b,c),d&&a.__defineSetter__(b,d);else if(Object.defineProperty){var g={enumerable:!1,configurable:!0};c&&(g.get=c);d&&(g.set=d);Object.defineProperty(a,b,g)}else throw Error("browser does not support getters");if(!e&&!f)for(var g=null!=c,h=void 0!=d,k=Object.getOwnPropertyNames(a),m=0;m<k.length;m++){var p=k[m];if((a.__lookupGetter__?!a.__lookupGetter__(p):!Object.getOwnPropertyDescriptor(a,p))&&"function"===typeof a[p]){var r=
a[p];if(g&&r===c&&(e=p,!h||f))break;if(h&&r===d&&(f=p,!g||e))break}}a=a.constructor;e&&(a.__getters__||(a.__getters__={}),a.__getters__[e]=b);f&&(a.__setters__||(a.__setters__={}),a.__setters__[f]=b)};cc.clone=function(a){var b=a.constructor?new a.constructor:{},c;for(c in a){var d=a[c];b[c]="object"!==typeof d||!d||d instanceof cc.Node||d instanceof HTMLElement?d:cc.clone(d)}return b};cc.inject=function(a,b){for(var c in a)b[c]=a[c]};cc=cc||{};cc._tmp=cc._tmp||{};cc.associateWithNative=function(a,b){};
...
(function(){var a=cc.ContainerStrategy.extend({apply:function(a){this._setupContainer(a,a._frameSize.width,a._frameSize.height)}}),b=cc.ContainerStrategy.extend({apply:function(a,b){var c=a._frameSize.width,d=a._frameSize.height,e=cc.container.style,p=b.width,r=b.height,t=c/p,u=d/r,x,w;t<u?(x=c,w=r*t):(x=p*u,w=d);p=Math.round((c-x)/2);w=Math.round((d-w)/2);this._setupContainer(a,c-2*p,d-2*w);e.marginLeft=p+"px";e.marginRight=p+"px";e.marginTop=w+"px";e.marginBottom=w+"px"}});a.extend({preApply:function(a){this._super(a);
...
cc.pSubIn=function(a,b){a.x-=b.x;a.y-=b.y};cc.pAddIn=function(a,b){a.x+=b.x;a.y+=b.y};cc.pNormalizeIn=function(a){cc.pMultIn(a,1/Math.sqrt(a.x*a.x+a.y*a.y))};cc.vertexLineToPolygon=function(a,b,c,d,e){e+=d;if(!(1>=e)){b*=0.5;for(var f,g=e-1,h=d;h<e;h++){f=2*h;var k=cc.p(a[2*h],a[2*h+1]),m;if(0===h)m=cc.pPerp(cc.pNormalize(cc.pSub(k,cc.p(a[2*(h+1)],a[2*(h+1)+1]))));else if(h===g)m=cc.pPerp(cc.pNormalize(cc.pSub(cc.p(a[2*(h-1)],a[2*(h-1)+1]),k)));else{m=cc.p(a[2*(h-1)],a[2*(h-1)+1]);var p=cc.p(a[2*(h+1)],a[2*(h+1)+1]),r=cc.pNormalize(cc.pSub(p,k)),t=cc.pNormalize(cc.pSub(m,k)),u=Math.acos(cc.pDot(r,t));m=u<cc.degreesToRadians(70)?cc.pPerp(cc.pNormalize(cc.pMidpoint(r,
t))):u<cc.degreesToRadians(170)?cc.pNormalize(cc.pMidpoint(r,t)):cc.pPerp(cc.pNormalize(cc.pSub(p,m)))}m=cc.pMult(m,b);c[2*f]=k.x+m.x;c[2*f+1]=k.y+m.y;c[2*(f+1)]=k.x-m.x;c[2*(f+1)+1]=k.y-m.y}for(h=0===d?0:d-1;h<g;h++)f=2*h,a=f+2,b=cc.vertex2(c[2*f],c[2*f+1]),e=cc.vertex2(c[2*(f+1)],c[2*(f+1)+1]),f=cc.vertex2(c[2*a],c[2*a]),d=cc.vertex2(c[2*(a+1)],c[2*(a+1)+1]),b=!cc.vertexLineIntersect(b.x,b.y,d.x,d.y,e.x,e.y,f.x,f.y),!b.isSuccess&&(0>b.value||1<b.value)&&(b.isSuccess=!0),b.isSuccess&&(c[2*a]=d.x,
...
c.tx=a._position.x;c.ty=a._position.y;var d=1,e=0,f=0,g=1;a._rotationX&&(g=0.017453292519943295*a._rotationX,f=Math.sin(g),g=Math.cos(g));a._rotationY&&(e=0.017453292519943295*a._rotationY,d=Math.cos(e),e=-Math.sin(e));c.a=d;c.b=e;c.c=f;c.d=g;var h=a._scaleX,k=a._scaleY,m=this._anchorPointInPoints.x,p=this._anchorPointInPoints.y,r=1E-6>h&&-1E-6<h?1E-6:h,t=1E-6>k&&-1E-6<k?1E-6:k;if(1!==h||1!==k)d=c.a*=r,e=c.b*=r,f=c.c*=t,g=c.d*=t;if(a._skewX||a._skewY)h=Math.tan(-a._skewX*Math.PI/180),k=Math.tan(-a._skewY*
Math.PI/180),Infinity===h&&(h=99999999),Infinity===k&&(k=99999999),r=p*h,t=m*k,c.a=d-f*k,c.b=e-g*k,c.c=f-d*h,c.d=g-e*h,c.tx+=d*r+f*t,c.ty+=e*r+g*t;c.tx-=d*m+f*p;c.ty-=e*m+g*p;a._ignoreAnchorPointForPosition&&(c.tx+=m,c.ty+=p);a._additionalTransformDirty&&(this._transform=cc.affineTransformConcat(c,a._additionalTransform))}return this._transform};a.visit=function(a){var c=this._node;if(c._visible){if(a=a||this.getParentRenderCmd())this._curLevel=a._curLevel+1;var d=c._children,e;this._syncStatus(a);
...
g||(8<=m?k=d.PIXEL_FORMAT_RGB888:(cc.log(cc._LogInfos.Texture2D__initPremultipliedATextureWithImage),k=d.PIXEL_FORMAT_RGB565));var p=b*c;if(k===d.PIXEL_FORMAT_RGB565)if(g)for(e=new Uint16Array(b*c),f=a.getData(),m=0;m<p;++m)e[m]=(f[m]>>0&255)>>3<<11|(f[m]>>8&255)>>2<<5|(f[m]>>16&255)>>3<<0;else for(e=new Uint16Array(b*c),f=a.getData(),m=0;m<p;++m)e[m]=(f[m]&255)>>3<<11|(f[m]&255)>>2<<5|(f[m]&255)>>3<<0;else if(k===d.PIXEL_FORMAT_RGBA4444)for(e=new Uint16Array(b*c),f=a.getData(),m=0;m<p;++m)e[m]=(f[m]>>
0&255)>>4<<12|(f[m]>>8&255)>>4<<8|(f[m]>>16&255)>>4<<4|(f[m]>>24&255)>>4<<0;else if(k===d.PIXEL_FORMAT_RGB5A1)for(e=new Uint16Array(b*c),f=a.getData(),m=0;m<p;++m)e[m]=(f[m]>>0&255)>>3<<11|(f[m]>>8&255)>>3<<6|(f[m]>>16&255)>>3<<1|(f[m]>>24&255)>>7<<0;else if(k===d.PIXEL_FORMAT_A8)for(e=new Uint8Array(b*c),f=a.getData(),m=0;m<p;++m)e[m]=f>>24&255;if(g&&k===d.PIXEL_FORMAT_RGB888)for(f=a.getData(),e=new Uint8Array(b*c*3),m=0;m<p;++m)e[3*m]=f>>0&255,e[3*m+1]=f>>8&255,e[3*m+2]=f>>16&255;this.initWithData(e,
...
!0;var d=c.length,e=2*d,f,g=a._contentSize;this._squareVerticesAB=new ArrayBuffer(8*e);this._squareColorsAB=new ArrayBuffer(4*e);var h=this._squareVertices,k=this._squareColors;h.length=0;k.length=0;var m=this._squareVerticesAB,p=this._squareColorsAB,r=cc.Vertex2F.BYTES_PER_ELEMENT,t=cc.Color.BYTES_PER_ELEMENT;for(f=0;f<e;f++)h.push(new cc.Vertex2F(0,0,m,r*f)),k.push(cc.color(0,0,0,255,p,t*f));p=Math.PI+cc.pAngleSigned(cc.p(0,-1),a._alongVector);a=cc.p(g.width/2,g.height/2);f=Math.round(cc.radiansToDegrees(p));
e=cc.affineTransformMake(1,0,0,1,a.x,a.y);e=cc.affineTransformRotate(e,p);90>f?(r=cc.p(-a.x,a.y),f=cc.p(a.x,a.y)):180>f?(r=cc.p(a.x,a.y),f=cc.p(a.x,-a.y)):270>f?(r=cc.p(a.x,-a.y),f=cc.p(-a.x,-a.y)):(r=cc.p(-a.x,-a.y),f=cc.p(-a.x,a.y));m=Math.sin(p);p=Math.cos(p);r=Math.abs((r.x*p-r.y*m)/a.x);f=Math.abs((f.x*m+f.y*p)/a.y);e=cc.affineTransformScale(e,r,f);for(f=0;f<d;f++)m=c[f].p*g.height,p=cc.pointApplyAffineTransform(-a.x,m-a.y,e),h[2*f].x=p.x,h[2*f].y=p.y,m=cc.pointApplyAffineTransform(g.width-a.x,
...
a.url));this._node._originalTexture=a};a.rendering=function(a,c,d){var e=this._node,f=this._textureCoord,g=this._displayedOpacity/255;if((!e._texture||0!==f.width&&0!==f.height&&e._texture._textureLoaded)&&0!==g){a=a||cc._renderContext;var h=a.getContext(),k=e._offsetPosition.x,m=e._rect.height,p=e._rect.width,r=-e._offsetPosition.y-m;a.setTransform(this._worldTransform,c,d);a.setCompositeOperation(this._blendFuncStr);a.setGlobalAlpha(g);(e._flippedX||e._flippedY)&&a.save();e._flippedX&&(k=-k-p,h.scale(-1,
1));e._flippedY&&(r=e._offsetPosition.y,h.scale(1,-1));e._texture?(g=e._texture._htmlElementObj,""!==e._texture._pattern?(a.setFillStyle(h.createPattern(g,e._texture._pattern)),h.fillRect(k*c,r*d,p*c,m*d)):this._colorized?h.drawImage(g,0,0,f.width,f.height,k*c,r*d,p*c,m*d):h.drawImage(g,f.renderX,f.renderY,f.width,f.height,k*c,r*d,p*c,m*d)):(g=e._contentSize,f.validRect&&(f=this._displayedColor,a.setFillStyle("rgba("+f.r+","+f.g+","+f.b+",1)"),h.fillRect(k*c,r*d,g.width*c,g.height*d)));(e._flippedX||
...
cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor,e=a.width,h=a.height;d[0].width=e;d[0].height=h;d[1].width=e;d[1].height=h;d[2].width=e;d[2].height=h;d[3].width=e;d[3].height=h;c.canvas.width=e;c.canvas.height=h;var k=c.canvas.getContext("2d");k.drawImage(a,0,0);c.tempCanvas.width=e;c.tempCanvas.height=h;for(var k=k.getImageData(0,0,e,h).data,m=0;4>m;m++){var p=d[m].getContext("2d");p.getImageData(0,0,e,h).data;c.tempCtx.drawImage(a,0,0);for(var r=c.tempCtx.getImageData(0,0,e,h),t=r.data,
u=0;u<k.length;u+=4)t[u]=0===m?k[u]:0,t[u+1]=1===m?k[u+1]:0,t[u+2]=2===m?k[u+2]:0,t[u+3]=k[u+3];p.putImageData(r,0,0)}a.onload=null}if(a.channelCache)return a.channelCache;var d=[cc.newElement("canvas"),cc.newElement("canvas"),cc.newElement("canvas"),cc.newElement("canvas")];try{c()}catch(e){a.onload=c}return a.channelCache=d};cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor.canvas=cc.newElement("canvas");cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor.tempCanvas=cc.newElement("canvas");
...
a._rect,d=a._offsetPosition.x,g=a._offsetPosition.y,h=d+f.width,k=g+f.height,m=e.tx,p=e.ty,r=e.a,t=e.b,u=e.d,x=-e.c,e=d*r-g*x+m,f=d*t+g*u+p,w=h*r-g*x+m,g=h*t+g*u+p,E=h*r-k*x+m,h=h*t+k*u+p,m=d*r-k*x+m,d=d*t+k*u+p,k=a._vertexZ;cc.SPRITEBATCHNODE_RENDER_SUBPIXEL||(e|=0,f|=0,w|=0,g|=0,E|=0,h|=0,m|=0,d|=0);c.bl.vertices={x:e,y:f,z:k};c.br.vertices={x:w,y:g,z:k};c.tl.vertices={x:m,y:d,z:k};c.tr.vertices={x:E,y:h,z:k}}a.textureAtlas.updateQuad(c,a.atlasIndex);this._dirty=a._recursiveDirty=!1}a._hasChildren&&
...
function(a){if(a){var c=this._node,d=c._strokeShadowOffsetX,e=c._strokeShadowOffsetY,f=c._contentSize.height-e,g=c._vAlignment,h=c._hAlignment,k=c._strokeSize;a.setTransform(1,0,0,1,0.5*d,f+0.5*e);a.font!==this._fontStyleStr&&(a.font=this._fontStyleStr);a.fillStyle=this._fillColorStr;var m=e=0,p=c._strokeEnabled;p&&(a.lineWidth=2*k,a.strokeStyle=this._strokeColorStr);c._shadowEnabled&&(k=c._shadowOffset,a.shadowColor=this._shadowColorStr,a.shadowOffsetX=k.x,a.shadowOffsetY=-k.y,a.shadowBlur=c._shadowBlur);
a.textBaseline=cc.LabelTTF._textBaseline[g];a.textAlign=cc.LabelTTF._textAlign[h];var r=c._contentSize.width-d,d=c.getLineHeight(),k=(d-this._fontClientHeight)/2,e=h===cc.TEXT_ALIGNMENT_RIGHT?e+r:h===cc.TEXT_ALIGNMENT_CENTER?e+r/2:e+0;if(this._isMultiLine)for(c=this._strings.length,g===cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM?m=d-2*k+f-d*c:g===cc.VERTICAL_TEXT_ALIGNMENT_CENTER&&(m=(d-2*k)/2+(f-d*c)/2),g=0;g<c;g++)h=this._strings[g],r=-f+(d*g+k)+m,p&&a.strokeText(h,e,r),a.fillText(h,e,r);else g!==cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM&&
(m=g===cc.VERTICAL_TEXT_ALIGNMENT_TOP?m-f:m-0.5*f),p&&a.strokeText(c._string,e,m),a.fillText(c._string,e,m)}};a._checkWarp=function(a,c,d){var e=a[c],f=this._measure(e);if(f>d&&1<e.length){for(var g=d/f*e.length|0,h=e.substr(g),k=f-this._measure(h),m,p=0,r=0;k>d&&100>r++;)g*=d/k,g|=0,h=e.substr(g),k=f-this._measure(h);for(r=0;k<d&&100>r++;)h&&(p=(m=cc.LabelTTF._wordRex.exec(h))?m[0].length:1,m=h),g+=p,h=e.substr(g),k=f-this._measure(h);g-=p;0===g&&(g=1,m=m.substr(1));d=e.substr(0,g);cc.LabelTTF.wrapInspection&&
...
a.y;this.z-=a.z;this.w-=a.w};b.transform=function(a){var b=this.x,e=this.y,f=this.z,g=this.w;a=a.mat;this.x=b*a[0]+e*a[4]+f*a[8]+g*a[12];this.y=b*a[1]+e*a[5]+f*a[9]+g*a[13];this.z=b*a[2]+e*a[6]+f*a[10]+g*a[14];this.w=b*a[3]+e*a[7]+f*a[11]+g*a[15];return this};a.math.Vec4.transformArray=function(c,b){for(var e=[],f=0;f<c.length;f++){var g=new a.math.Vec4(c[f]);g.transform(b);e.push(g)}return e};b.equals=function(c){var b=a.math.EPSILON;return this.x<c.x+b&&this.x>c.x-b&&this.y<c.y+b&&this.y>c.y-b&&
this.z<c.z+b&&this.z>c.z-b&&this.w<c.w+b&&this.w>c.w-b};b.assignFrom=function(a){this.x=a.x;this.y=a.y;this.z=a.z;this.w=a.w;return this};b.toTypeArray=function(){var a=new Float32Array(4);a[0]=this.x;a[1]=this.y;a[2]=this.z;a[3]=this.w;return a}})(cc);(function(a){function b(c,b,e){b=new a.math.Vec2(b);b.subtract(c);e.x=-b.y;e.y=b.x;e.normalize()}a.math.Ray2=function(c,b){this.start=c||new a.math.Vec2;this.dir=b||new a.math.Vec2};a.math.Ray2.prototype.fill=function(a,b,e,f){this.start.x=a;this.start.y=b;this.dir.x=e;this.dir.y=f};a.math.Ray2.prototype.intersectLineSegment=function(c,b,e){var f=this.start.x,g=this.start.y,h=this.start.x+this.dir.x,k=this.start.y+this.dir.y,m=c.x,p=c.y,r=b.x,t=b.y,u=(t-p)*(h-f)-(r-m)*(k-g);if(u>-a.math.EPSILON&&
u<a.math.EPSILON)return!1;p=((r-m)*(g-p)-(t-p)*(f-m))/u;m=f+p*(h-f);p=g+p*(k-g);if(m<Math.min(c.x,b.x)-a.math.EPSILON||m>Math.max(c.x,b.x)+a.math.EPSILON||p<Math.min(c.y,b.y)-a.math.EPSILON||p>Math.max(c.y,b.y)+a.math.EPSILON||m<Math.min(f,h)-a.math.EPSILON||m>Math.max(f,h)+a.math.EPSILON||p<Math.min(g,k)-a.math.EPSILON||p>Math.max(g,k)+a.math.EPSILON)return!1;e.x=m;e.y=p;return!0};a.math.Ray2.prototype.intersectTriangle=function(c,d,e,f,g){var h=new a.math.Vec2,k=new a.math.Vec2,m=new a.math.Vec2,
p=1E4,r=!1,t;this.intersectLineSegment(c,d,h)&&(r=!0,t=h.subtract(this.start).length(),t<p&&(k.x=h.x,k.y=h.y,p=t,b(c,d,m)));this.intersectLineSegment(d,e,h)&&(r=!0,t=h.subtract(this.start).length(),t<p&&(k.x=h.x,k.y=h.y,p=t,b(d,e,m)));this.intersectLineSegment(e,c,h)&&(r=!0,t=h.subtract(this.start).length(),t<p&&(k.x=h.x,k.y=h.y,b(e,c,m)));r&&(f.x=k.x,f.y=k.y,g&&(g.x=m.x,g.y=m.y));return r}})(cc);window.Uint16Array=window.Uint16Array||window.Array;window.Float32Array=window.Float32Array||window.Array;
(function(a){a.math.Matrix3=function(a){this.mat=a&&a.mat?new Float32Array(a.mat):new Float32Array(9)};a.kmMat3=a.math.Matrix3;var b=a.math.Matrix3.prototype;b.fill=function(a){var c=this.mat;a=a.mat;c[0]=a[0];c[1]=a[1];c[2]=a[2];c[3]=a[3];c[4]=a[4];c[5]=a[5];c[6]=a[6];c[7]=a[7];c[8]=a[8];return this};b.adjugate=function(){var a=this.mat,c=a[0],b=a[1],g=a[2],h=a[3],k=a[4],m=a[5],p=a[6],r=a[7],t=a[8];a[0]=k*t-m*r;a[1]=g*r-b*t;a[2]=b*m-g*k;a[3]=m*p-h*t;a[4]=c*t-g*p;a[5]=g*h-c*m;a[6]=h*r-k*p;a[8]=c*
k-b*h;return this};b.identity=function(){var a=this.mat;a[1]=a[2]=a[3]=a[5]=a[6]=a[7]=0;a[0]=a[4]=a[8]=1;return this};var c=new a.math.Matrix3;b.inverse=function(a){if(0===a)return this;c.assignFrom(this);a=1/a;this.adjugate();this.multiplyScalar(a);return this};b.isIdentity=function(){var a=this.mat;return 1===a[0]&&0===a[1]&&0===a[2]&&0===a[3]&&1===a[4]&&0===a[5]&&0===a[6]&&0===a[7]&&1===a[8]};b.transpose=function(){var a=this.mat,c=a[1],b=a[2],g=a[5],h=a[6],k=a[7];a[1]=a[3];a[2]=h;a[3]=c;a[5]=
k;a[6]=b;a[7]=g;return this};b.determinant=function(){var a=this.mat,c=a[0]*a[4]*a[8]+a[1]*a[5]*a[6]+a[2]*a[3]*a[7];return c-=a[2]*a[4]*a[6]+a[0]*a[5]*a[7]+a[1]*a[3]*a[8]};b.multiply=function(a){var c=this.mat,b=a.mat;a=c[0];var g=c[1],h=c[2],k=c[3],m=c[4],p=c[5],r=c[6],t=c[7],u=c[8],x=b[0],w=b[1],E=b[2],n=b[3],M=b[4],B=b[5],D=b[6],N=b[7],b=b[8];c[0]=a*x+k*w+r*E;c[1]=g*x+m*w+t*E;c[2]=h*x+p*w+u*E;c[3]=h*x+p*w+u*E;c[4]=g*n+m*M+t*B;c[5]=h*n+p*M+u*B;c[6]=a*D+k*N+r*b;c[7]=g*D+m*N+t*b;c[8]=h*D+p*N+u*b;
return this};b.multiplyScalar=function(a){var c=this.mat;c[0]*=a;c[1]*=a;c[2]*=a;c[3]*=a;c[4]*=a;c[5]*=a;c[6]*=a;c[7]*=a;c[8]*=a;return this};a.math.Matrix3.rotationAxisAngle=function(c,b){var f=Math.cos(b),g=Math.sin(b),h=new a.math.Matrix3,k=h.mat;k[0]=f+c.x*c.x*(1-f);k[1]=c.z*g+c.y*c.x*(1-f);k[2]=-c.y*g+c.z*c.x*(1-f);k[3]=-c.z*g+c.x*c.y*(1-f);k[4]=f+c.y*c.y*(1-f);k[5]=c.x*g+c.z*c.y*(1-f);k[6]=c.y*g+c.x*c.z*(1-f);k[7]=-c.x*g+c.y*c.z*(1-f);k[8]=f+c.z*c.z*(1-f);return h};b.assignFrom=function(c){if(this===
c)return a.log("cc.math.Matrix3.assign(): current matrix equals matIn"),this;var b=this.mat;c=c.mat;b[0]=c[0];b[1]=c[1];b[2]=c[2];b[3]=c[3];b[4]=c[4];b[5]=c[5];b[6]=c[6];b[7]=c[7];b[8]=c[8];return this};b.equals=function(c){if(this===c)return!0;var b=a.math.EPSILON,f=this.mat;c=c.mat;for(var g=0;9>g;++g)if(!(f[g]+b>c[g]&&f[g]-b<c[g]))return!1;return!0};a.math.Matrix3.createByRotationX=function(c){var b=new a.math.Matrix3,f=b.mat;f[0]=1;f[1]=0;f[2]=0;f[3]=0;f[4]=Math.cos(c);f[5]=Math.sin(c);f[6]=0;
f[7]=-Math.sin(c);f[8]=Math.cos(c);return b};a.math.Matrix3.createByRotationY=function(c){var b=new a.math.Matrix3,f=b.mat;f[0]=Math.cos(c);f[1]=0;f[2]=-Math.sin(c);f[3]=0;f[4]=1;f[5]=0;f[6]=Math.sin(c);f[7]=0;f[8]=Math.cos(c);return b};a.math.Matrix3.createByRotationZ=function(c){var b=new a.math.Matrix3,f=b.mat;f[0]=Math.cos(c);f[1]=-Math.sin(c);f[2]=0;f[3]=Math.sin(c);f[4]=Math.cos(c);f[5]=0;f[6]=0;f[7]=0;f[8]=1;return b};a.math.Matrix3.createByRotation=function(c){var b=new a.math.Matrix3,f=b.mat;
f[0]=Math.cos(c);f[1]=Math.sin(c);f[2]=0;f[3]=-Math.sin(c);f[4]=Math.cos(c);f[5]=0;f[6]=0;f[7]=0;f[8]=1;return b};a.math.Matrix3.createByScale=function(c,b){var f=new a.math.Matrix3;f.identity();f.mat[0]=c;f.mat[4]=b;return f};a.math.Matrix3.createByTranslation=function(c,b){var f=new a.math.Matrix3;f.identity();f.mat[6]=c;f.mat[7]=b;return f};a.math.Matrix3.createByQuaternion=function(c){if(!c)return null;var b=new a.math.Matrix3,f=b.mat;f[0]=1-2*(c.y*c.y+c.z*c.z);f[1]=2*(c.x*c.y-c.w*c.z);f[2]=2*
(c.x*c.z+c.w*c.y);f[3]=2*(c.x*c.y+c.w*c.z);f[4]=1-2*(c.x*c.x+c.z*c.z);f[5]=2*(c.y*c.z-c.w*c.x);f[6]=2*(c.x*c.z-c.w*c.y);f[7]=2*(c.y*c.z+c.w*c.x);f[8]=1-2*(c.x*c.x+c.y*c.y);return b};b.rotationToAxisAngle=function(){return a.math.Quaternion.rotationMatrix(this).toAxisAndAngle()}})(cc);(function(a){a.math.Matrix4=function(a){this.mat=a&&a.mat?new Float32Array(a.mat):new Float32Array(16)};a.kmMat4=a.math.Matrix4;var b=a.math.Matrix4.prototype;b.fill=function(a){for(var c=this.mat,b=0;16>b;b++)c[b]=a[b];return this};a.kmMat4Identity=function(a){var c=a.mat;c[1]=c[2]=c[3]=c[4]=c[6]=c[7]=c[8]=c[9]=c[11]=c[12]=c[13]=c[14]=0;c[0]=c[5]=c[10]=c[15]=1;return a};b.identity=function(){var a=this.mat;a[1]=a[2]=a[3]=a[4]=a[6]=a[7]=a[8]=a[9]=a[11]=a[12]=a[13]=a[14]=0;a[0]=a[5]=a[10]=a[15]=1;
return this};b.get=function(a,c){return this.mat[a+4*c]};b.set=function(a,c,b){this.mat[a+4*c]=b};b.swap=function(a,c,b,d){var k=this.mat,m=k[a+4*c];k[a+4*c]=k[b+4*d];k[b+4*d]=m};a.math.Matrix4._gaussj=function(a,c){var b,d=0,k=0,m,p,r,t,u=[0,0,0,0],x=[0,0,0,0],w=[0,0,0,0];for(b=0;4>b;b++){for(m=t=0;4>m;m++)if(1!==w[m])for(p=0;4>p;p++)0===w[p]&&(r=Math.abs(a.get(m,p)),r>=t&&(t=r,k=m,d=p));++w[d];if(k!==d){for(m=0;4>m;m++)a.swap(k,m,d,m);for(m=0;4>m;m++)c.swap(k,m,d,m)}x[b]=k;u[b]=d;if(0===a.get(d,
d))return!1;p=1/a.get(d,d);a.set(d,d,1);for(m=0;4>m;m++)a.set(d,m,a.get(d,m)*p);for(m=0;4>m;m++)c.set(d,m,c.get(d,m)*p);for(p=0;4>p;p++)if(p!==d){r=a.get(p,d);a.set(p,d,0);for(m=0;4>m;m++)a.set(p,m,a.get(p,m)-a.get(d,m)*r);for(m=0;4>m;m++)c.set(p,m,a.get(p,m)-c.get(d,m)*r)}}for(m=3;0<=m;m--)if(x[m]!==u[m])for(p=0;4>p;p++)a.swap(p,x[m],p,u[m]);return!0};var c=(new a.math.Matrix4).identity();a.kmMat4Inverse=function(b,d){var g=new a.math.Matrix4(d),h=new a.math.Matrix4(c);if(!1===a.math.Matrix4._gaussj(g,
h))return null;b.assignFrom(g);return b};b.inverse=function(){var b=new a.math.Matrix4(this),d=new a.math.Matrix4(c);return!1===a.math.Matrix4._gaussj(b,d)?null:b};b.isIdentity=function(){var a=this.mat;return 1===a[0]&&0===a[1]&&0===a[2]&&0===a[3]&&0===a[4]&&1===a[5]&&0===a[6]&&0===a[7]&&0===a[8]&&0===a[9]&&1===a[10]&&0===a[11]&&0===a[12]&&0===a[13]&&0===a[14]&&1===a[15]};b.transpose=function(){var a=this.mat,c=a[1],b=a[2],d=a[3],k=a[6],m=a[7],p=a[8],r=a[9],t=a[11],u=a[12],x=a[13],w=a[14];a[1]=a[4];
a[2]=p;a[3]=u;a[4]=c;a[6]=r;a[7]=x;a[8]=b;a[9]=k;a[11]=w;a[12]=d;a[13]=m;a[14]=t;return this};a.kmMat4Multiply=function(a,c,b){var d=a.mat,k=c.mat,m=b.mat;b=k[0];c=k[1];var p=k[2],r=k[3],t=k[4],u=k[5],x=k[6],w=k[7],E=k[8],n=k[9],M=k[10],B=k[11],D=k[12],N=k[13],y=k[14],k=k[15],C=m[0],z=m[1],I=m[2],G=m[3],H=m[4],X=m[5],Y=m[6],R=m[7],J=m[8],Z=m[9],T=m[10],da=m[11],V=m[12],ba=m[13],ha=m[14],m=m[15];d[0]=C*b+z*t+I*E+G*D;d[1]=C*c+z*u+I*n+G*N;d[2]=C*p+z*x+I*M+G*y;d[3]=C*r+z*w+I*B+G*k;d[4]=H*b+X*t+Y*E+R*
D;d[5]=H*c+X*u+Y*n+R*N;d[6]=H*p+X*x+Y*M+R*y;d[7]=H*r+X*w+Y*B+R*k;d[8]=J*b+Z*t+T*E+da*D;d[9]=J*c+Z*u+T*n+da*N;d[10]=J*p+Z*x+T*M+da*y;d[11]=J*r+Z*w+T*B+da*k;d[12]=V*b+ba*t+ha*E+m*D;d[13]=V*c+ba*u+ha*n+m*N;d[14]=V*p+ba*x+ha*M+m*y;d[15]=V*r+ba*w+ha*B+m*k;return a};b.multiply=function(a){var c=this.mat,b=a.mat;a=c[0];var d=c[1],k=c[2],m=c[3],p=c[4],r=c[5],t=c[6],u=c[7],x=c[8],w=c[9],E=c[10],n=c[11],M=c[12],B=c[13],D=c[14],N=c[15],y=b[0],C=b[1],z=b[2],I=b[3],G=b[4],H=b[5],X=b[6],Y=b[7],R=b[8],J=b[9],Z=
b[10],T=b[11],da=b[12],V=b[13],ba=b[14],b=b[15];c[0]=y*a+C*p+z*x+I*M;c[1]=y*d+C*r+z*w+I*B;c[2]=y*k+C*t+z*E+I*D;c[3]=y*m+C*u+z*n+I*N;c[4]=G*a+H*p+X*x+Y*M;c[5]=G*d+H*r+X*w+Y*B;c[6]=G*k+H*t+X*E+Y*D;c[7]=G*m+H*u+X*n+Y*N;c[8]=R*a+J*p+Z*x+T*M;c[9]=R*d+J*r+Z*w+T*B;c[10]=R*k+J*t+Z*E+T*D;c[11]=R*m+J*u+Z*n+T*N;c[12]=da*a+V*p+ba*x+b*M;c[13]=da*d+V*r+ba*w+b*B;c[14]=da*k+V*t+ba*E+b*D;c[15]=da*m+V*u+ba*n+b*N;return this};a.getMat4MultiplyValue=function(a,c){var b=a.mat,d=c.mat,k=new Float32Array(16);k[0]=b[0]*
d[0]+b[4]*d[1]+b[8]*d[2]+b[12]*d[3];k[1]=b[1]*d[0]+b[5]*d[1]+b[9]*d[2]+b[13]*d[3];k[2]=b[2]*d[0]+b[6]*d[1]+b[10]*d[2]+b[14]*d[3];k[3]=b[3]*d[0]+b[7]*d[1]+b[11]*d[2]+b[15]*d[3];k[4]=b[0]*d[4]+b[4]*d[5]+b[8]*d[6]+b[12]*d[7];k[5]=b[1]*d[4]+b[5]*d[5]+b[9]*d[6]+b[13]*d[7];k[6]=b[2]*d[4]+b[6]*d[5]+b[10]*d[6]+b[14]*d[7];k[7]=b[3]*d[4]+b[7]*d[5]+b[11]*d[6]+b[15]*d[7];k[8]=b[0]*d[8]+b[4]*d[9]+b[8]*d[10]+b[12]*d[11];k[9]=b[1]*d[8]+b[5]*d[9]+b[9]*d[10]+b[13]*d[11];k[10]=b[2]*d[8]+b[6]*d[9]+b[10]*d[10]+b[14]*
d[11];k[11]=b[3]*d[8]+b[7]*d[9]+b[11]*d[10]+b[15]*d[11];k[12]=b[0]*d[12]+b[4]*d[13]+b[8]*d[14]+b[12]*d[15];k[13]=b[1]*d[12]+b[5]*d[13]+b[9]*d[14]+b[13]*d[15];k[14]=b[2]*d[12]+b[6]*d[13]+b[10]*d[14]+b[14]*d[15];k[15]=b[3]*d[12]+b[7]*d[13]+b[11]*d[14]+b[15]*d[15];return k};a.kmMat4Assign=function(c,b){if(c===b)return a.log("cc.kmMat4Assign(): pOut equals pIn"),c;var d=c.mat,h=b.mat;d[0]=h[0];d[1]=h[1];d[2]=h[2];d[3]=h[3];d[4]=h[4];d[5]=h[5];d[6]=h[6];d[7]=h[7];d[8]=h[8];d[9]=h[9];d[10]=h[10];d[11]=
h[11];d[12]=h[12];d[13]=h[13];d[14]=h[14];d[15]=h[15];return c};b.assignFrom=function(c){if(this===c)return a.log("cc.mat.Matrix4.assignFrom(): mat4 equals current matrix"),this;var b=this.mat;c=c.mat;b[0]=c[0];b[1]=c[1];b[2]=c[2];b[3]=c[3];b[4]=c[4];b[5]=c[5];b[6]=c[6];b[7]=c[7];b[8]=c[8];b[9]=c[9];b[10]=c[10];b[11]=c[11];b[12]=c[12];b[13]=c[13];b[14]=c[14];b[15]=c[15];return this};b.equals=function(c){if(this===c)return a.log("cc.kmMat4AreEqual(): pMat1 and pMat2 are same object."),!0;var b=this.mat;
c=c.mat;for(var d=a.math.EPSILON,h=0;16>h;h++)if(!(b[h]+d>c[h]&&b[h]-d<c[h]))return!1;return!0};a.math.Matrix4.createByRotationX=function(c,b){b=b||new a.math.Matrix4;var d=b.mat;d[0]=1;d[3]=d[2]=d[1]=0;d[4]=0;d[5]=Math.cos(c);d[6]=Math.sin(c);d[7]=0;d[8]=0;d[9]=-Math.sin(c);d[10]=Math.cos(c);d[11]=0;d[14]=d[13]=d[12]=0;d[15]=1;return b};a.math.Matrix4.createByRotationY=function(c,b){b=b||new a.math.Matrix4;var d=b.mat;d[0]=Math.cos(c);d[1]=0;d[2]=-Math.sin(c);d[3]=0;d[7]=d[6]=d[4]=0;d[5]=1;d[8]=
Math.sin(c);d[9]=0;d[10]=Math.cos(c);d[11]=0;d[14]=d[13]=d[12]=0;d[15]=1;return b};a.math.Matrix4.createByRotationZ=function(c,b){b=b||new a.math.Matrix4;var d=b.mat;d[0]=Math.cos(c);d[1]=Math.sin(c);d[3]=d[2]=0;d[4]=-Math.sin(c);d[5]=Math.cos(c);d[7]=d[6]=0;d[11]=d[9]=d[8]=0;d[10]=1;d[14]=d[13]=d[12]=0;d[15]=1;return b};a.math.Matrix4.createByPitchYawRoll=function(c,b,d,h){h=h||new a.math.Matrix4;var k=Math.cos(c);c=Math.sin(c);var m=Math.cos(b);b=Math.sin(b);var p=Math.cos(d);d=Math.sin(d);var r=
c*b,t=k*b,u=h.mat;u[0]=m*p;u[4]=m*d;u[8]=-b;u[1]=r*p-k*d;u[5]=r*d+k*p;u[9]=c*m;u[2]=t*p+c*d;u[6]=t*d-c*p;u[10]=k*m;u[3]=u[7]=u[11]=0;u[15]=1;return h};a.math.Matrix4.createByQuaternion=function(c,b){b=b||new a.math.Matrix4;var d=b.mat;d[0]=1-2*(c.y*c.y+c.z*c.z);d[1]=2*(c.x*c.y+c.z*c.w);d[2]=2*(c.x*c.z-c.y*c.w);d[3]=0;d[4]=2*(c.x*c.y-c.z*c.w);d[5]=1-2*(c.x*c.x+c.z*c.z);d[6]=2*(c.z*c.y+c.x*c.w);d[7]=0;d[8]=2*(c.x*c.z+c.y*c.w);d[9]=2*(c.y*c.z-c.x*c.w);d[10]=1-2*(c.x*c.x+c.y*c.y);d[11]=0;d[14]=d[13]=
d[12]=0;d[15]=1;return b};a.math.Matrix4.createByRotationTranslation=function(c,b,d){d=d||new a.math.Matrix4;var h=d.mat;c=c.mat;h[0]=c[0];h[1]=c[1];h[2]=c[2];h[3]=0;h[4]=c[3];h[5]=c[4];h[6]=c[5];h[7]=0;h[8]=c[6];h[9]=c[7];h[10]=c[8];h[11]=0;h[12]=b.x;h[13]=b.y;h[14]=b.z;h[15]=1;return d};a.math.Matrix4.createByScale=function(c,b,d,h){h=h||new a.math.Matrix4;var k=h.mat;k[0]=c;k[5]=b;k[10]=d;k[15]=1;k[1]=k[2]=k[3]=k[4]=k[6]=k[7]=k[8]=k[9]=k[11]=k[12]=k[13]=k[14]=0;return h};a.kmMat4Translation=function(a,
c,b,d){a.mat[0]=a.mat[5]=a.mat[10]=a.mat[15]=1;a.mat[1]=a.mat[2]=a.mat[3]=a.mat[4]=a.mat[6]=a.mat[7]=a.mat[8]=a.mat[9]=a.mat[11]=0;a.mat[12]=c;a.mat[13]=b;a.mat[14]=d;return a};a.math.Matrix4.createByTranslation=function(c,b,d,h){h=h||new a.math.Matrix4;h.identity();h.mat[12]=c;h.mat[13]=b;h.mat[14]=d;return h};b.getUpVec3=function(){var c=this.mat;return(new a.math.Vec3(c[4],c[5],c[6])).normalize()};b.getRightVec3=function(){var c=this.mat;return(new a.math.Vec3(c[0],c[1],c[2])).normalize()};b.getForwardVec3=
function(){var c=this.mat;return(new a.math.Vec3(c[8],c[9],c[10])).normalize()};a.kmMat4PerspectiveProjection=function(c,b,d,h,k){var m=a.degreesToRadians(b/2);b=k-h;var p=Math.sin(m);if(0===b||0===p||0===d)return null;m=Math.cos(m)/p;c.identity();c.mat[0]=m/d;c.mat[5]=m;c.mat[10]=-(k+h)/b;c.mat[11]=-1;c.mat[14]=-2*h*k/b;c.mat[15]=0;return c};a.math.Matrix4.createPerspectiveProjection=function(c,b,d,h){var k=a.degreesToRadians(c/2);c=h-d;var m=Math.sin(k);if(0===c||0===m||0===b)return null;var k=
Math.cos(k)/m,m=new a.math.Matrix4,p=m.mat;m.identity();p[0]=k/b;p[5]=k;p[10]=-(h+d)/c;p[11]=-1;p[14]=-2*d*h/c;p[15]=0;return m};a.kmMat4OrthographicProjection=function(a,c,b,d,k,m,p){a.identity();a.mat[0]=2/(b-c);a.mat[5]=2/(k-d);a.mat[10]=-2/(p-m);a.mat[12]=-((b+c)/(b-c));a.mat[13]=-((k+d)/(k-d));a.mat[14]=-((p+m)/(p-m));return a};a.math.Matrix4.createOrthographicProjection=function(c,b,d,h,k,m){var p=new a.math.Matrix4,r=p.mat;p.identity();r[0]=2/(b-c);r[5]=2/(h-d);r[10]=-2/(m-k);r[12]=-((b+c)/
(b-c));r[13]=-((h+d)/(h-d));r[14]=-((m+k)/(m-k));return p};a.kmMat4LookAt=function(c,b,d,h){d=new a.math.Vec3(d);var k=new a.math.Vec3(h);d.subtract(b);d.normalize();k.normalize();h=new a.math.Vec3(d);h.cross(k);h.normalize();k=new a.math.Vec3(h);k.cross(d);h.normalize();c.identity();c.mat[0]=h.x;c.mat[4]=h.y;c.mat[8]=h.z;c.mat[1]=k.x;c.mat[5]=k.y;c.mat[9]=k.z;c.mat[2]=-d.x;c.mat[6]=-d.y;c.mat[10]=-d.z;b=a.math.Matrix4.createByTranslation(-b.x,-b.y,-b.z);c.multiply(b);return c};var d=new a.math.Matrix4;
b.lookAt=function(c,b,g){b=new a.math.Vec3(b);var h=new a.math.Vec3(g);g=this.mat;b.subtract(c);b.normalize();h.normalize();var k=new a.math.Vec3(b);k.cross(h);k.normalize();h=new a.math.Vec3(k);h.cross(b);k.normalize();this.identity();g[0]=k.x;g[4]=k.y;g[8]=k.z;g[1]=h.x;g[5]=h.y;g[9]=h.z;g[2]=-b.x;g[6]=-b.y;g[10]=-b.z;d=a.math.Matrix4.createByTranslation(-c.x,-c.y,-c.z,d);this.multiply(d);return this};a.kmMat4RotationAxisAngle=function(c,b,d){var h=Math.cos(d);d=Math.sin(d);b=new a.math.Vec3(b);
b.normalize();c.mat[0]=h+b.x*b.x*(1-h);c.mat[1]=b.z*d+b.y*b.x*(1-h);c.mat[2]=-b.y*d+b.z*b.x*(1-h);c.mat[3]=0;c.mat[4]=-b.z*d+b.x*b.y*(1-h);c.mat[5]=h+b.y*b.y*(1-h);c.mat[6]=b.x*d+b.z*b.y*(1-h);c.mat[7]=0;c.mat[8]=b.y*d+b.x*b.z*(1-h);c.mat[9]=-b.x*d+b.y*b.z*(1-h);c.mat[10]=h+b.z*b.z*(1-h);c.mat[11]=0;c.mat[12]=0;c.mat[13]=0;c.mat[14]=0;c.mat[15]=1;return c};a.math.Matrix4.createByAxisAndAngle=function(c,b,d){d=d||new a.math.Matrix4;var h=this.mat,k=Math.cos(b);b=Math.sin(b);c=new a.math.Vec3(c);c.normalize();
h[0]=k+c.x*c.x*(1-k);h[1]=c.z*b+c.y*c.x*(1-k);h[2]=-c.y*b+c.z*c.x*(1-k);h[3]=0;h[4]=-c.z*b+c.x*c.y*(1-k);h[5]=k+c.y*c.y*(1-k);h[6]=c.x*b+c.z*c.y*(1-k);h[7]=0;h[8]=c.y*b+c.x*c.z*(1-k);h[9]=-c.x*b+c.y*c.z*(1-k);h[10]=k+c.z*c.z*(1-k);h[11]=0;h[12]=h[13]=h[14]=0;h[15]=1;return d};b.extractRotation=function(){var c=new a.math.Matrix3,b=this.mat,d=c.mat;d[0]=b[0];d[1]=b[1];d[2]=b[2];d[3]=b[4];d[4]=b[5];d[5]=b[6];d[6]=b[8];d[7]=b[9];d[8]=b[10];return c};b.extractPlane=function(c){var b=new a.math.Plane,
d=this.mat;switch(c){case a.math.Plane.RIGHT:b.a=d[3]-d[0];b.b=d[7]-d[4];b.c=d[11]-d[8];b.d=d[15]-d[12];break;case a.math.Plane.LEFT:b.a=d[3]+d[0];b.b=d[7]+d[4];b.c=d[11]+d[8];b.d=d[15]+d[12];break;case a.math.Plane.BOTTOM:b.a=d[3]+d[1];b.b=d[7]+d[5];b.c=d[11]+d[9];b.d=d[15]+d[13];break;case a.math.Plane.TOP:b.a=d[3]-d[1];b.b=d[7]-d[5];b.c=d[11]-d[9];b.d=d[15]-d[13];break;case a.math.Plane.FAR:b.a=d[3]-d[2];b.b=d[7]-d[6];b.c=d[11]-d[10];b.d=d[15]-d[14];break;case a.math.Plane.NEAR:b.a=d[3]+d[2];b.b=
d[7]+d[6];b.c=d[11]+d[10];b.d=d[15]+d[14];break;default:a.log("cc.math.Matrix4.extractPlane: Invalid plane index")}c=Math.sqrt(b.a*b.a+b.b*b.b+b.c*b.c);b.a/=c;b.b/=c;b.c/=c;b.d/=c;return b};b.toAxisAndAngle=function(){var c=this.extractRotation();return a.math.Quaternion.rotationMatrix(c).toAxisAndAngle()}})(cc);(function(a){a.math.Plane=function(a,b,e,f){a&&void 0===b?(this.a=a.a,this.b=a.b,this.c=a.c,this.d=a.d):(this.a=a||0,this.b=b||0,this.c=e||0,this.d=f||0)};a.kmPlane=a.math.Plane;var b=a.math.Plane.prototype;a.math.Plane.LEFT=0;a.math.Plane.RIGHT=1;a.math.Plane.BOTTOM=2;a.math.Plane.TOP=3;a.math.Plane.NEAR=4;a.math.Plane.FAR=5;a.math.Plane.POINT_INFRONT_OF_PLANE=0;a.math.Plane.POINT_BEHIND_PLANE=1;a.math.Plane.POINT_ON_PLANE=2;b.dot=function(a){return this.a*a.x+this.b*a.y+this.c*a.z+this.d*a.w};b.dotCoord=
function(a){return this.a*a.x+this.b*a.y+this.c*a.z+this.d};b.dotNormal=function(a){return this.a*a.x+this.b*a.y+this.c*a.z};a.math.Plane.fromPointNormal=function(c,b){return new a.math.Plane(b.x,b.y,b.z,-b.dot(c))};a.math.Plane.fromPoints=function(c,b,e){b=new a.math.Vec3(b);e=new a.math.Vec3(e);var f=new a.math.Plane;b.subtract(c);e.subtract(c);b.cross(e);b.normalize();f.a=b.x;f.b=b.y;f.c=b.z;f.d=b.scale(-1).dot(c);return f};b.normalize=function(){var c=new a.math.Vec3(this.a,this.b,this.c),b=1/
c.length();c.normalize();this.a=c.x;this.b=c.y;this.c=c.z;this.d*=b;return this};b.classifyPoint=function(c){c=this.a*c.x+this.b*c.y+this.c*c.z+this.d;return 0.001<c?a.math.Plane.POINT_INFRONT_OF_PLANE:-0.001>c?a.math.Plane.POINT_BEHIND_PLANE:a.math.Plane.POINT_ON_PLANE}})(cc);(function(a){a.math.Quaternion=function(a,b,e,f){a&&void 0===b?(this.x=a.x,this.y=a.y,this.z=a.z,this.w=a.w):(this.x=a||0,this.y=b||0,this.z=e||0,this.w=f||0)};a.kmQuaternion=a.math.Quaternion;var b=a.math.Quaternion.prototype;b.conjugate=function(a){this.x=-a.x;this.y=-a.y;this.z=-a.z;this.w=a.w;return this};b.dot=function(a){return this.w*a.w+this.x*a.x+this.y*a.y+this.z*a.z};b.exponential=function(){return this};b.identity=function(){this.z=this.y=this.x=0;this.w=1;return this};b.inverse=function(){var c=
this.length();if(Math.abs(c)>a.math.EPSILON)return this.w=this.z=this.y=this.x=0,this;this.conjugate(this).scale(1/c);return this};b.isIdentity=function(){return 0===this.x&&0===this.y&&0===this.z&&1===this.w};b.length=function(){return Math.sqrt(this.lengthSq())};b.lengthSq=function(){return this.x*this.x+this.y*this.y+this.z*this.z+this.w*this.w};b.multiply=function(a){var b=this.x,e=this.y,f=this.z,g=this.w;this.w=g*a.w-b*a.x-e*a.y-f*a.z;this.x=g*a.x+b*a.w+e*a.z-f*a.y;this.y=g*a.y+e*a.w+f*a.x-
b*a.z;this.z=g*a.z+f*a.w+b*a.y-e*a.x;return this};b.normalize=function(){var c=this.length();if(Math.abs(c)<=a.math.EPSILON)throw Error("current quaternion is an invalid value");this.scale(1/c);return this};b.rotationAxis=function(a,b){var e=0.5*b,f=Math.sin(e);this.w=Math.cos(e);this.x=a.x*f;this.y=a.y*f;this.z=a.z*f;return this};a.math.Quaternion.rotationMatrix=function(c){if(!c)return null;var b,e,f;b=[];e=c.mat;c=0;b[0]=e[0];b[1]=e[3];b[2]=e[6];b[4]=e[1];b[5]=e[4];b[6]=e[7];b[8]=e[2];b[9]=e[5];
b[10]=e[8];b[15]=1;var g=b[0];c=g[0]+g[5]+g[10]+1;c>a.math.EPSILON?(c=2*Math.sqrt(c),b=(g[9]-g[6])/c,e=(g[2]-g[8])/c,f=(g[4]-g[1])/c,c*=0.25):g[0]>g[5]&&g[0]>g[10]?(c=2*Math.sqrt(1+g[0]-g[5]-g[10]),b=0.25*c,e=(g[4]+g[1])/c,f=(g[2]+g[8])/c,c=(g[9]-g[6])/c):g[5]>g[10]?(c=2*Math.sqrt(1+g[5]-g[0]-g[10]),b=(g[4]+g[1])/c,e=0.25*c,f=(g[9]+g[6])/c,c=(g[2]-g[8])/c):(c=2*Math.sqrt(1+g[10]-g[0]-g[5]),b=(g[2]+g[8])/c,e=(g[9]+g[6])/c,f=0.25*c,c=(g[4]-g[1])/c);return new a.math.Quaternion(b,e,f,c)};a.math.Quaternion.rotationYawPitchRoll=
function(c,b,e){var f,g,h,k,m;f=a.degreesToRadians(b)/2;g=a.degreesToRadians(c)/2;h=a.degreesToRadians(e)/2;e=Math.cos(f);c=Math.cos(g);b=Math.cos(h);f=Math.sin(f);g=Math.sin(g);h=Math.sin(h);k=c*b;m=g*h;var p=new a.math.Quaternion;p.w=e*k+f*m;p.x=f*k-e*m;p.y=e*g*b+f*c*h;p.z=e*c*h-f*g*b;p.normalize();return p};b.slerp=function(b,d){if(this.x===b.x&&this.y===b.y&&this.z===b.z&&this.w===b.w)return this;var e=this.dot(b),f=Math.acos(e),g=Math.sqrt(1-a.math.square(e)),e=Math.sin(d*f)/g,f=Math.sin((1-
...
window.mozAudioContext);a.DELAY_CREATE_CTX&&setTimeout(function(){f=new (window.AudioContext||window.webkitAudioContext||window.mozAudioContext)},0)}}catch(g){b=!1,cc.log("browser don't support web audio")}var h={cache:{},load:function(c,d,g,k){if(0===e.length)return k("can not support audio!");cc.loader.audioPath&&(c=cc.path.join(cc.loader.audioPath,c));var u=cc.path.extname(c),x=[u];for(g=0;g<e.length;g++)u!==e[g]&&x.push(e[g]);var w;if(h.cache[d])return k(null,h.cache[d]);if(b)try{var E=f.createGain();
E.gain.value=1;E.connect(f.destination);w=new cc.Audio(f,E,c);a.NEED_MANUAL_LOOP&&(w._manualLoop=!0)}catch(n){b=!1,cc.log("browser don't support web audio"),w=new cc.Audio(null,null,c)}else w=new cc.Audio(null,null,c);this.loadAudioFromExtList(c,x,w,k);h.cache[d]=w},loadAudioFromExtList:function(c,d,g,k){if(0===d.length){var u="can not found the resource of audio! Last match url is : ",u=u+c.replace(/\.(.*)?$/,"(");e.forEach(function(a){u+=a+"|"});u=u.replace(/\|$/,")");return k({status:520,errorMessage:u},
null)}c=cc.path.changeExtname(c,d.splice(0,1));if(b){a.webAudioCallback&&a.webAudioCallback(c);var x=new XMLHttpRequest;x.open("GET",c,!0);x.responseType="arraybuffer";x.onload=function(){f.decodeAudioData(x.response,function(a){g.setBuffer(a);k(null,g)},function(){h.loadAudioFromExtList(c,d,g,k)})};x.onerror=function(){k({status:520,errorMessage:u},null)};x.send()}else{var w=document.createElement("audio"),E=!1,n=!1,M=setTimeout(function(){0===w.readyState?N():(n=!0,w.pause(),document.body.removeChild(w),
k("audio load timeout : "+c,g))},1E4),B=function(){if(!E){w.pause();try{w.currentTime=0,w.volume=1}catch(a){}document.body.removeChild(w);g.setElement(w);w.removeEventListener("canplaythrough",B,!1);w.removeEventListener("error",D,!1);w.removeEventListener("emptied",N,!1);!n&&k(null,g);E=!0;clearTimeout(M)}},D=function(){E&&(w.pause(),document.body.removeChild(w),w.removeEventListener("canplaythrough",B,!1),w.removeEventListener("error",D,!1),w.removeEventListener("emptied",N,!1),!n&&h.loadAudioFromExtList(c,
d,g,k),E=!0,clearTimeout(M))},N=function(){n=!0;B();k(null,g)};cc._addEventListener(w,"canplaythrough",B,!1);cc._addEventListener(w,"error",D,!1);a.USE_EMPTIED_EVENT&&cc._addEventListener(w,"emptied",N,!1);w.src=c;document.body.appendChild(w);w.volume=0;w.play()}}};cc.loader.register(["mp3","ogg","wav","mp4","m4a"],h);cc.audioEngine={_currMusic:null,_musicVolume:1,features:a,willPlayMusic:function(){return!1},playMusic:function(a,b){var c=this._currMusic;c&&c.src!==a&&c.getPlaying()&&c.stop();c=h.cache[a];
...
cc._canvas.removeEventListener("touchstart",k))};setTimeout(function(){cc._canvas&&cc._canvas.addEventListener("touchstart",k,!1)},150)}cc.eventManager.addCustomListener(cc.game.EVENT_HIDE,function(){cc.audioEngine._pausePlaying()});cc.eventManager.addCustomListener(cc.game.EVENT_SHOW,function(){cc.audioEngine._resumePlaying()})})(window.__audioSupport);cc.ACTION_TAG_INVALID=-1;
...
this._children;if(m&&0<m.length)for(b=0,k=m.length;b<k;b++)d>=a.length||!(g=a[d])||(h=m[b].height,e=e>=h||isNaN(h)?e:h,++f,f>=g&&(c+=e+5,e=f=0,++d));var p=cc.director.getWinSize(),r=g=e=d=0,t=0,c=c/2;if(m&&0<m.length)for(b=0,k=m.length;b<k;b++){var u=m[b];0===g&&(g=a[d],t=r=p.width/(1+g));h=u._getHeight();e=e>=h||isNaN(h)?e:h;u.setPosition(t-p.width/2,c-h/2);t+=r;++f;f>=g&&(c-=e+5,e=g=f=0,++d)}},alignItemsInRows:function(){0<arguments.length&&null==arguments[arguments.length-1]&&cc.log("parameters should not be ending with null in Javascript");
var a=[],b;for(b=0;b<arguments.length;b++)a.push(arguments[b]);var c=[],d=[],e=-10,f=-5,g=0,h=0,k=0,m,p,r,t,u=this._children;if(u&&0<u.length)for(b=0,r=u.length;b<r;b++)(p=u[b],g>=a.length||!(m=a[g]))||(t=p.width,h=h>=t||isNaN(t)?h:t,f+=p.height+5,++k,k>=m&&(c.push(h),d.push(f),e+=h+10,h=k=0,f=-5,++g));f=cc.director.getWinSize();m=h=g=0;var e=-e/2,x=0;if(u&&0<u.length)for(b=0,r=u.length;b<r;b++)p=u[b],0===m&&(m=a[g],x=d[g]),t=p._getWidth(),h=h>=t||isNaN(t)?h:t,p.setPosition(e+c[g]/2,x-f.height/2),
...
f=c.rect();f.x=0;f.y=0;if(cc.rectContainsPoint(f,e))return c}return null}});_p=cc.Menu.prototype;cc.Menu.create=function(a){var b=arguments.length;0<b&&null==arguments[b-1]&&cc.log("parameters should not be ending with null in Javascript");return 0===b?new cc.Menu:1===b?new cc.Menu(a):new cc.Menu(Array.prototype.slice.call(arguments,0))};(function(){function a(a){return function(b,c,d,e){c=M(c,e,4);var f=!I(b)&&n.keys(b),g=(f||b).length,h=0<a?0:g-1;3>arguments.length&&(d=b[f?f[h]:h],h+=a);for(var k=c,m=d;0<=h&&g>h;h+=a)var J=f?f[h]:h,m=k(m,b[J],J,b);return m}}function b(a){return function(b,c,d){c=B(c,d);d=z(b);for(var e=0<a?0:d-1;0<=e&&d>e;e+=a)if(c(b[e],e,b))return e;return-1}}function c(a,b,c){return function(d,e,f){var g=0,h=z(d);if("number"==typeof f)0<a?g=0<=f?f:Math.max(f+h,g):h=0<=f?Math.min(f+1,h):f+h+1;else if(c&&f&&h)return f=
c(d,e),d[f]===e?f:-1;if(e!==e)return f=b(m.call(d,g,h),n.isNaN),0<=f?f+g:-1;for(f=0<a?g:h-1;0<=f&&h>f;f+=a)if(d[f]===e)return f;return-1}}function d(a,b){var c=R.length,d=a.constructor,d=n.isFunction(d)&&d.prototype||h,e="constructor";for(n.has(a,e)&&!n.contains(b,e)&&b.push(e);c--;)e=R[c],e in a&&a[e]!==d[e]&&!n.contains(b,e)&&b.push(e)}var e=this,f=e._,g=Array.prototype,h=Object.prototype,k=g.push,m=g.slice,p=h.toString,r=h.hasOwnProperty,t=Array.isArray,u=Object.keys,x=Function.prototype.bind,
w=Object.create,E=function(){},n=function(a){return a instanceof n?a:this instanceof n?void(this._wrapped=a):new n(a)};"undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=n),exports._=n):e._=n;n.VERSION="1.8.3";var M=function(a,b,c){if(void 0===b)return a;switch(null==c?3:c){case 1:return function(c){return a.call(b,c)};case 2:return function(c,d){return a.call(b,c,d)};case 3:return function(c,d,e){return a.call(b,c,d,e)};case 4:return function(c,d,e,f){return a.call(b,
c,d,e,f)}}return function(){return a.apply(b,arguments)}},B=function(a,b,c){return null==a?n.identity:n.isFunction(a)?M(a,b,c):n.isObject(a)?n.matcher(a):n.property(a)};n.iteratee=function(a,b){return B(a,b,1/0)};var D=function(a,b){return function(c){var d=arguments.length;if(2>d||null==c)return c;for(var e=1;d>e;e++)for(var f=arguments[e],g=a(f),h=g.length,k=0;h>k;k++){var m=g[k];b&&void 0!==c[m]||(c[m]=f[m])}return c}},N=function(a){if(!n.isObject(a))return{};if(w)return w(a);E.prototype=a;a=new E;
return E.prototype=null,a},y=function(a){return function(b){return null==b?void 0:b[a]}},C=Math.pow(2,53)-1,z=y("length"),I=function(a){a=z(a);return"number"==typeof a&&0<=a&&C>=a};n.each=n.forEach=function(a,b,c){b=M(b,c);var d;if(I(a))for(c=0,d=a.length;d>c;c++)b(a[c],c,a);else{var e=n.keys(a);c=0;for(d=e.length;d>c;c++)b(a[e[c]],e[c],a)}return a};n.map=n.collect=function(a,b,c){b=B(b,c);c=!I(a)&&n.keys(a);for(var d=(c||a).length,e=Array(d),f=0;d>f;f++){var g=c?c[f]:f;e[f]=b(a[g],g,a)}return e};
n.reduce=n.foldl=n.inject=a(1);n.reduceRight=n.foldr=a(-1);n.find=n.detect=function(a,b,c){var d;return d=I(a)?n.findIndex(a,b,c):n.findKey(a,b,c),void 0!==d&&-1!==d?a[d]:void 0};n.filter=n.select=function(a,b,c){var d=[];return b=B(b,c),n.each(a,function(a,c,e){b(a,c,e)&&d.push(a)}),d};n.reject=function(a,b,c){return n.filter(a,n.negate(B(b)),c)};n.every=n.all=function(a,b,c){b=B(b,c);c=!I(a)&&n.keys(a);for(var d=(c||a).length,e=0;d>e;e++){var f=c?c[e]:e;if(!b(a[f],f,a))return!1}return!0};n.some=
n.any=function(a,b,c){b=B(b,c);c=!I(a)&&n.keys(a);for(var d=(c||a).length,e=0;d>e;e++){var f=c?c[e]:e;if(b(a[f],f,a))return!0}return!1};n.contains=n.includes=n.include=function(a,b,c,d){return I(a)||(a=n.values(a)),("number"!=typeof c||d)&&(c=0),0<=n.indexOf(a,b,c)};n.invoke=function(a,b){var c=m.call(arguments,2),d=n.isFunction(b);return n.map(a,function(a){var e=d?b:a[b];return null==e?e:e.apply(a,c)})};n.pluck=function(a,b){return n.map(a,n.property(b))};n.where=function(a,b){return n.filter(a,
n.matcher(b))};n.findWhere=function(a,b){return n.find(a,n.matcher(b))};n.max=function(a,b,c){var d,e=-1/0,f=-1/0;if(null==b&&null!=a){a=I(a)?a:n.values(a);for(var g=0,h=a.length;h>g;g++)c=a[g],c>e&&(e=c)}else b=B(b,c),n.each(a,function(a,c,g){d=b(a,c,g);(d>f||d===-1/0&&e===-1/0)&&(e=a,f=d)});return e};n.min=function(a,b,c){var d,e=1/0,f=1/0;if(null==b&&null!=a){a=I(a)?a:n.values(a);for(var g=0,h=a.length;h>g;g++)c=a[g],e>c&&(e=c)}else b=B(b,c),n.each(a,function(a,c,g){d=b(a,c,g);(f>d||1/0===d&&1/
0===e)&&(e=a,f=d)});return e};n.shuffle=function(a){for(var b=I(a)?a:n.values(a),c=b.length,d=Array(c),e=0;c>e;e++)a=n.random(0,e),a!==e&&(d[e]=d[a]),d[a]=b[e];return d};n.sample=function(a,b,c){return null==b||c?(I(a)||(a=n.values(a)),a[n.random(a.length-1)]):n.shuffle(a).slice(0,Math.max(0,b))};n.sortBy=function(a,b,c){return b=B(b,c),n.pluck(n.map(a,function(a,c,d){return{value:a,index:c,criteria:b(a,c,d)}}).sort(function(a,b){var c=a.criteria,d=b.criteria;if(c!==d){if(c>d||void 0===c)return 1;
if(d>c||void 0===d)return-1}return a.index-b.index}),"value")};var G=function(a){return function(b,c,d){var e={};return c=B(c,d),n.each(b,function(d,f){var g=c(d,f,b);a(e,d,g)}),e}};n.groupBy=G(function(a,b,c){n.has(a,c)?a[c].push(b):a[c]=[b]});n.indexBy=G(function(a,b,c){a[c]=b});n.countBy=G(function(a,b,c){n.has(a,c)?a[c]++:a[c]=1});n.toArray=function(a){return a?n.isArray(a)?m.call(a):I(a)?n.map(a,n.identity):n.values(a):[]};n.size=function(a){return null==a?0:I(a)?a.length:n.keys(a).length};n.partition=
function(a,b,c){b=B(b,c);var d=[],e=[];return n.each(a,function(a,c,f){(b(a,c,f)?d:e).push(a)}),[d,e]};n.first=n.head=n.take=function(a,b,c){return null==a?void 0:null==b||c?a[0]:n.initial(a,a.length-b)};n.initial=function(a,b,c){return m.call(a,0,Math.max(0,a.length-(null==b||c?1:b)))};n.last=function(a,b,c){return null==a?void 0:null==b||c?a[a.length-1]:n.rest(a,Math.max(0,a.length-b))};n.rest=n.tail=n.drop=function(a,b,c){return m.call(a,null==b||c?1:b)};n.compact=function(a){return n.filter(a,
n.identity)};var H=function(a,b,c,d){var e=[],f=0;d=d||0;for(var g=z(a);g>d;d++){var h=a[d];if(I(h)&&(n.isArray(h)||n.isArguments(h))){b||(h=H(h,b,c));var k=0,m=h.length;for(e.length+=m;m>k;)e[f++]=h[k++]}else c||(e[f++]=h)}return e};n.flatten=function(a,b){return H(a,b,!1)};n.without=function(a){return n.difference(a,m.call(arguments,1))};n.uniq=n.unique=function(a,b,c,d){n.isBoolean(b)||(d=c,c=b,b=!1);null!=c&&(c=B(c,d));d=[];for(var e=[],f=0,g=z(a);g>f;f++){var h=a[f],k=c?c(h,f,a):h;b?(f&&e===
k||d.push(h),e=k):c?n.contains(e,k)||(e.push(k),d.push(h)):n.contains(d,h)||d.push(h)}return d};n.union=function(){return n.uniq(H(arguments,!0,!0))};n.intersection=function(a){for(var b=[],c=arguments.length,d=0,e=z(a);e>d;d++){var f=a[d];if(!n.contains(b,f)){for(var g=1;c>g&&n.contains(arguments[g],f);g++);g===c&&b.push(f)}}return b};n.difference=function(a){var b=H(arguments,!0,!0,1);return n.filter(a,function(a){return!n.contains(b,a)})};n.zip=function(){return n.unzip(arguments)};n.unzip=function(a){for(var b=
a&&n.max(a,z).length||0,c=Array(b),d=0;b>d;d++)c[d]=n.pluck(a,d);return c};n.object=function(a,b){for(var c={},d=0,e=z(a);e>d;d++)b?c[a[d]]=b[d]:c[a[d][0]]=a[d][1];return c};n.findIndex=b(1);n.findLastIndex=b(-1);n.sortedIndex=function(a,b,c,d){c=B(c,d,1);b=c(b);d=0;for(var e=z(a);e>d;){var f=Math.floor((d+e)/2);c(a[f])<b?d=f+1:e=f}return d};n.indexOf=c(1,n.findIndex,n.sortedIndex);n.lastIndexOf=c(-1,n.findLastIndex);n.range=function(a,b,c){null==b&&(b=a||0,a=0);c=c||1;b=Math.max(Math.ceil((b-a)/
c),0);for(var d=Array(b),e=0;b>e;e++,a+=c)d[e]=a;return d};var X=function(a,b,c,d,e){if(!(d instanceof b))return a.apply(c,e);b=N(a.prototype);a=a.apply(b,e);return n.isObject(a)?a:b};n.bind=function(a,b){if(x&&a.bind===x)return x.apply(a,m.call(arguments,1));if(!n.isFunction(a))throw new TypeError("Bind must be called on a function");var c=m.call(arguments,2),d=function(){return X(a,d,b,this,c.concat(m.call(arguments)))};return d};n.partial=function(a){var b=m.call(arguments,1),c=function(){for(var d=
0,e=b.length,f=Array(e),g=0;e>g;g++)f[g]=b[g]===n?arguments[d++]:b[g];for(;d<arguments.length;)f.push(arguments[d++]);return X(a,c,this,this,f)};return c};n.bindAll=function(a){var b,c,d=arguments.length;if(1>=d)throw Error("bindAll must be passed function names");for(b=1;d>b;b++)c=arguments[b],a[c]=n.bind(a[c],a);return a};n.memoize=function(a,b){var c=function(d){var e=c.cache,f=""+(b?b.apply(this,arguments):d);return n.has(e,f)||(e[f]=a.apply(this,arguments)),e[f]};return c.cache={},c};n.delay=
function(a,b){var c=m.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)};n.defer=n.partial(n.delay,n,1);n.throttle=function(a,b,c){var d,e,f,g=null,h=0;c||(c={});var k=function(){h=!1===c.leading?0:n.now();g=null;f=a.apply(d,e);g||(d=e=null)};return function(){var m=n.now();h||!1!==c.leading||(h=m);var J=b-(m-h);return d=this,e=arguments,0>=J||J>b?(g&&(clearTimeout(g),g=null),h=m,f=a.apply(d,e),g||(d=e=null)):g||!1===c.trailing||(g=setTimeout(k,J)),f}};n.debounce=function(a,
b,c){var d,e,f,g,h,k=function(){var m=n.now()-g;b>m&&0<=m?d=setTimeout(k,b-m):(d=null,c||(h=a.apply(f,e),d||(f=e=null)))};return function(){f=this;e=arguments;g=n.now();var m=c&&!d;return d||(d=setTimeout(k,b)),m&&(h=a.apply(f,e),f=e=null),h}};n.wrap=function(a,b){return n.partial(b,a)};n.negate=function(a){return function(){return!a.apply(this,arguments)}};n.compose=function(){var a=arguments,b=a.length-1;return function(){for(var c=b,d=a[b].apply(this,arguments);c--;)d=a[c].call(this,d);return d}};
n.after=function(a,b){return function(){return 1>--a?b.apply(this,arguments):void 0}};n.before=function(a,b){var c;return function(){return 0<--a&&(c=b.apply(this,arguments)),1>=a&&(b=null),c}};n.once=n.partial(n.before,2);var Y=!{toString:null}.propertyIsEnumerable("toString"),R="valueOf isPrototypeOf toString propertyIsEnumerable hasOwnProperty toLocaleString".split(" ");n.keys=function(a){if(!n.isObject(a))return[];if(u)return u(a);var b=[],c;for(c in a)n.has(a,c)&&b.push(c);return Y&&d(a,b),b};
n.allKeys=function(a){if(!n.isObject(a))return[];var b=[],c;for(c in a)b.push(c);return Y&&d(a,b),b};n.values=function(a){for(var b=n.keys(a),c=b.length,d=Array(c),e=0;c>e;e++)d[e]=a[b[e]];return d};n.mapObject=function(a,b,c){b=B(b,c);for(var d=n.keys(a),e=d.length,f={},g=0;e>g;g++)c=d[g],f[c]=b(a[c],c,a);return f};n.pairs=function(a){for(var b=n.keys(a),c=b.length,d=Array(c),e=0;c>e;e++)d[e]=[b[e],a[b[e]]];return d};n.invert=function(a){for(var b={},c=n.keys(a),d=0,e=c.length;e>d;d++)b[a[c[d]]]=
c[d];return b};n.functions=n.methods=function(a){var b=[],c;for(c in a)n.isFunction(a[c])&&b.push(c);return b.sort()};n.extend=D(n.allKeys);n.extendOwn=n.assign=D(n.keys);n.findKey=function(a,b,c){b=B(b,c);var d;c=n.keys(a);for(var e=0,f=c.length;f>e;e++)if(d=c[e],b(a[d],d,a))return d};n.pick=function(a,b,c){var d,e,f={},g=a;if(null==g)return f;n.isFunction(b)?(e=n.allKeys(g),d=M(b,c)):(e=H(arguments,!1,!1,1),d=function(a,b,c){return b in c},g=Object(g));for(var h=0,k=e.length;k>h;h++){var m=e[h],
J=g[m];d(J,m,g)&&(f[m]=J)}return f};n.omit=function(a,b,c){if(n.isFunction(b))b=n.negate(b);else{var d=n.map(H(arguments,!1,!1,1),String);b=function(a,b){return!n.contains(d,b)}}return n.pick(a,b,c)};n.defaults=D(n.allKeys,!0);n.create=function(a,b){var c=N(a);return b&&n.extendOwn(c,b),c};n.clone=function(a){return n.isObject(a)?n.isArray(a)?a.slice():n.extend({},a):a};n.tap=function(a,b){return b(a),a};n.isMatch=function(a,b){var c=n.keys(b),d=c.length;if(null==a)return!d;for(var e=Object(a),f=
0;d>f;f++){var g=c[f];if(b[g]!==e[g]||!(g in e))return!1}return!0};var J=function(a,b,c,d){if(a===b)return 0!==a||1/a===1/b;if(null==a||null==b)return a===b;a instanceof n&&(a=a._wrapped);b instanceof n&&(b=b._wrapped);var e=p.call(a);if(e!==p.call(b))return!1;switch(e){case "[object RegExp]":case "[object String]":return""+a==""+b;case "[object Number]":return+a!==+a?+b!==+b:0===+a?1/+a===1/b:+a===+b;case "[object Date]":case "[object Boolean]":return+a===+b}e="[object Array]"===e;if(!e){if("object"!=
typeof a||"object"!=typeof b)return!1;var f=a.constructor,g=b.constructor;if(f!==g&&!(n.isFunction(f)&&f instanceof f&&n.isFunction(g)&&g instanceof g)&&"constructor"in a&&"constructor"in b)return!1}c=c||[];d=d||[];for(f=c.length;f--;)if(c[f]===a)return d[f]===b;if(c.push(a),d.push(b),e){if(f=a.length,f!==b.length)return!1;for(;f--;)if(!J(a[f],b[f],c,d))return!1}else{var h,e=n.keys(a);if(f=e.length,n.keys(b).length!==f)return!1;for(;f--;)if(h=e[f],!n.has(b,h)||!J(a[h],b[h],c,d))return!1}return c.pop(),
d.pop(),!0};n.isEqual=function(a,b){return J(a,b)};n.isEmpty=function(a){return null==a?!0:I(a)&&(n.isArray(a)||n.isString(a)||n.isArguments(a))?0===a.length:0===n.keys(a).length};n.isElement=function(a){return!(!a||1!==a.nodeType)};n.isArray=t||function(a){return"[object Array]"===p.call(a)};n.isObject=function(a){var b=typeof a;return"function"===b||"object"===b&&!!a};n.each("Arguments Function String Number Date RegExp Error".split(" "),function(a){n["is"+a]=function(b){return p.call(b)==="[object "+
...
a&&r.call(a,b)};n.noConflict=function(){return e._=f,this};n.identity=function(a){return a};n.constant=function(a){return function(){return a}};n.noop=function(){};n.property=y;n.propertyOf=function(a){return null==a?function(){}:function(b){return a[b]}};n.matcher=n.matches=function(a){return a=n.extendOwn({},a),function(b){return n.isMatch(b,a)}};n.times=function(a,b,c){var d=Array(Math.max(0,a));b=M(b,c,1);for(c=0;a>c;c++)d[c]=b(c);return d};n.random=function(a,b){return null==b&&(b=a,a=0),a+Math.floor(Math.random()*
(b-a+1))};n.now=Date.now||function(){return(new Date).getTime()};t={"\x26":"\x26amp;","\x3c":"\x26lt;","\x3e":"\x26gt;",'"':"\x26quot;","'":"\x26#x27;","`":"\x26#x60;"};D=n.invert(t);y=function(a){var b=function(b){return a[b]},c="(?:"+n.keys(a).join("|")+")",d=RegExp(c),e=RegExp(c,"g");return function(a){return a=null==a?"":""+a,d.test(a)?a.replace(e,b):a}};n.escape=y(t);n.unescape=y(D);n.result=function(a,b,c){b=null==a?void 0:a[b];return void 0===b&&(b=c),n.isFunction(b)?b.call(a):b};var Z=0;n.uniqueId=
function(a){var b=++Z+"";return a?a+b:b};n.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var T=/(.)^/,da={"'":"'","\\":"\\","\r":"r","\n":"n","\u2028":"u2028","\u2029":"u2029"},V=/\\|'|\r|\n|\u2028|\u2029/g,ba=function(a){return"\\"+da[a]};n.template=function(a,b,c){!b&&c&&(b=c);b=n.defaults({},b,n.templateSettings);c=RegExp([(b.escape||T).source,(b.interpolate||T).source,(b.evaluate||T).source].join("|")+"|$","g");var d=0,e="__p+\x3d'";a.replace(c,
function(b,c,f,g,h){return e+=a.slice(d,h).replace(V,ba),d=h+b.length,c?e+="'+\n((__t\x3d("+c+"))\x3d\x3dnull?'':_.escape(__t))+\n'":f?e+="'+\n((__t\x3d("+f+"))\x3d\x3dnull?'':__t)+\n'":g&&(e+="';\n"+g+"\n__p+\x3d'"),b});e+="';\n";b.variable||(e="with(obj||{}){\n"+e+"}\n");e="var __t,__p\x3d'',__j\x3dArray.prototype.join,print\x3dfunction(){__p+\x3d__j.call(arguments,'');};\n"+e+"return __p;\n";try{var f=new Function(b.variable||"obj","_",e)}catch(g){throw g.source=e,g;}c=function(a){return f.call(this,
a,n)};return c.source="function("+(b.variable||"obj")+"){\n"+e+"}",c};n.chain=function(a){a=n(a);return a._chain=!0,a};var ha=function(a,b){return a._chain?n(b).chain():b};n.mixin=function(a){n.each(n.functions(a),function(b){var c=n[b]=a[b];n.prototype[b]=function(){var a=[this._wrapped];return k.apply(a,arguments),ha(this,c.apply(n,a))}})};n.mixin(n);n.each("pop push reverse shift sort splice unshift".split(" "),function(a){var b=g[a];n.prototype[a]=function(){var c=this._wrapped;return b.apply(c,
arguments),"shift"!==a&&"splice"!==a||0!==c.length||delete c[0],ha(this,c)}});n.each(["concat","join","slice"],function(a){var b=g[a];n.prototype[a]=function(){return ha(this,b.apply(this._wrapped,arguments))}});n.prototype.value=function(){return this._wrapped};n.prototype.valueOf=n.prototype.toJSON=n.prototype.value;n.prototype.toString=function(){return""+this._wrapped};"function"==typeof define&&define.amd&&define("underscore",[],function(){return n})}).call(this);(function(a,b){if("function"===typeof define&&define.amd)define(["underscore","jquery","exports"],function(c,e,f){a.Backbone=b(a,f,c,e)});else if("undefined"!==typeof exports){var c=require("underscore");b(a,exports,c)}else a.Backbone=b(a,{},a._,a.jQuery||a.Zepto||a.ender||a.$)})(this,function(a,b,c,d){var e=a.Backbone,f=[].slice;b.VERSION="1.1.2";b.$=d;b.noConflict=function(){a.Backbone=e;return this};b.emulateHTTP=!1;b.emulateJSON=!1;var g=b.Events={on:function(a,b,c){if(!k(this,"on",a,[b,c])||
!b)return this;this._events||(this._events={});(this._events[a]||(this._events[a]=[])).push({callback:b,context:c,ctx:c||this});return this},once:function(a,b,d){if(!k(this,"once",a,[b,d])||!b)return this;var e=this,f=c.once(function(){e.off(a,f);b.apply(this,arguments)});f._callback=b;return this.on(a,f,d)},off:function(a,b,d){var e,f,g,h,m,n,p,r;if(!this._events||!k(this,"off",a,[b,d]))return this;if(!a&&!b&&!d)return this._events=void 0,this;h=a?[a]:c.keys(this._events);m=0;for(n=h.length;m<n;m++)if(a=
h[m],g=this._events[a]){this._events[a]=e=[];if(b||d)for(p=0,r=g.length;p<r;p++)f=g[p],(b&&b!==f.callback&&b!==f.callback._callback||d&&d!==f.context)&&e.push(f);e.length||delete this._events[a]}return this},trigger:function(a){if(!this._events)return this;var b=f.call(arguments,1);if(!k(this,"trigger",a,b))return this;var c=this._events[a],d=this._events.all;c&&m(c,b);d&&m(d,arguments);return this},stopListening:function(a,b,d){var e=this._listeningTo;if(!e)return this;var f=!b&&!d;d||"object"!==
typeof b||(d=this);a&&((e={})[a._listenId]=a);for(var g in e)a=e[g],a.off(b,d,this),(f||c.isEmpty(a._events))&&delete this._listeningTo[g];return this}},h=/\s+/,k=function(a,b,c,d){if(!c)return!0;if("object"===typeof c){for(var e in c)a[b].apply(a,[e,c[e]].concat(d));return!1}if(h.test(c)){c=c.split(h);e=0;for(var f=c.length;e<f;e++)a[b].apply(a,[c[e]].concat(d));return!1}return!0},m=function(a,b){var c,d=-1,e=a.length,f=b[0],g=b[1],h=b[2];switch(b.length){case 0:for(;++d<e;)(c=a[d]).callback.call(c.ctx);
break;case 1:for(;++d<e;)(c=a[d]).callback.call(c.ctx,f);break;case 2:for(;++d<e;)(c=a[d]).callback.call(c.ctx,f,g);break;case 3:for(;++d<e;)(c=a[d]).callback.call(c.ctx,f,g,h);break;default:for(;++d<e;)(c=a[d]).callback.apply(c.ctx,b)}};c.each({listenTo:"on",listenToOnce:"once"},function(a,b){g[b]=function(b,d,e){var f=this._listeningTo||(this._listeningTo={}),g=b._listenId||(b._listenId=c.uniqueId("l"));f[g]=b;e||"object"!==typeof d||(e=this);b[a](d,e,this);return this}});g.bind=g.on;g.unbind=g.off;
c.extend(b,g);var p=b.Model=function(a,b){var d=a||{};b||(b={});this.cid=c.uniqueId("c");this.attributes={};b.collection&&(this.collection=b.collection);b.parse&&(d=this.parse(d,b)||{});d=c.defaults({},d,c.result(this,"defaults"));this.set(d,b);this.changed={};this.initialize.apply(this,arguments)};c.extend(p.prototype,g,{changed:null,validationError:null,idAttribute:"id",initialize:function(){},toJSON:function(a){return c.clone(this.attributes)},sync:function(){return b.sync.apply(this,arguments)},
...
fetch:function(a){a=a?c.clone(a):{};void 0===a.parse&&(a.parse=!0);var b=this,d=a.success;a.success=function(c){if(!b.set(b.parse(c,a),a))return!1;d&&d(b,c,a);b.trigger("sync",b,c,a)};R(this,a);return this.sync("read",this,a)},save:function(a,b,d){var e,f=this.attributes;null==a||"object"===typeof a?(e=a,d=b):(e={})[a]=b;d=c.extend({validate:!0},d);if(e&&!d.wait){if(!this.set(e,d))return!1}else if(!this._validate(e,d))return!1;e&&d.wait&&(this.attributes=c.extend({},f,e));void 0===d.parse&&(d.parse=
!0);var g=this,h=d.success;d.success=function(a){g.attributes=f;var b=g.parse(a,d);d.wait&&(b=c.extend(e||{},b));if(c.isObject(b)&&!g.set(b,d))return!1;h&&h(g,a,d);g.trigger("sync",g,a,d)};R(this,d);a=this.isNew()?"create":d.patch?"patch":"update";"patch"===a&&(d.attrs=e);a=this.sync(a,this,d);e&&d.wait&&(this.attributes=f);return a},destroy:function(a){a=a?c.clone(a):{};var b=this,d=a.success,e=function(){b.trigger("destroy",b,b.collection,a)};a.success=function(c){(a.wait||b.isNew())&&e();d&&d(b,
c,a);b.isNew()||b.trigger("sync",b,c,a)};if(this.isNew())return a.success(),!1;R(this,a);var f=this.sync("delete",this,a);a.wait||e();return f},url:function(){var a=c.result(this,"urlRoot")||c.result(this.collection,"url")||Y();return this.isNew()?a:a.replace(/([^\/])$/,"$1/")+encodeURIComponent(this.id)},parse:function(a,b){return a},clone:function(){return new this.constructor(this.attributes)},isNew:function(){return!this.has(this.idAttribute)},isValid:function(a){return this._validate({},c.extend(a||
{},{validate:!0}))},_validate:function(a,b){if(!b.validate||!this.validate)return!0;a=c.extend({},this.attributes,a);var d=this.validationError=this.validate(a,b)||null;if(!d)return!0;this.trigger("invalid",this,d,c.extend(b,{validationError:d}));return!1}});c.each("keys values pairs invert pick omit".split(" "),function(a){p.prototype[a]=function(){var b=f.call(arguments);b.unshift(this.attributes);return c[a].apply(c,b)}});var r=b.Collection=function(a,b){b||(b={});b.model&&(this.model=b.model);
void 0!==b.comparator&&(this.comparator=b.comparator);this._reset();this.initialize.apply(this,arguments);a&&this.reset(a,c.extend({silent:!0},b))},t={add:!0,remove:!0,merge:!0},u={add:!0,remove:!1};c.extend(r.prototype,g,{model:p,initialize:function(){},toJSON:function(a){return this.map(function(b){return b.toJSON(a)})},sync:function(){return b.sync.apply(this,arguments)},add:function(a,b){return this.set(a,c.extend({merge:!1},b,u))},remove:function(a,b){var d=!c.isArray(a);a=d?[a]:c.clone(a);b||
(b={});var e,f,g,h;e=0;for(f=a.length;e<f;e++)if(h=a[e]=this.get(a[e]))delete this._byId[h.id],delete this._byId[h.cid],g=this.indexOf(h),this.models.splice(g,1),this.length--,b.silent||(b.index=g,h.trigger("remove",h,this,b)),this._removeReference(h,b);return d?a[0]:a},set:function(a,b){b=c.defaults({},b,t);b.parse&&(a=this.parse(a,b));var d=!c.isArray(a);a=d?a?[a]:[]:c.clone(a);var e,f,g,h,k,m,n=b.at,r=this.model,u=this.comparator&&null==n&&!1!==b.sort,w=c.isString(this.comparator)?this.comparator:
null,x=[],y=[],z={},B=b.add,E=b.merge,D=b.remove,C=!u&&B&&D?[]:!1;e=0;for(f=a.length;e<f;e++){k=a[e]||{};g=k instanceof p?h=k:k[r.prototype.idAttribute||"id"];if(g=this.get(g))D&&(z[g.cid]=!0),E&&(k=k===h?h.attributes:k,b.parse&&(k=g.parse(k,b)),g.set(k,b),u&&!m&&g.hasChanged(w)&&(m=!0)),a[e]=g;else if(B){h=a[e]=this._prepareModel(k,b);if(!h)continue;x.push(h);this._addReference(h,b)}h=g||h;!C||!h.isNew()&&z[h.id]||C.push(h);z[h.id]=!0}if(D){e=0;for(f=this.length;e<f;++e)z[(h=this.models[e]).cid]||
y.push(h);y.length&&this.remove(y,b)}if(x.length||C&&C.length)if(u&&(m=!0),this.length+=x.length,null!=n)for(e=0,f=x.length;e<f;e++)this.models.splice(n+e,0,x[e]);else for(C&&(this.models.length=0),k=C||x,e=0,f=k.length;e<f;e++)this.models.push(k[e]);m&&this.sort({silent:!0});if(!b.silent){e=0;for(f=x.length;e<f;e++)(h=x[e]).trigger("add",h,this,b);(m||C&&C.length)&&this.trigger("sort",this,b)}return d?a[0]:a},reset:function(a,b){b||(b={});for(var d=0,e=this.models.length;d<e;d++)this._removeReference(this.models[d],
...
this));a.silent||this.trigger("sort",this,a);return this},pluck:function(a){return c.invoke(this.models,"get",a)},fetch:function(a){a=a?c.clone(a):{};void 0===a.parse&&(a.parse=!0);var b=a.success,d=this;a.success=function(c){d[a.reset?"reset":"set"](c,a);b&&b(d,c,a);d.trigger("sync",d,c,a)};R(this,a);return this.sync("read",this,a)},create:function(a,b){b=b?c.clone(b):{};if(!(a=this._prepareModel(a,b)))return!1;b.wait||this.add(a,b);var d=this,e=b.success;b.success=function(a,c){b.wait&&d.add(a,
b);e&&e(a,c,b)};a.save(null,b);return a},parse:function(a,b){return a},clone:function(){return new this.constructor(this.models)},_reset:function(){this.length=0;this.models=[];this._byId={}},_prepareModel:function(a,b){if(a instanceof p)return a;b=b?c.clone(b):{};b.collection=this;var d=new this.model(a,b);if(!d.validationError)return d;this.trigger("invalid",this,d.validationError,b);return!1},_addReference:function(a,b){this._byId[a.cid]=a;null!=a.id&&(this._byId[a.id]=a);a.collection||(a.collection=
...
function(a){r.prototype[a]=function(){var b=f.call(arguments);b.unshift(this.models);return c[a].apply(c,b)}});c.each(["groupBy","countBy","sortBy","indexBy"],function(a){r.prototype[a]=function(b,d){var e=c.isFunction(b)?b:function(a){return a.get(b)};return c[a](this.models,e,d)}});d=b.View=function(a){this.cid=c.uniqueId("view");a||(a={});c.extend(this,c.pick(a,w));this._ensureElement();this.initialize.apply(this,arguments);this.delegateEvents()};var x=/^(\S+)\s*(.*)$/,w="model collection el id attributes className tagName events".split(" ");
c.extend(d.prototype,g,{tagName:"div",$:function(a){return this.$el.find(a)},initialize:function(){},render:function(){return this},remove:function(){this.$el.remove();this.stopListening();return this},setElement:function(a,c){this.$el&&this.undelegateEvents();this.$el=a instanceof b.$?a:b.$(a);this.el=this.$el[0];!1!==c&&this.delegateEvents();return this},delegateEvents:function(a){if(!a&&!(a=c.result(this,"events")))return this;this.undelegateEvents();for(var b in a){var d=a[b];c.isFunction(d)||
(d=this[a[b]]);if(d){var e=b.match(x),f=e[1],e=e[2],d=c.bind(d,this),f=f+(".delegateEvents"+this.cid);if(""===e)this.$el.on(f,d);else this.$el.on(f,e,d)}}return this},undelegateEvents:function(){this.$el.off(".delegateEvents"+this.cid);return this},_ensureElement:function(){if(this.el)this.setElement(c.result(this,"el"),!1);else{var a=c.extend({},c.result(this,"attributes"));this.id&&(a.id=c.result(this,"id"));this.className&&(a["class"]=c.result(this,"className"));a=b.$("\x3c"+c.result(this,"tagName")+
"\x3e").attr(a);this.setElement(a,!1)}}});b.sync=function(a,d,e){var f=n[a];c.defaults(e||(e={}),{emulateHTTP:b.emulateHTTP,emulateJSON:b.emulateJSON});var g={type:f,dataType:"json"};e.url||(g.url=c.result(d,"url")||Y());null!=e.data||!d||"create"!==a&&"update"!==a&&"patch"!==a||(g.contentType="application/json",g.data=JSON.stringify(e.attrs||d.toJSON(e)));e.emulateJSON&&(g.contentType="application/x-www-form-urlencoded",g.data=g.data?{model:g.data}:{});if(e.emulateHTTP&&("PUT"===f||"DELETE"===f||
"PATCH"===f)){g.type="POST";e.emulateJSON&&(g.data._method=f);var h=e.beforeSend;e.beforeSend=function(a){a.setRequestHeader("X-HTTP-Method-Override",f);if(h)return h.apply(this,arguments)}}"GET"===g.type||e.emulateJSON||(g.processData=!1);"PATCH"===g.type&&E&&(g.xhr=function(){return new ActiveXObject("Microsoft.XMLHTTP")});a=e.xhr=b.ajax(c.extend(g,e));d.trigger("request",d,a,e);return a};var E="undefined"!==typeof window&&!!window.ActiveXObject&&!(window.XMLHttpRequest&&(new XMLHttpRequest).dispatchEvent),
n={create:"POST",update:"PUT",patch:"PATCH","delete":"DELETE",read:"GET"};b.ajax=function(){return b.$.ajax.apply(b.$,arguments)};var M=b.Router=function(a){a||(a={});a.routes&&(this.routes=a.routes);this._bindRoutes();this.initialize.apply(this,arguments)},B=/\((.*?)\)/g,D=/(\(\?)?:\w+/g,N=/\*\w+/g,y=/[\-{}\[\]+?.,\\\^$|#\s]/g;c.extend(M.prototype,g,{initialize:function(){},route:function(a,d,e){c.isRegExp(a)||(a=this._routeToRegExp(a));c.isFunction(d)&&(e=d,d="");e||(e=this[d]);var f=this;b.history.route(a,
function(c){c=f._extractParameters(a,c);f.execute(e,c);f.trigger.apply(f,["route:"+d].concat(c));f.trigger("route",d,c);b.history.trigger("route",f,d,c)});return this},execute:function(a,b){a&&a.apply(this,b)},navigate:function(a,c){b.history.navigate(a,c);return this},_bindRoutes:function(){if(this.routes){this.routes=c.result(this,"routes");for(var a,b=c.keys(this.routes);null!=(a=b.pop());)this.route(a,this.routes[a])}},_routeToRegExp:function(a){a=a.replace(y,"\\$\x26").replace(B,"(?:$1)?").replace(D,
function(a,b){return b?a:"([^/?]+)"}).replace(N,"([^?]*?)");return RegExp("^"+a+"(?:\\?([\\s\\S]*))?$")},_extractParameters:function(a,b){var d=a.exec(b).slice(1);return c.map(d,function(a,b){return b===d.length-1?a||null:a?decodeURIComponent(a):null})}});var C=b.History=function(){this.handlers=[];c.bindAll(this,"checkUrl");"undefined"!==typeof window&&(this.location=window.location,this.history=window.history)},z=/^[#\/]|\s+$/g,I=/^\/+|\/+$/g,G=/msie [\w.]+/,H=/\/$/,X=/#.*$/;C.started=!1;c.extend(C.prototype,
g,{interval:50,atRoot:function(){return this.location.pathname.replace(/[^\/]$/,"$\x26/")===this.root},getHash:function(a){return(a=(a||this).location.href.match(/#(.*)$/))?a[1]:""},getFragment:function(a,b){if(null==a)if(this._hasPushState||!this._wantsHashChange||b){a=decodeURI(this.location.pathname+this.location.search);var c=this.root.replace(H,"");a.indexOf(c)||(a=a.slice(c.length))}else a=this.getHash();return a.replace(z,"")},start:function(a){if(C.started)throw Error("Backbone.history has already been started");
C.started=!0;this.options=c.extend({root:"/"},this.options,a);this.root=this.options.root;this._wantsHashChange=!1!==this.options.hashChange;this._wantsPushState=!!this.options.pushState;this._hasPushState=!!(this.options.pushState&&this.history&&this.history.pushState);a=this.getFragment();var d=document.documentMode,d=G.exec(navigator.userAgent.toLowerCase())&&(!d||7>=d);this.root=("/"+this.root+"/").replace(I,"/");d&&this._wantsHashChange&&(this.iframe=b.$('\x3ciframe src\x3d"javascript:0" tabindex\x3d"-1"\x3e').hide().appendTo("body")[0].contentWindow,
...
this.atRoot()&&a.hash&&(this.fragment=this.getHash().replace(z,""),this.history.replaceState({},document.title,this.root+this.fragment))}if(!this.options.silent)return this.loadUrl()},stop:function(){b.$(window).off("popstate",this.checkUrl).off("hashchange",this.checkUrl);this._checkUrlInterval&&clearInterval(this._checkUrlInterval);C.started=!1},route:function(a,b){this.handlers.unshift({route:a,callback:b})},checkUrl:function(a){a=this.getFragment();a===this.fragment&&this.iframe&&(a=this.getFragment(this.getHash(this.iframe)));
if(a===this.fragment)return!1;this.iframe&&this.navigate(a);this.loadUrl()},loadUrl:function(a){a=this.fragment=this.getFragment(a);return c.any(this.handlers,function(b){if(b.route.test(a))return b.callback(a),!0})},navigate:function(a,b){if(!C.started)return!1;b&&!0!==b||(b={trigger:!!b});var c=this.root+(a=this.getFragment(a||""));a=a.replace(X,"");if(this.fragment!==a){this.fragment=a;""===a&&"/"!==c&&(c=c.slice(0,-1));if(this._hasPushState)this.history[b.replace?"replaceState":"pushState"]({},
document.title,c);else if(this._wantsHashChange)this._updateHash(this.location,a,b.replace),this.iframe&&a!==this.getFragment(this.getHash(this.iframe))&&(b.replace||this.iframe.document.open().close(),this._updateHash(this.iframe.location,a,b.replace));else return this.location.assign(c);if(b.trigger)return this.loadUrl(a)}},_updateHash:function(a,b,c){c?(c=a.href.replace(/(javascript:|#).*$/,""),a.replace(c+"#"+b)):a.hash="#"+b}});b.history=new C;p.extend=r.extend=M.extend=d.extend=C.extend=function(a,
b){var d=this,e;e=a&&c.has(a,"constructor")?a.constructor:function(){return d.apply(this,arguments)};c.extend(e,d,b);var f=function(){this.constructor=e};f.prototype=d.prototype;e.prototype=new f;a&&c.extend(e.prototype,a);e.__super__=d.prototype;return e};var Y=function(){throw Error('A "url" property or function must be specified');},R=function(a,b){var c=b.error;b.error=function(d){c&&c(a,d,b);a.trigger("error",a,d,b)}};return b});(function(){function a(a){return void 0!==a}function b(){}function c(a){a.ib=function(){return a.Ld?a.Ld:a.Ld=new a}}function d(a){var b=typeof a;if("object"==b)if(a){if(a instanceof Array)return"array";if(a instanceof Object)return b;var c=Object.prototype.toString.call(a);if("[object Window]"==c)return"object";if("[object Array]"==c||"number"==typeof a.length&&"undefined"!=typeof a.splice&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("splice"))return"array";if("[object Function]"==
c||"undefined"!=typeof a.call&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("call"))return"function"}else return"null";else if("function"==b&&"undefined"==typeof a.call)return"object";return b}function e(a){return"array"==d(a)}function f(a){var b=d(a);return"array"==b||"object"==b&&"number"==typeof a.length}function g(a){return"string"==typeof a}function h(a){return"number"==typeof a}function k(a){return"function"==d(a)}function m(a){var b=typeof a;return"object"==b&&null!=
a||"function"==b}function p(a,b,c){return a.call.apply(a.bind,arguments)}function r(a,b,c){if(!a)throw Error();if(2<arguments.length){var d=Array.prototype.slice.call(arguments,2);return function(){var c=Array.prototype.slice.call(arguments);Array.prototype.unshift.apply(c,d);return a.apply(b,c)}}return function(){return a.apply(b,arguments)}}function t(a,b,c){t=Function.prototype.bind&&-1!=Function.prototype.bind.toString().indexOf("native code")?p:r;return t.apply(null,arguments)}function u(b,c){var d=
b.split("."),e=cb;d[0]in e||!e.execScript||e.execScript("var "+d[0]);for(var f;d.length&&(f=d.shift());)!d.length&&a(c)?e[f]=c:e=e[f]?e[f]:e[f]={}}function x(a,b){function c(){}c.prototype=b.prototype;a.df=b.prototype;a.prototype=new c;a.$e=function(a,c,d){return b.prototype[c].apply(a,Array.prototype.slice.call(arguments,2))}}function w(a){a=String(a);if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);}function E(){this.Ec=void 0}function n(a,b,c){switch(typeof b){case "string":M(b,c);break;case "number":c.push(isFinite(b)&&!isNaN(b)?b:"null");break;case "boolean":c.push(b);break;case "undefined":c.push("null");break;case "object":if(null==b){c.push("null");break}if(e(b)){var d=b.length;c.push("[");for(var f="",g=0;g<d;g++)c.push(f),f=b[g],n(a,a.Ec?a.Ec.call(b,String(g),
f):f,c),f=",";c.push("]");break}c.push("{");d="";for(g in b)Object.prototype.hasOwnProperty.call(b,g)&&(f=b[g],"function"!=typeof f&&(c.push(d),M(g,c),c.push(":"),n(a,a.Ec?a.Ec.call(b,g,f):f,c),d=","));c.push("}");break;case "function":break;default:throw Error("Unknown type: "+typeof b);}}function M(a,b){b.push('"',a.replace(we,function(a){if(a in hc)return hc[a];var b=a.charCodeAt(0),c="\\u";16>b?c+="000":256>b?c+="00":4096>b&&(c+="0");return hc[a]=c+b.toString(16)}),'"')}function B(b){return"undefined"!==
typeof JSON&&a(JSON.parse)?JSON.parse(b):w(b)}function D(b){if("undefined"!==typeof JSON&&a(JSON.stringify))b=JSON.stringify(b);else{var c=[];n(new E,b,c);b=c.join("")}return b}function N(a){for(var b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);55296<=e&&56319>=e&&(e-=55296,d++,L(d<a.length,"Surrogate pair missing trail surrogate."),e=65536+(e<<10)+(a.charCodeAt(d)-56320));128>e?b[c++]=e:(2048>e?b[c++]=e>>6|192:(65536>e?b[c++]=e>>12|224:(b[c++]=e>>18|240,b[c++]=e>>12&63|128),b[c++]=e>>6&63|128),
b[c++]=e&63|128)}return b}function y(a,b,c,d){var e;d<b?e="at least "+b:d>c&&(e=0===c?"none":"no more than "+c);if(e)throw Error(a+" failed: Was called with "+d+(1===d?" argument.":" arguments.")+" Expects "+e+".");}function C(a,b,c){var d="";switch(b){case 1:d=c?"first":"First";break;case 2:d=c?"second":"Second";break;case 3:d=c?"third":"Third";break;case 4:d=c?"fourth":"Fourth";break;default:xe.assert(!1,"errorPrefix_ called with argumentNumber \x3e 4.  Need to update it?")}return a+" failed: "+
(d+" argument ")}function z(b,c,d,e){if((!e||a(d))&&!k(d))throw Error(C(b,c,e)+"must be a valid function.");}function I(b,c,d){if(a(d)&&(!m(d)||null===d))throw Error(C(b,c,!0)+"must be a valid context object.");}function G(a,b){return Object.prototype.hasOwnProperty.call(a,b)}function H(a,b){if(Object.prototype.hasOwnProperty.call(a,b))return a[b]}function X(a,b){for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&b(c,a[c])}function Y(a){var b={};X(a,function(a,c){b[a]=c});return b}function R(a){return g(a)&&
0!==a.length&&!ye.test(a)}function J(b,c,d){d&&!a(c)||Z(C(b,1,d),c)}function Z(b,c,d,e){d||(d=0);e=e||[];if(!a(c))throw Error(b+"contains undefined"+T(e));if(k(c))throw Error(b+"contains a function"+T(e)+" with contents: "+c.toString());if(ic(c))throw Error(b+"contains "+c.toString()+T(e));if(1E3<d)throw new TypeError(b+"contains a cyclic object value ("+e.slice(0,100).join(".")+"...)");if(g(c)&&c.length>10485760/3&&10485760<N(c).length)throw Error(b+"contains a string greater than 10485760 utf8 bytes"+
T(e)+" ('"+c.substring(0,50)+"...')");if(m(c))for(var f in c)if(G(c,f)){var h=c[f];if(".priority"!==f&&".value"!==f&&".sv"!==f&&!R(f))throw Error(b+" contains an invalid key ("+f+")"+T(e)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');e.push(f);Z(b,h,d+1,e);e.pop()}}function T(a){return 0==a.length?"":" in property '"+a.join(".")+"'"}function da(a,b){if(!m(b)||e(b))throw Error(C(a,1,!1)+" must be an Object containing the children to replace.");J(a,b,!1)}function V(b,
c,d,e){if(!e||a(d)){if(ic(d))throw Error(C(b,c,e)+"is "+d.toString()+", but must be a valid Firebase priority (a string, finite number, or null).");if(!(null===d||h(d)||g(d)||m(d)&&G(d,".sv")))throw Error(C(b,c,e)+"must be a valid Firebase priority (a string, finite number, or null).");}}function ba(b,c,d){if(!d||a(c))switch(c){case "value":case "child_added":case "child_removed":case "child_changed":case "child_moved":break;default:throw Error(C(b,1,d)+'must be a valid event type: "value", "child_added", "child_removed", "child_changed", or "child_moved".');
}}function ha(b,c){if(a(c)&&!R(c))throw Error(C(b,2,!0)+'was an invalid key: "'+c+'".  Firebase keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]").');}function Bb(a,b){if(!g(b)||0===b.length||Sc.test(b))throw Error(C(a,1,!1)+'was an invalid path: "'+b+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"');}function na(a,b){if(".info"===ea(b))throw Error(a+" failed: Can't modify data under /.info/");}function Oc(a,b){if(!g(b))throw Error(C(a,
1,!1)+"must be a valid credential (a string).");}function Cb(a,b,c){if(!g(c))throw Error(C(a,b,!1)+"must be a valid string.");}function ia(b,c,d,e){if(!e||a(d))if(!m(d)||null===d)throw Error(C(b,c,e)+"must be a valid object.");}function qa(a,b,c){if(!m(b)||null===b||!G(b,c))throw Error(C(a,1,!1)+'must contain the key "'+c+'"');if(!g(H(b,c)))throw Error(C(a,1,!1)+'must contain the key "'+c+'" with type "string"');}function K(b,c,d,e,f,g,h){this.i=b;this.path=c;this.Ga=d;this.fa=e;this.za=f;this.Ea=
g;this.fb=h;if(a(this.fa)&&a(this.Ea)&&a(this.Ga))throw"Query: Can't combine startAt(), endAt(), and limit().";}function fc(b){var c={};a(b.fa)&&(c.sp=b.fa);a(b.za)&&(c.sn=b.za);a(b.Ea)&&(c.ep=b.Ea);a(b.fb)&&(c.en=b.fb);a(b.Ga)&&(c.l=b.Ga);a(b.fa)&&a(b.za)&&null===b.fa&&null===b.za&&(c.vf="l");return c}function Pc(a,b,c){var d={};if(b&&c)d.cancel=b,z(a,3,d.cancel,!0),d.$=c,I(a,4,d.$);else if(b)if("object"===typeof b&&null!==b)d.$=b;else if("function"===typeof b)d.cancel=b;else throw Error(ze.af(a,
3,!0)+"must either be a cancel callback or a context object.");return d}function O(a,b){if(1==arguments.length){this.u=a.split("/");for(var c=0,d=0;d<this.u.length;d++)0<this.u[d].length&&(this.u[c]=this.u[d],c++);this.u.length=c;this.W=0}else this.u=a,this.W=b}function ea(a){return a.W>=a.u.length?null:a.u[a.W]}function ua(a){var b=a.W;b<a.u.length&&b++;return new O(a.u,b)}function Qc(a){return a.W<a.u.length?a.u[a.u.length-1]:null}function Rc(a,b){var c=ea(a);if(null===c)return b;if(c===ea(b))return Rc(ua(a),
ua(b));throw"INTERNAL ERROR: innerPath ("+b+") is not within outerPath ("+a+")";}function Tc(){this.children={};this.gc=0;this.value=null}function Da(a,b,c){this.Ha=a?a:"";this.Rb=b?b:null;this.A=c?c:new Tc}function P(a,b){for(var c=b instanceof O?b:new O(b),d=a,e;null!==(e=ea(c));)d=new Da(e,d,H(d.A.children,e)||new Tc),c=ua(c);return d}function ra(a,b){L("undefined"!==typeof b,"Cannot set value to undefined");a.A.value=b;Db(a)}function eb(a,b,c,d){c&&!d&&b(a);a.B(function(a){eb(a,b,!0,d)});c&&d&&
b(a)}function Eb(a,b,c){for(a=c?a:a.parent();null!==a;){if(b(a))return!0;a=a.parent()}return!1}function Db(a){if(null!==a.Rb){var b=a.Rb,c=a.Ha,d=a.f(),e=G(b.A.children,c);d&&e?(delete b.A.children[c],b.A.gc--,Db(b)):d||e||(b.A.children[c]=a.A,b.A.gc++,Db(b))}}function Ea(a,b){this.ab=a?a:Ae;this.ea=b?b:fb}function Ae(a,b){return a<b?-1:a>b?1:0}function Uc(a,b){for(var c,d=a.ea,e=null;!d.f();){c=a.ab(b,d.key);if(0===c){if(d.left.f())return e?e.key:null;for(d=d.left;!d.right.f();)d=d.right;return d.key}0>
c?d=d.left:0<c&&(e=d,d=d.right)}throw Error("Attempted to find predecessor key for a nonexistent key.  What gives?");}function Be(a,b){this.Wd=b;for(this.pc=[];!a.f();)this.pc.push(a),a=a.left}function gb(a){if(0===a.pc.length)return null;var b=a.pc.pop(),c;c=a.Wd?a.Wd(b.key,b.value):{key:b.key,value:b.value};for(b=b.right;!b.f();)a.pc.push(b),b=b.left;return c}function Pa(a,b,c,d,e){this.key=a;this.value=b;this.color=null!=c?c:!0;this.left=null!=d?d:fb;this.right=null!=e?e:fb}function jc(a){return a.left.f()?
a:jc(a.left)}function Vc(a){if(a.left.f())return fb;a.left.R()||a.left.left.R()||(a=Wc(a));a=a.M(null,null,null,Vc(a.left),null);return kc(a)}function kc(a){a.right.R()&&!a.left.R()&&(a=Xc(a));a.left.R()&&a.left.left.R()&&(a=Fb(a));a.left.R()&&a.right.R()&&(a=hb(a));return a}function Wc(a){a=hb(a);a.right.left.R()&&(a=a.M(null,null,null,null,Fb(a.right)),a=Xc(a),a=hb(a));return a}function Xc(a){return a.right.M(null,null,a.color,a.M(null,null,!0,null,a.right.left),null)}function Fb(a){return a.left.M(null,
null,a.color,null,a.M(null,null,!0,a.left.right,null))}function hb(a){return a.M(null,null,!a.color,a.left.M(null,null,!a.left.color,null,null),a.right.M(null,null,!a.right.color,null,null))}function Yc(){}function Zc(a){this.Db=a;this.zc="firebase:"}function ib(){this.zb={}}function $c(a){try{if("undefined"!==typeof window&&"undefined"!==typeof window[a]){var b=window[a];b.setItem("firebase:sentinel","cache");b.removeItem("firebase:sentinel");return new Zc(b)}}catch(c){}return new ib}function lc(a,
b,c,d,e){this.host=a.toLowerCase();this.domain=this.host.substr(this.host.indexOf(".")+1);this.Ya=b;this.Sa=c;this.Ye=d;this.yc=e||"";this.ia=wa.get("host:"+a)||this.host}function ad(a,b){b!==a.ia&&(a.ia=b,"s-"===a.ia.substr(0,2)&&wa.set("host:"+a.host,a.ia))}function Gb(){this.ra=-1;this.ra=64;this.F=[];this.Sc=[];this.ge=[];this.vc=[];this.vc[0]=128;for(var a=1;a<this.ra;++a)this.vc[a]=0;this.Kc=this.kb=0;this.reset()}function Hb(a,b,c){c||(c=0);var d=a.ge;if(g(b))for(var e=0;16>e;e++)d[e]=b.charCodeAt(c)<<
24|b.charCodeAt(c+1)<<16|b.charCodeAt(c+2)<<8|b.charCodeAt(c+3),c+=4;else for(e=0;16>e;e++)d[e]=b[c]<<24|b[c+1]<<16|b[c+2]<<8|b[c+3],c+=4;for(e=16;80>e;e++){var f=d[e-3]^d[e-8]^d[e-14]^d[e-16];d[e]=(f<<1|f>>>31)&4294967295}b=a.F[0];c=a.F[1];for(var h=a.F[2],k=a.F[3],m=a.F[4],n,e=0;80>e;e++)40>e?20>e?(f=k^c&(h^k),n=1518500249):(f=c^h^k,n=1859775393):60>e?(f=c&h|k&(c|h),n=2400959708):(f=c^h^k,n=3395469782),f=(b<<5|b>>>27)+f+m+n+d[e]&4294967295,m=k,k=h,h=(c<<30|c>>>2)&4294967295,c=b,b=f;a.F[0]=a.F[0]+
b&4294967295;a.F[1]=a.F[1]+c&4294967295;a.F[2]=a.F[2]+h&4294967295;a.F[3]=a.F[3]+k&4294967295;a.F[4]=a.F[4]+m&4294967295}function Qa(){return Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Ce()).toString(36)}function De(a,b){var c;a:{c=a.length;for(var d=g(a)?a.split(""):a,e=0;e<c;e++)if(e in d&&b.call(void 0,d[e],e,a)){c=e;break a}c=-1}return 0>c?null:g(a)?a.charAt(c):a[c]}function Ee(a,b){a.sort(b||Fe)}function Fe(a,b){return a>b?1:a<b?-1:0}function Fa(a){return-1!=
Ra.indexOf(a)}function bd(a,b){if(!f(a))throw Error("encodeByteArray takes an array as a parameter");if(!Ib){Ib={};mc={};for(var c=0;65>c;c++)Ib[c]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(c),mc[c]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(c)}for(var c=b?mc:Ib,d=[],e=0;e<a.length;e+=3){var g=a[e],h=e+1<a.length,k=h?a[e+1]:0,m=e+2<a.length,n=m?a[e+2]:0,p=g>>2,g=(g&3)<<4|k>>4,k=(k&15)<<2|n>>6,n=n&63;m||(n=64,h||(k=64));d.push(c[p],
c[g],c[k],c[n])}return d.join("")}function L(a,b){if(!a)throw Error("Firebase INTERNAL ASSERT FAILED:"+b);}function cd(a){try{if("undefined"!==typeof atob)return atob(a)}catch(b){oa("base64DecodeIfNativeSupport failed: ",b)}return null}function dd(a){var b=N(a);a=new Gb;a.update(b);var b=[],c=8*a.Kc;56>a.kb?a.update(a.vc,56-a.kb):a.update(a.vc,a.ra-(a.kb-56));for(var d=a.ra-1;56<=d;d--)a.Sc[d]=c&255,c/=256;Hb(a,a.Sc);for(d=c=0;5>d;d++)for(var e=24;0<=e;e-=8)b[c]=a.F[d]>>e&255,++c;return bd(b)}function jb(a){for(var b=
"",c=0;c<arguments.length;c++)b=f(arguments[c])?b+jb.apply(null,arguments[c]):"object"===typeof arguments[c]?b+D(arguments[c]):b+arguments[c],b+=" ";return b}function oa(a){!0===ed&&(ed=!1,null===Ga&&!0===ja.get("logging_enabled")&&fd(!0));if(Ga){var b=jb.apply(null,arguments);Ga(b)}}function Jb(a){return function(){oa(a,arguments)}}function nc(a){if("undefined"!==typeof console){var b="FIREBASE INTERNAL ERROR: "+jb.apply(null,arguments);"undefined"!==typeof console.error?console.error(b):console.log(b)}}
function gd(a){var b=jb.apply(null,arguments);throw Error("FIREBASE FATAL ERROR: "+b);}function $(a){if("undefined"!==typeof console){var b="FIREBASE WARNING: "+jb.apply(null,arguments);"undefined"!==typeof console.warn?console.warn(b):console.log(b)}}function Kb(a){var b="",c="",d="",e=!0,f="https",h="";if(g(a)){var k=a.indexOf("//");0<=k&&(f=a.substring(0,k-1),a=a.substring(k+2));k=a.indexOf("/");-1===k&&(k=a.length);b=a.substring(0,k);a=a.substring(k+1);var m=b.split(".");if(3===m.length){k=m[2].indexOf(":");
e=0<=k?"https"===f||"wss"===f:!0;c=m[1];d=m[0];h="";a=("/"+a).split("/");for(k=0;k<a.length;k++)if(0<a[k].length){m=a[k];try{m=decodeURIComponent(m.replace(/\+/g," "))}catch(n){}h+="/"+m}d=d.toLowerCase()}else 2===m.length&&(c=m[0])}return{host:b,domain:c,Ve:d,Ya:e,scheme:f,pb:h}}function ic(a){return h(a)&&(a!=a||a==Number.POSITIVE_INFINITY||a==Number.NEGATIVE_INFINITY)}function Ge(a){if("complete"===document.readyState)a();else{var b=!1,c=function(){document.body?b||(b=!0,a()):setTimeout(c,Math.floor(10))};
document.addEventListener?(document.addEventListener("DOMContentLoaded",c,!1),window.addEventListener("load",c,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",function(){"complete"===document.readyState&&c()}),window.attachEvent("onload",c))}}function Ha(a,b){return a!==b?null===a?-1:null===b?1:typeof a!==typeof b?"number"===typeof a?-1:1:a>b?1:-1:0}function Ia(a,b){if(a===b)return 0;var c=hd(a),d=hd(b);return null!==c?null!==d?0==c-d?a.length-b.length:c-d:-1:null!==d?1:a<b?
-1:1}function kb(a,b){if(b&&a in b)return b[a];throw Error("Missing required key ("+a+") in object: "+D(b));}function oc(a){if("object"!==typeof a||null===a)return D(a);var b=[],c;for(c in a)b.push(c);b.sort();c="{";for(var d=0;d<b.length;d++)0!==d&&(c+=","),c+=D(b[d]),c+=":",c+=oc(a[b[d]]);return c+"}"}function id(a,b){if(a.length<=b)return[a];for(var c=[],d=0;d<a.length;d+=b)d+b>a?c.push(a.substring(d,a.length)):c.push(a.substring(d,d+b));return c}function pc(a,b){if(e(a))for(var c=0;c<a.length;++c)b(c,
a[c]);else xa(a,b)}function qc(a,b){return b?t(a,b):a}function jd(a){L(!ic(a),"Invalid JSON number");var b,c,d,e;0===a?(d=c=0,b=-Infinity===1/a?1:0):(b=0>a,a=Math.abs(a),a>=Math.pow(2,-1022)?(d=Math.min(Math.floor(Math.log(a)/Math.LN2),1023),c=d+1023,d=Math.round(a*Math.pow(2,52-d)-Math.pow(2,52))):(c=0,d=Math.round(a/Math.pow(2,-1074))));e=[];for(a=52;a;a-=1)e.push(d%2?1:0),d=Math.floor(d/2);for(a=11;a;a-=1)e.push(c%2?1:0),c=Math.floor(c/2);e.push(b?1:0);e.reverse();b=e.join("");c="";for(a=0;64>
a;a+=8)d=parseInt(b.substr(a,8),2).toString(16),1===d.length&&(d="0"+d),c+=d;return c.toLowerCase()}function He(a){var b="Unknown Error";"too_big"===a?b="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"==a?b="Client doesn't have permission to access the desired data.":"unavailable"==a&&(b="The service is unavailable");b=Error(a+": "+b);b.code=a.toUpperCase();return b}function hd(a){return Ie.test(a)&&(a=Number(a),-2147483648<=a&&2147483647>=
a)?a:null}function Ja(a){try{a()}catch(b){setTimeout(function(){throw b;},Math.floor(0))}}function W(a,b){if(k(a)){var c=Array.prototype.slice.call(arguments,1).slice();Ja(function(){a.apply(null,c)})}}function Ka(a,b){this.H=a;L(null!==this.H,"LeafNode shouldn't be created with null value.");this.qb="undefined"!==typeof b?b:null}function Lb(a,b){return Ha(a.la,b.la)||Ia(a.name,b.name)}function Je(a,b){return Ia(a.name,b.name)}function kd(a,b){return Ia(a,b)}function ka(a,b){this.o=a||new Ea(kd);
this.qb="undefined"!==typeof b?b:null}function lb(a,b,c){ka.call(this,a,c);null===b&&(b=new Ea(Lb),a.Fa(function(a,c){b=b.ta({name:a,la:c.m()},c)}));this.ya=b}function la(a,b){if(null===a)return S;var c=null;"object"===typeof a&&".priority"in a?c=a[".priority"]:"undefined"!==typeof b&&(c=b);L(null===c||"string"===typeof c||"number"===typeof c||"object"===typeof c&&".sv"in c,"Invalid priority type found: "+typeof c);"object"===typeof a&&".value"in a&&null!==a[".value"]&&(a=a[".value"]);if("object"!==
typeof a||".sv"in a)return new Ka(a,c);if(a instanceof Array){var d=S,e=a;xa(e,function(a,b){if(G(e,b)&&"."!==b.substring(0,1)){var c=la(a);if(c.Q()||!c.f())d=d.K(b,c)}});return d.Ka(c)}var f=[],g={},h=!1,k=a;pc(k,function(a,b){if("string"!==typeof b||"."!==b.substring(0,1)){var c=la(k[b]);c.f()||(h=h||null!==c.m(),f.push({name:b,la:c.m()}),g[b]=c)}});var m=ld(f,g,!1);if(h){var n=ld(f,g,!0);return new lb(m,n,c)}return new ka(m,c)}function Ke(a){this.count=parseInt(Math.log(a+1)/Le,10);this.Fd=this.count-
1;this.pe=a+1&parseInt(Array(this.count+1).join("1"),2)}function Me(a){var b=!(a.pe&1<<a.Fd);a.Fd--;return b}function ld(a,b,c){function d(e,f){var g=f-e;if(0==g)return null;if(1==g){var g=a[e].name,h=c?a[e]:g;return new Pa(h,b[g],!1,null,null)}var h=parseInt(g/2,10)+e,k=d(e,h),m=d(h+1,f),g=a[h].name,h=c?a[h]:g;return new Pa(h,b[g],!1,k,m)}var e=c?Lb:Je;a.sort(e);var f=function(e){function f(e,m){var va=k-e,db=k;k-=e;var n=a[va].name,va=new Pa(c?a[va]:n,b[n],m,null,d(va+1,db));g?g.left=va:h=va;g=
va}for(var g=null,h=null,k=a.length,m=0;m<e.count;++m){var va=Me(e),db=Math.pow(2,e.count-(m+1));va?f(db,!1):(f(db,!1),f(db,!0))}return h}(new Ke(a.length)),e=c?Lb:kd;return null!==f?new Ea(e,f):new Ea(e)}function md(a){return"number"===typeof a?"number:"+jd(a):"string:"+a}function F(a,b){this.A=a;this.Cc=b}function ya(a){L(e(a)&&0<a.length,"Requires a non-empty array");this.he=a;this.Kb={}}function nd(a,b){L(De(a.he,function(a){return a===b}),"Unknown event: "+b)}function Mb(){ya.call(this,["visible"]);
var a,b;"undefined"!==typeof document&&"undefined"!==typeof document.addEventListener&&("undefined"!==typeof document.hidden?(b="visibilitychange",a="hidden"):"undefined"!==typeof document.mozHidden?(b="mozvisibilitychange",a="mozHidden"):"undefined"!==typeof document.msHidden?(b="msvisibilitychange",a="msHidden"):"undefined"!==typeof document.webkitHidden&&(b="webkitvisibilitychange",a="webkitHidden"));this.yb=!0;if(b){var c=this;document.addEventListener(b,function(){var b=!document[a];b!==c.yb&&
(c.yb=b,c.Mc("visible",b))},!1)}}function Nb(){ya.call(this,["online"]);this.Pb=!0;if("undefined"!==typeof window&&"undefined"!==typeof window.addEventListener){var a=this;window.addEventListener("online",function(){a.Pb||a.Mc("online",!0);a.Pb=!0},!1);window.addEventListener("offline",function(){a.Pb&&a.Mc("online",!1);a.Pb=!1},!1)}}function xa(a,b){for(var c in a)b.call(void 0,a[c],c,a)}function Ne(a){var b=[],c=0,d;for(d in a)b[c++]=d;return b}function od(a){for(var b in a)return!1;return!0}function pd(a){var b=
{},c;for(c in a)b[c]=a[c];return b}function Oe(a,b){for(var c,d,e=1;e<arguments.length;e++){d=arguments[e];for(c in d)a[c]=d[c];for(var f=0;f<qd.length;f++)c=qd[f],Object.prototype.hasOwnProperty.call(d,c)&&(a[c]=d[c])}}function rd(){this.Cb={}}function Sa(b,c,d){a(d)||(d=1);G(b.Cb,c)||(b.Cb[c]=0);b.Cb[c]+=d}function rc(a){this.qe=a;this.mc=null}function sd(a,b){this.yd={};this.Hc=new rc(a);this.n=b;var c=1E4+2E4*Math.random();setTimeout(t(this.Ud,this),Math.floor(c))}function sc(a){a=a.toString();
tc[a]||(tc[a]=new rd);return tc[a]}function Pe(a,b){var c=a.toString();uc[c]||(uc[c]=b());return uc[c]}function sa(a,b,c){this.Wc=a;this.e=Jb(this.Wc);this.frames=this.Ib=null;this.Ma=this.Na=this.Ad=0;this.ga=sc(b);this.Ca=(b.Ya?"wss://":"ws://")+b.ia+"/.ws?v\x3d5";"undefined"!==typeof location&&location.href&&-1!==location.href.indexOf("firebaseio.com")&&(this.Ca+="\x26r\x3df");b.host!==b.ia&&(this.Ca=this.Ca+"\x26ns\x3d"+b.Sa);c&&(this.Ca=this.Ca+"\x26s\x3d"+c)}function td(a,b){a.frames.push(b);
if(a.frames.length==a.Ad){var c=a.frames.join("");a.frames=null;c=B(c);a.Ge(c)}}function vc(a){clearInterval(a.Ib);a.Ib=setInterval(function(){a.Y&&a.Y.send("0");vc(a)},Math.floor(45E3))}function Qe(a){this.ob=a;this.xc=[];this.eb=0;this.Vc=-1;this.Ua=null}function Re(a,b,c){a.Vc=b;a.Ua=c;a.Vc<a.eb&&(a.Ua(),a.Ua=null)}function Se(a,b,c){for(a.xc[b]=c;a.xc[a.eb];){var d=a.xc[a.eb];delete a.xc[a.eb];for(var e=0;e<d.length;++e)if(d[e]){var f=a;Ja(function(){f.ob(d[e])})}if(a.eb===a.Vc){a.Ua&&(clearTimeout(a.Ua),
a.Ua(),a.Ua=null);break}a.eb++}}function Ob(){this.set={}}function ta(a,b){xa(a.set,function(a,c){b(c,a)})}function mb(a,b,c){this.Wc=a;this.e=Jb(a);this.Ma=this.Na=0;this.ga=sc(b);this.Gc=c;this.Eb=!1;this.dc=function(a){b.host!==b.ia&&(a.ns=b.Sa);var c=[],d;for(d in a)a.hasOwnProperty(d)&&c.push(d+"\x3d"+a[d]);return(b.Ya?"https://":"http://")+b.ia+"/.lp?"+c.join("\x26")}}function ud(a,b){var c=D(b).length;a.Ma+=c;Sa(a.ga,"bytes_received",c)}function vd(a,b,c,d){this.dc=d;this.ka=c;this.od=new Ob;
this.Tb=[];this.Yc=Math.floor(1E8*Math.random());this.Fc=!0;this.Nc=Pb();window["pLPCommand"+this.Nc]=a;window["pRTLPCB"+this.Nc]=b;a=document.createElement("iframe");a.style.display="none";if(document.body){document.body.appendChild(a);try{a.contentWindow.document||oa("No IE domain setting required")}catch(e){a.src="javascript:void((function(){document.open();document.domain\x3d'"+document.domain+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";
a.contentDocument?a.Da=a.contentDocument:a.contentWindow?a.Da=a.contentWindow.document:a.document&&(a.Da=a.document);this.aa=a;a="";this.aa.src&&"javascript:"===this.aa.src.substr(0,11)&&(a='\x3cscript\x3edocument.domain\x3d"'+document.domain+'";\x3c/script\x3e');a="\x3chtml\x3e\x3cbody\x3e"+a+"\x3c/body\x3e\x3c/html\x3e";try{this.aa.Da.open(),this.aa.Da.write(a),this.aa.Da.close()}catch(f){oa("frame writing exception"),f.stack&&oa(f.stack),oa(f)}}function wc(a){if(a.Qc&&a.Fc&&a.od.count()<(0<a.Tb.length?
2:1)){a.Yc++;var b={};b.id=a.Be;b.pw=a.Ce;b.ser=a.Yc;for(var b=a.dc(b),c="",d=0;0<a.Tb.length;)if(1870>=a.Tb[0].Gd.length+30+c.length){var e=a.Tb.shift(),c=c+"\x26seg"+d+"\x3d"+e.Pe+"\x26ts"+d+"\x3d"+e.We+"\x26d"+d+"\x3d"+e.Gd;d++}else break;Te(a,b+c,a.Yc);return!0}return!1}function Te(a,b,c){function d(){a.od.remove(c);wc(a)}a.od.add(c);var e=setTimeout(d,Math.floor(25E3));wd(a,b,function(){clearTimeout(e);d()})}function wd(a,b,c){setTimeout(function(){try{if(a.Fc){var d=a.aa.Da.createElement("script");
d.type="text/javascript";d.async=!0;d.src=b;d.onload=d.onreadystatechange=function(){var a=d.readyState;a&&"loaded"!==a&&"complete"!==a||(d.onload=d.onreadystatechange=null,d.parentNode&&d.parentNode.removeChild(d),c())};d.onerror=function(){oa("Long-poll script failed to load: "+b);a.Fc=!1;a.close()};a.aa.Da.body.appendChild(d)}}catch(e){}},Math.floor(1))}function Ue(a){Ve(this,a)}function Ve(a,b){var c=sa&&sa.isAvailable(),d=c&&!(wa.Nd||!0===wa.get("previous_websocket_failure"));b.Ye&&(c||$("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),
d=!0);if(d)a.bc=[sa];else{var e=a.bc=[];pc(We,function(a,b){b&&b.isAvailable()&&e.push(b)})}}function Xe(a){if(0<a.bc.length)return a.bc[0];throw Error("No transports available");}function za(a,b,c,d,e,f){this.id=a;this.e=Jb("c:"+this.id+":");this.ob=c;this.Ob=d;this.U=e;this.md=f;this.D=b;this.wc=[];this.Dd=0;this.ce=new Ue(b);this.oa=0;this.e("Connection created");xd(this)}function xd(a){var b=Xe(a.ce);a.C=new b("c:"+a.id+":"+a.Dd++,a.D);a.qd=b.responsesRequiredToBeHealthy||0;var c=yd(a,a.C),d=
zd(a,a.C);a.cc=a.C;a.$b=a.C;a.w=null;a.Ra=!1;setTimeout(function(){a.C&&a.C.open(c,d)},Math.floor(0));b=b.healthyTimeout||0;0<b&&(a.kc=setTimeout(function(){a.kc=null;a.Ra||(a.C&&102400<a.C.Ma?(a.e("Connection exceeded healthy timeout but has received "+a.C.Ma+" bytes.  Marking connection healthy."),a.Ra=!0,a.C.nc()):a.C&&10240<a.C.Na?a.e("Connection exceeded healthy timeout but has sent "+a.C.Na+" bytes.  Leaving connection alive."):(a.e("Closing unhealthy connection after timeout."),a.close()))},
Math.floor(b)))}function zd(a,b){return function(c){b===a.C?(a.C=null,c||0!==a.oa?1===a.oa&&a.e("Realtime connection lost."):(a.e("Realtime connection failed."),"s-"===a.D.ia.substr(0,2)&&(wa.remove("host:"+a.D.host),a.D.ia=a.D.host)),a.close()):b===a.w?(a.e("Secondary connection lost."),c=a.w,a.w=null,a.cc!==c&&a.$b!==c||a.close()):a.e("closing an old connection")}}function yd(a,b){return function(c){if(2!=a.oa)if(b===a.$b){var d=kb("t",c);c=kb("d",c);if("c"==d){if(d=kb("t",c),"d"in c)if(c=c.d,"h"===
d){var d=c.ts,e=c.v,f=c.h;a.Gc=c.s;ad(a.D,f);0==a.oa&&(a.C.start(),Ye(a,a.C,d),"5"!==e&&$("Protocol version mismatch detected"),c=a.ce,(c=1<c.bc.length?c.bc[1]:null)&&Ze(a,c))}else if("n"===d){a.e("recvd end transmission on primary");a.$b=a.w;for(c=0;c<a.wc.length;++c)a.tc(a.wc[c]);a.wc=[];Ad(a)}else"s"===d?(a.e("Connection shutdown command received. Shutting down..."),a.md&&(a.md(c),a.md=null),a.U=null,a.close()):"r"===d?(a.e("Reset packet received.  New host: "+c),ad(a.D,c),1===a.oa?a.close():(Bd(a),
xd(a))):"e"===d?nc("Server Error: "+c):"o"===d?(a.e("got pong on primary."),Cd(a),Dd(a)):nc("Unknown control packet command: "+d)}else"d"==d&&a.tc(c)}else if(b===a.w)if(d=kb("t",c),c=kb("d",c),"c"==d)"t"in c&&(c=c.t,"a"===c?Ed(a):"r"===c?(a.e("Got a reset on secondary, closing it"),a.w.close(),a.cc!==a.w&&a.$b!==a.w||a.close()):"o"===c&&(a.e("got pong on secondary."),a.Yd--,Ed(a)));else if("d"==d)a.wc.push(c);else throw Error("Unknown protocol layer: "+d);else a.e("message on old connection")}}function Ad(a){a.cc===
a.w&&a.$b===a.w&&(a.e("cleaning up and promoting a connection: "+a.w.Wc),a.C=a.w,a.w=null)}function Ed(a){0>=a.Yd?(a.e("Secondary connection is healthy."),a.Ra=!0,a.w.nc(),a.w.start(),a.e("sending client ack on secondary"),a.w.send({t:"c",d:{t:"a",d:{}}}),a.e("Ending transmission on primary"),a.C.send({t:"c",d:{t:"n",d:{}}}),a.cc=a.w,Ad(a)):(a.e("sending ping on secondary."),a.w.send({t:"c",d:{t:"p",d:{}}}))}function Cd(a){a.Ra||(a.qd--,0>=a.qd&&(a.e("Primary connection is healthy."),a.Ra=!0,a.C.nc()))}
function Ze(a,b){a.w=new b("c:"+a.id+":"+a.Dd++,a.D,a.Gc);a.Yd=b.responsesRequiredToBeHealthy||0;a.w.open(yd(a,a.w),zd(a,a.w));setTimeout(function(){a.w&&(a.e("Timed out trying to upgrade."),a.w.close())},Math.floor(6E4))}function Ye(a,b,c){a.e("Realtime connection established.");a.C=b;a.oa=1;a.Ob&&(a.Ob(c),a.Ob=null);0===a.qd?(a.e("Primary connection is healthy."),a.Ra=!0):setTimeout(function(){Dd(a)},Math.floor(5E3))}function Dd(a){a.Ra||1!==a.oa||(a.e("sending ping on primary."),Fd(a,{t:"c",d:{t:"p",
d:{}}}))}function Fd(a,b){if(1!==a.oa)throw"Connection is not connected";a.cc.send(b)}function Bd(a){a.e("Shutting down all connections");a.C&&(a.C.close(),a.C=null);a.w&&(a.w.close(),a.w=null);a.kc&&(clearTimeout(a.kc),a.kc=null)}function xc(a){var b={},c={},d={},e="";try{var f=a.split("."),b=B(cd(f[0])||""),c=B(cd(f[1])||""),e=f[2],d=c.d||{};delete c.d}catch(g){}return{cf:b,Uc:c,data:d,Ue:e}}function Gd(a){a=xc(a).Uc;return"object"===typeof a&&a.hasOwnProperty("iat")?H(a,"iat"):null}function Hd(a){a=
xc(a);var b=a.Uc;return!!a.Ue&&!!b&&"object"===typeof b&&b.hasOwnProperty("iat")}function La(a,c,d,e,f){this.id=$e++;this.e=Jb("p:"+this.id+":");this.Za=!0;this.ja={};this.V=[];this.Qb=0;this.Nb=[];this.T=!1;this.va=1E3;this.oc=3E5;this.uc=c||b;this.sc=d||b;this.nd=e||b;this.dd=f||b;this.D=a;this.ud=null;this.Xb={};this.Oe=0;this.Jb=this.hd=null;nb(this,0);Mb.ib().Ta("visible",this.Je,this);-1===a.host.indexOf("fblocal")&&Nb.ib().Ta("online",this.He,this)}function af(a,b,c){var d=b.toString(),e=b.path().toString();
a.ja[e]=a.ja[e]||{};L(!a.ja[e][d],"listen() called twice for same path/queryId.");a.ja[e][d]={rb:b.rb(),G:c};a.T&&Id(a,e,d,b.rb(),c)}function Id(a,b,c,d,e){a.e("Listen on "+b+" for "+c);var f={p:b};d=ob(d,function(a){return fc(a)});"{}"!==c&&(f.q=d);f.h=a.dd(b);a.Ia("l",f,function(d){a.e("listen response",d);d=d.s;"ok"!==d&&yc(a,b,c);e&&e(d)})}function Jd(a){var b=a.bb;a.T&&b&&a.Ia("auth",{cred:b.re},function(c){var d=c.s;c=c.d||"error";"ok"!==d&&a.bb===b&&delete a.bb;b.Id?"ok"!==d&&b.fc&&b.fc(d,
c):(b.Id=!0,b.ca&&b.ca(d,c))})}function Kd(a,b,c,d){b=b.toString();yc(a,b,c)&&a.T&&bf(a,b,c,d)}function bf(a,b,c,d){a.e("Unlisten on "+b+" for "+c);b={p:b};d=ob(d,function(a){return fc(a)});"{}"!==c&&(b.q=d);a.Ia("u",b)}function Ld(a,b,c,d){a.T?Qb(a,"o",b,c,d):a.Nb.push({pb:b,action:"o",data:c,G:d})}function cf(a,b,c,d){a.T?Qb(a,"om",b,c,d):a.Nb.push({pb:b,action:"om",data:c,G:d})}function Qb(a,b,c,d,e){c={p:c,d:d};a.e("onDisconnect "+b,c);a.Ia(b,c,function(a){e&&setTimeout(function(){e(a.s,a.d)},
Math.floor(0))})}function df(a,b,c,d){Md(a,"m",b,c,d,void 0)}function Md(b,c,d,e,f,g){d={p:d,d:e};a(g)&&(d.h=g);b.V.push({action:c,Vd:d,G:f});b.Qb++;c=b.V.length-1;b.T&&Nd(b,c)}function Nd(a,b){var c=a.V[b].action,d=a.V[b].Vd,e=a.V[b].G;a.V[b].Le=a.T;a.Ia(c,d,function(d){a.e(c+" response",d);delete a.V[b];a.Qb--;0===a.Qb&&(a.V=[]);e&&e(d.s,d.d)})}function nb(a,b){L(!a.ma,"Scheduling a connect when we're already connected/ing?");a.gb&&clearTimeout(a.gb);a.gb=setTimeout(function(){a.gb=null;ef(a)},
Math.floor(b))}function ef(a){if(a.Za){a.e("Making a connection attempt");a.hd=(new Date).getTime();a.Jb=null;var b=t(a.tc,a),c=t(a.Ob,a),d=t(a.Qd,a),e=a.id+":"+ff++;a.ma=new za(e,a.D,b,c,d,function(b){$(b+" ("+a.D.toString()+")");a.Za=!1})}}function gf(a,b,c){c=c?ob(c,function(a){return oc(a)}).join("$"):"{}";(a=yc(a,b,c))&&a.G&&a.G("permission_denied")}function yc(a,b,c){b=(new O(b)).toString();c||(c="{}");var d=a.ja[b][c];delete a.ja[b][c];return d}function Ta(){this.o=this.H=null}function zc(a,
b){if(b.f())return a.H=null,a.o=null,!0;if(null!==a.H){if(a.H.Q())return!1;var c=a.H;a.H=null;c.B(function(b,c){a.sb(new O(b),c)});return zc(a,b)}return null!==a.o?(c=ea(b),b=ua(b),a.o.contains(c)&&zc(a.o.get(c),b)&&a.o.remove(c),a.o.f()?(a.o=null,!0):!1):!0}function Ac(a,b,c){null!==a.H?c(b,a.H):a.B(function(a,d){var e=new O(b.toString()+"/"+a);Ac(d,e,c)})}function Ua(){this.ba=S}function Q(a,b){return a.ba.N(b)}function ca(a,b,c){a.ba=a.ba.Ba(b,c)}function Od(){this.wa=new Ua;this.O=new Ua;this.qa=
new Ua;this.Sb=new Da}function hf(a,b,c){ca(a.wa,b,c);return pb(a,b)}function pb(a,b){for(var c=Q(a.wa,b),d=Q(a.O,b),e=P(a.Sb,b),f=!1,g=e;null!==g;){if(null!==g.k()){f=!0;break}g=g.parent()}if(f)return!1;c=Pd(c,d,e);return c!==d?(ca(a.O,b,c),!0):!1}function Pd(a,b,c){if(c.f())return a;if(null!==c.k())return b;a=a||S;c.B(function(d){d=d.name();var e=a.P(d),f=b.P(d),g=P(c,d),e=Pd(e,f,g);a=a.K(d,e)});return a}function Rb(a,b){Va(b,function(b){var c=b.Re;b=P(a.Sb,b.path);var d=b.k();L(null!==d,"pendingPut should not be null.");
d===c&&ra(b,null)})}function Bc(a,b){return a&&"object"===typeof a?(L(".sv"in a,"Unexpected leaf node or priority contents"),b[a[".sv"]]):a}function jf(a,b){var c=new Ta;Ac(a,new O(""),function(a,d){c.sb(a,qb(d,b))});return c}function qb(a,b){var c=Bc(a.m(),b),d;if(a.Q()){var e=Bc(a.k(),b);return e!==a.k()||c!==a.m()?new Ka(e,c):a}d=a;c!==a.m()&&(d=d.Ka(c));a.B(function(a,c){var e=qb(c,b);e!==c&&(d=d.K(a,e))});return d}function Cc(a,b,c){this.hc=a||{};this.Lc=b||{};this.vb=c||{};this.hc.remember||
(this.hc.remember="default")}function Ma(a){var b={},c={};X(a||{},function(a,d){0<=kf(lf,a)?b[a]=d:c[a]=d});return new Cc(b,{},c)}function fa(a){var b=Error(H(mf,a),a);b.code=a;return b}function nf(){var a=window.opener.frames,b;for(b=a.length-1;0<=b;b--)try{if(a[b].location.protocol===window.location.protocol&&a[b].location.host===window.location.host&&"__winchan_relay_frame"===a[b].name)return a[b]}catch(c){}return null}function Ca(a,b,c){a.attachEvent?a.attachEvent("on"+b,c):a.addEventListener&&
a.addEventListener(b,c,!1)}function Wa(a,b,c){a.detachEvent?a.detachEvent("on"+b,c):a.removeEventListener&&a.removeEventListener(b,c,!1)}function Qd(a){/^https?:\/\//.test(a)||(a=window.location.href);var b=/^(https?:\/\/[\-_a-zA-Z\.0-9:]+)/.exec(a);return b?b[1]:a}function Xa(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=H(a,c);if(e(d))for(var f=0;f<d.length;f++)b.push(encodeURIComponent(c)+"\x3d"+encodeURIComponent(d[f]));else b.push(encodeURIComponent(c)+"\x3d"+encodeURIComponent(H(a,
c)))}return b.join("\x26")}function Dc(){var a=Kb(rb);return a.scheme+"://"+a.host+"/v2"}function Sb(){return!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(navigator.userAgent)}function Tb(){var a=navigator.userAgent;if("Microsoft Internet Explorer"===navigator.appName){if((a=a.match(/MSIE ([0-9]{1,}[\.0-9]{0,})/))&&1<a.length)return 8<=parseFloat(a[1])}else if(-1<a.indexOf("Trident")&&(a=a.match(/rv:([0-9]{2,2}[\.0-9]{0,})/))&&1<a.length)return 8<=
parseFloat(a[1]);return!1}function Ya(a){a=a||{};a.method||(a.method="GET");a.headers||(a.headers={});a.headers.content_type||(a.headers.content_type="application/json");a.headers.content_type=a.headers.content_type.toLowerCase();this.options=a}function sb(a){a=a||{};this.Yb=Qa()+Qa()+Qa();this.Rd=a||{}}function tb(a){a=a||{};if(!a.window_features||-1!==navigator.userAgent.indexOf("Fennec/")||-1!==navigator.userAgent.indexOf("Firefox/")&&-1!==navigator.userAgent.indexOf("Android"))a.window_features=
void 0;a.window_name||(a.window_name="_blank");a.relay_url||(a.relay_url=Dc()+"/auth/channel");this.options=a}function Za(a){a=a||{};a.callback_parameter||(a.callback_parameter="callback");this.options=a;window.__firebase_login_jsonp=window.__firebase_login_jsonp||{}}function of(a,b,c){setTimeout(function(){try{var d=document.createElement("script");d.type="text/javascript";d.id=a;d.async=!0;d.src=b;d.onerror=function(){var b=document.getElementById(a);null!==b&&b.parentNode.removeChild(b);c&&c(fa("NETWORK_ERROR"))};
var e=document.getElementsByTagName("head");(e&&0!=e.length?e[0]:document.documentElement).appendChild(d)}catch(f){c&&c(fa("NETWORK_ERROR"))}},0)}function ub(a,b){this.pd=["session",a.yc,a.Sa].join(":");this.Ic=b}function vb(a){a=a||{};this.Yb=Qa()+Qa()+Qa();this.Rd=a||{}}function Ec(a,b,c,d){ya.call(this,["auth_status"]);this.D=a;this.Cd=b;this.Xe=c;this.jd=d;this.wb=new ub(a,[wa,ja]);this.La=null;pf(this)}function pf(a){ja.get("redirect_request_id")&&qf(a);var b=a.wb.get();b&&b.token?($a(a,b),a.Cd(b.token,
function(c,d){Rd(a,c,d,!1,b.token,b)},function(b,c){Sd(a,"resumeSession()",b,c)})):$a(a,null)}function Fc(a,b,c,d,e,f){"firebaseio-demo.com"===a.D.domain&&$("FirebaseRef.auth() not supported on demo Firebases (*.firebaseio-demo.com). Please use on production Firebases only (*.firebaseio.com).");a.Cd(b,function(f,g){Rd(a,f,g,!0,b,c,d||{},e)},function(b,c){Sd(a,"auth()",b,c,f)})}function Td(a,b){a.wb.clear();$a(a,null);a.Xe(function(a,c){if("ok"===a)W(b);else{var d=(a||"error").toUpperCase(),e=d;c&&
(e+=": "+c);e=Error(e);e.code=d;W(b,e)}})}function Rd(a,b,c,d,e,f,g,h){"ok"===b?(d&&(b=c.auth,f.auth=b,f.expires=c.expires,f.token=Hd(e)?e:"",c=null,b&&G(b,"uid")?c=H(b,"uid"):G(f,"uid")&&(c=H(f,"uid")),f.uid=c,c="custom",b&&G(b,"provider")?c=H(b,"provider"):G(f,"provider")&&(c=H(f,"provider")),f.provider=c,a.wb.clear(),Hd(e)&&(g=g||{},c=wa,"sessionOnly"===g.remember&&(c=ja),"none"!==g.remember&&a.wb.set(f,c)),$a(a,f)),W(h,null,f)):(a.wb.clear(),$a(a,null),f=a=(b||"error").toUpperCase(),c&&(f+=": "+
c),f=Error(f),f.code=a,W(h,f))}function Sd(a,b,c,d,e){$(b+" was canceled: "+d);a.wb.clear();$a(a,null);a=Error(d);a.code=c.toUpperCase();W(e,a)}function Ub(a,b,c,d){Na(a);var e=[Ya,Za];c=Ma(c);Vb(a,e,"/auth/"+b,c,d)}function rf(a,b,c,d){Na(a);var e=[tb,sb];c=Ma(c);"anonymous"===b||"password"===b?setTimeout(function(){W(d,fa("TRANSPORT_UNAVAILABLE"))},0):(c.Lc.window_features="menubar\x3dyes,modal\x3dyes,alwaysRaised\x3dyeslocation\x3dyes,resizable\x3dyes,scrollbars\x3dyes,status\x3dyes,height\x3d625,width\x3d625,top\x3d"+
("object"===typeof screen?0.5*(screen.height-625):0)+",left\x3d"+("object"===typeof screen?0.5*(screen.width-625):0),c.Lc.relay_url=Dc()+"/"+a.D.Sa+"/auth/channel",c.Lc.requestWithCredential=t(a.Zb,a),Vb(a,e,"/auth/"+b,c,d))}function qf(a){var b=ja.get("redirect_request_id");if(b){var c=ja.get("redirect_client_options");ja.remove("redirect_request_id");ja.remove("redirect_client_options");var d=[Ya,Za],b=new Cc(c,{},{requestId:b});Vb(a,d,"/auth/session",b)}}function Vb(a,b,c,d,e){Ud(a,b,c,d,function(b,
c){!b&&c&&c.token&&c.uid?Fc(a,c.token,c,d.hc,function(a,b){a?W(e,a):W(e,null,b)}):W(e,b||fa("UNKNOWN_ERROR"))})}function Ud(a,b,c,d,e){b=Vd(b,function(a){return"function"===typeof a.isAvailable&&a.isAvailable()});0===b.length?setTimeout(function(){W(e,fa("TRANSPORT_UNAVAILABLE"))},0):(b=new (b.shift())(d.Lc),d=Y(d.vb),d.v="js-1.1.0",d.transport=b.Bb(),d.suppress_status_codes=!0,a=Dc()+"/"+a.D.Sa+c,b.open(a,d,function(a,b){if(a)W(e,a);else if(b&&b.error){var c=Error(b.error.message);c.code=b.error.code;
c.details=b.error.details;W(e,c)}else W(e,null,b)}))}function $a(a,b){var c=null!==a.La||null!==b;a.La=b;c&&a.Mc("auth_status",b);a.jd(null!==b)}function Na(a){var b=a.D;if("firebaseio.com"!==b.domain&&"firebaseio-demo.com"!==b.domain&&"auth.firebase.com"===rb)throw Error("This custom Firebase server ('"+a.D.domain+"') does not support delegated login.");}function Wd(){this.hb=[]}function Xd(a,b){if(0!==b.length)for(var c=0;c<b.length;c++)a.hb.push(b[c])}function sf(a){var b=a.ca,c=a.$d,d=a.Ub;Ja(function(){b(c,
d)})}function U(a,b,c,d){this.type=a;this.xa=b;this.da=c;this.Ub=d}function ab(a){this.S=a;this.sa=[];this.Zc=new Wd}function Yd(a,b,c,d,e){a.sa.push({type:b,ca:c,cancel:d,$:e});d=[];var f=Zd(a.j);a.Hb&&f.push(new U("value",a.j));for(var g=0;g<f.length;g++)if(f[g].type===b){var h=new v(a.S.i,a.S.path);f[g].da&&(h=h.J(f[g].da));d.push({ca:qc(c,e),$d:new F(f[g].xa,h),Ub:f[g].Ub})}Xd(a.Zc,d)}function $d(a,b){for(var c=[],d=0;d<b.length;d++){var e=b[d],f=e.type,g=new v(a.S.i,a.S.path);b[d].da&&(g=g.J(b[d].da));
g=new F(b[d].xa,g);"value"!==e.type||g.Gb()?"value"!==e.type&&(f+=" "+g.name()):f+="("+g.X()+")";oa(a.S.i.n.id+": event:"+a.S.path+":"+a.S.Wa()+":"+f);for(f=0;f<a.sa.length;f++){var h=a.sa[f];b[d].type===h.type&&c.push({ca:qc(h.ca,h.$),$d:g,Ub:e.Ub})}}Xd(a.Zc,c)}function Zd(a){var b=[];if(!a.Q()){var c=null;a.B(function(a,d){b.push(new U("child_added",d,a,c));c=a})}return b}function Gc(a){a.Hb||(a.Hb=!0,$d(a,[new U("value",a.j)]))}function Wb(a,b){ab.call(this,a);this.j=b}function tf(a,b){this.jc=
a;this.kd=b}function ae(a,b,c,d,e){var f=a.N(c),g=b.N(c);d=new tf(d,e);e=wb(d,c,f,g);g=!f.f()&&!g.f()&&f.m()!==g.m();if(e||g)for(f=c,c=e;null!==f.parent();){var h=a.N(f);e=b.N(f);var k=f.parent();if(!d.jc||P(d.jc,k).k()){var m=b.N(k),n=[],f=Qc(f);h.f()?(h=m.ha(f,e),n.push(new U("child_added",e,f,h))):e.f()?n.push(new U("child_removed",h,f)):(h=m.ha(f,e),g&&n.push(new U("child_moved",e,f,h)),c&&n.push(new U("child_changed",e,f,h)));d.kd(k,m,n)}g&&(g=!1,c=!0);f=k}}function wb(a,b,c,d){var e,f=[];c===
d?e=!1:c.Q()&&d.Q()?e=c.k()!==d.k():c.Q()?(Hc(a,b,S,d,f),e=!0):d.Q()?(Hc(a,b,c,S,f),e=!0):e=Hc(a,b,c,d,f);e?a.kd(b,d,f):c.m()!==d.m()&&a.kd(b,d,null);return e}function Hc(b,c,d,e,f){var g=!1,h=!b.jc||!P(b.jc,c).f(),k=[],m=[],n=[],p=[],r={},s={},t,u,v,w;t=d.jb();v=gb(t);u=e.jb();for(w=gb(u);null!==v||null!==w;)if(d=w,d=null===v?1:null===d?-1:v.key===d.key?0:Lb({name:v.key,la:v.value.m()},{name:d.key,la:d.value.m()}),0>d?(g=H(r,v.key),a(g)?(n.push({ad:v,zd:k[g]}),k[g]=null):(s[v.key]=m.length,m.push(v)),
g=!0,v=gb(t)):(0<d?(g=H(s,w.key),a(g)?(n.push({ad:m[g],zd:w}),m[g]=null):(r[w.key]=k.length,k.push(w)),g=!0):(d=c.J(w.key),wb(b,d,v.value,w.value)&&(p.push(w),g=!0),v.value.m()!==w.value.m()&&(n.push({ad:v,zd:w}),g=!0),v=gb(t)),w=gb(u)),!h&&g)return!0;for(h=0;h<m.length;h++)if(r=m[h])d=c.J(r.key),wb(b,d,r.value,S),f.push(new U("child_removed",r.value,r.key));for(h=0;h<k.length;h++)if(r=k[h])d=c.J(r.key),m=e.ha(r.key,r.value),wb(b,d,S,r.value),f.push(new U("child_added",r.value,r.key,m));for(h=0;h<
n.length;h++)r=n[h].ad,k=n[h].zd,d=c.J(k.key),m=e.ha(k.key,k.value),f.push(new U("child_moved",k.value,k.key,m)),wb(b,d,r.value,k.value)&&p.push(k);for(h=0;h<p.length;h++)b=p[h],m=e.ha(b.key,b.value),f.push(new U("child_changed",b.value,b.key,m));return g}function Ic(){this.Z=this.Aa=null;this.set={}}function be(a,b,c){a.add(b,c);a.Z||(a.Z=c.S.path)}function uf(a){var b=a.Aa;a.Aa=null;return b}function Oa(a){return a.contains("default")}function xb(a){return null!=a.Aa&&Oa(a)}function yb(a,b){ab.call(this,
a);this.j=S;this.Bc(b,Zd(b))}function ce(a,b,c,d){if(a.Q())return null;var e=null;(d?a.$c:a.B).call(a,function(a,d){if(Xb(b,a,d)&&(e=a,c--,0===c))return!0});return e}function Xb(a,b,c){for(var d=0;d<a.length;d++)if(!a[d](b,c.m()))return!1;return!0}function bb(a,b){this.n=a;this.g=b;this.rc=b.ba;this.pa=new Da}function de(a,b,c,d,e){var f=a.get(b),g;if(g=f){g=!1;for(var h=f.sa.length-1;0<=h;h--){var k=f.sa[h];if(!(c&&k.type!==c||d&&k.ca!==d||e&&k.$!==e)&&(f.sa.splice(h,1),g=!0,c&&d))break}}(c=g&&!(0<
f.sa.length))&&a.remove(b);return c}function vf(a,b,c,d,e){b=b?b.Wa():null;var f=[];b&&"default"!==b?de(a,b,c,d,e)&&f.push(b):Va(a.keys(),function(b){de(a,b,c,d,e)&&f.push(b)});return f}function ee(a,b,c,d,e,f){var g=b.path(),g=P(a.pa,g);c=vf(b,c,d,e,f);b.f()&&ra(g,null);d=fe(g);if(0<c.length&&!d){d=g;e=g.parent();for(c=!1;!c&&e;){if(f=e.k()){L(!xb(f));var h=d.name(),k=!1;ta(f,function(a,b){k=b.ed(h)||k});k&&(c=!0)}d=e;e=e.parent()}d=null;xb(b)||(b=uf(b),d=wf(a,g),b&&b());return c?null:d}return null}
function Yb(a,b,c){eb(P(a.pa,b),function(a){(a=a.k())&&ta(a,function(a,b){Gc(b)})},c,!0)}function pa(a,b,c){function d(a){do{if(g[a.toString()])return!0;a=a.parent()}while(null!==a);return!1}var e=a.rc,f=a.g.ba;a.rc=f;for(var g={},h=0;h<c.length;h++)g[c[h].toString()]=!0;ae(e,f,b,a.pa,function(c,e,f){if(b.contains(c)){var g=d(c);g&&Yb(a,c,!1);a.Ac(c,e,f);g&&Yb(a,c,!0)}else a.Ac(c,e,f)});d(b)&&Yb(a,b,!0);ge(a,b)}function ge(a,b){var c=P(a.pa,b);eb(c,function(a){(a=a.k())&&ta(a,function(a,b){b.Vb()})},
!0,!0);Eb(c,function(a){(a=a.k())&&ta(a,function(a,b){b.Vb()})},!1)}function fe(a){return Eb(a,function(a){return a.k()&&xb(a.k())})}function xf(a,b,c,d,e){if(xb(c)||fe(b))be(c,d,e);else{var f,g;c.f()||(f=c.toString(),g=c.rb());be(c,d,e);c.setActive(Jc(a,c));f&&g&&Kd(a.n,c.path(),f,g)}xb(c)&&eb(b,function(a){if(a=a.k())a.Aa&&a.Aa(),a.Aa=null})}function wf(a,b){function c(b){var e=b.k();if(e&&Oa(e))d.push(e.path()),null==e.Aa&&e.setActive(Jc(a,e));else{if(e){null!=e.Aa||e.setActive(Jc(a,e));var f=
{};ta(e,function(a,b){b.j.B(function(a){G(f,a)||(f[a]=!0,a=e.path().J(a),d.push(a))})})}b.B(c)}}var d=[];c(b);return d}function Jc(a,c){if(a.n){var d=a.n,e=c.path(),f=c.toString(),g=c.rb(),h,k=c.keys(),m=Oa(c);af(a.n,c,function(b){"ok"!==b?(b=He(b),$("on() or once() for "+c.path().toString()+" failed: "+b.toString()),yf(a,c,b)):h||(m?Yb(a,c.path(),!0):Va(k,function(a){(a=c.get(a))&&Gc(a)}),ge(a,c.path()))});return function(){h=!0;Kd(d,e,f,g)}}return b}function yf(a,b,c){b&&(ta(b,function(a,b){for(var d=
0;d<b.sa.length;d++){var e=b.sa[d];e.cancel&&qc(e.cancel,e.$)(c)}}),ee(a,b))}function zf(a,b){return"default"===a.Wa()?new Wb(a,b):new yb(a,b)}function he(a,b,c,d,e){var f=b.path();b=a.Fb(f,b,d,e);var g=S,h=[];xa(b,function(b,gc){var k=new O(gc);3===b||1===b?g=g.K(gc,d.N(k)):(2===b&&h.push({path:f.J(gc),ua:S}),h=h.concat(Kc(a,d.N(k),P(c,k),e)))});return[{path:f,ua:g}].concat(h)}function zb(a,b,c,d){var e;a:{var f=P(a.pa,b);e=f.parent();for(var g=[];null!==e;){var h=e.k();if(null!==h){if(Oa(h)){e=
[{path:b,ua:c}];break a}h=a.Fb(b,h,c,d);f=H(h,f.name());if(3===f||1===f){e=[{path:b,ua:c}];break a}2===f&&g.push({path:b,ua:S})}f=e;e=e.parent()}e=g}if(1==e.length&&(!e[0].ua.f()||c.f()))return e;g=P(a.pa,b);f=g.k();null!==f?Oa(f)?e.push({path:b,ua:c}):e=e.concat(he(a,f,g,c,d)):e=e.concat(Kc(a,c,g,d));return e}function Kc(a,b,c,d){var e=c.k();if(null!==e)return Oa(e)?[{path:c.path(),ua:b}]:he(a,e,c,b,d);var f=[];c.B(function(c){var e=b.Q()?S:b.P(c.name());c=Kc(a,e,c,d);f=f.concat(c)});return f}function Lc(a){this.D=
a;this.ga=sc(a);this.n=new La(this.D,t(this.uc,this),t(this.sc,this),t(this.nd,this),t(this.dd,this));this.be=Pe(a,t(function(){return new sd(this.ga,this.n)},this));this.$a=new Da;this.Ja=new Ua;this.g=new Od;this.L=new bb(this.n,this.g.qa);this.fd=new Ua;this.gd=new bb(null,this.fd);Zb(this,"connected",!1);this.U=new Ta;this.I=new Ec(a,t(this.n.I,this.n),t(this.n.Bd,this.n),t(this.jd,this));this.ic=0}function ie(a){a=Q(a.fd,new O(".info/serverTimeOffset")).X()||0;return(new Date).getTime()+a}function Ab(a){a=
a={timestamp:ie(a)};a.timestamp=a.timestamp||(new Date).getTime();return a}function Zb(a,b,c){b=new O("/.info/"+b);ca(a.fd,b,la(c));pa(a.gd,b,[b])}function Af(a){a.e("onDisconnectEvents");var b=[],c=Ab(a);Ac(jf(a.U,c),new O(""),function(c,d){var e=zb(a.L,c,d,a.g.O);b.push.apply(b,a.g.set(c,e));e=Mc(a,c);Aa(a,e);pa(a.L,e,[c])});Rb(a.g,b);a.U=new Ta}function je(a,b,c,d){var e=la(c);Ld(a.n,b.toString(),e.X(!0),function(c,f){"ok"===c&&a.U.sb(b,e);Ba(d,c,f)})}function Bf(a,b,c,d,e){var f=la(c,d);Ld(a.n,
b.toString(),f.X(!0),function(c,d){"ok"===c&&a.U.sb(b,f);Ba(e,c,d)})}function Cf(a,b,c,d){var e=!0,f;for(f in c)e=!1;e?(oa("onDisconnect().update() called with empty data.  Don't do anything."),Ba(d,"ok")):cf(a.n,b.toString(),c,function(e,f){if("ok"===e)for(var g in c){var h=la(c[g]);a.U.sb(b.J(g),h)}Ba(d,e,f)})}function ke(a){Sa(a.ga,"deprecated_on_disconnect");a.be.yd.deprecated_on_disconnect=!0}function Ba(a,b,c){a&&Ja(function(){if("ok"==b)a(null,c);else{var d=(b||"error").toUpperCase(),e=d;c&&
(e+=": "+c);e=Error(e);e.code=d;a(e)}})}function Df(b,c,d,e,f){function g(){}b.e("transaction on "+c);var h=new v(b,c);h.Ta("value",g);d={path:c,update:d,G:e,status:null,Sd:Pb(),Rc:f,Xd:0,Oc:function(){h.nb("value",g)},Pc:null};b.Ja.ba=le(b,b.Ja.ba,b.g.O.ba,b.$a);e=d.update(Q(b.Ja,c).X());if(a(e)){Z("transaction failed: Data returned ",e);d.status=1;f=P(b.$a,c);var k=f.k()||[];k.push(d);ra(f,k);k="object"===typeof e&&null!==e&&G(e,".priority")?e[".priority"]:Q(b.g.O,c).m();f=Ab(b);e=la(e,k);e=qb(e,
f);ca(b.Ja,c,e);d.Rc&&(ca(b.g.qa,c,e),pa(b.L,c,[c]));$b(b)}else d.Oc(),d.G&&(b=me(b,c),d.G(null,!1,b))}function $b(a,b){var c=b||a.$a;b||ac(a,c);if(null!==c.k()){var d=ne(a,c);L(0<d.length);Ef(d,function(a){return 1===a.status})&&Ff(a,c.path(),d)}else c.Gb()&&c.B(function(b){$b(a,b)})}function Ff(a,b,c){for(var d=0;d<c.length;d++)L(1===c[d].status,"tryToSendTransactionQueue_: items in queue should all be run."),c[d].status=2,c[d].Xd++;var e=Q(a.g.O,b).hash();ca(a.g.O,b,Q(a.g.qa,b));for(var f=Q(a.Ja,
b).X(!0),g=Pb(),h=Gf(c),d=0;d<h.length;d++)ra(P(a.g.Sb,h[d]),g);a.n.put(b.toString(),f,function(e){a.e("transaction put response",{path:b.toString(),status:e});for(d=0;d<h.length;d++){var f=P(a.g.Sb,h[d]),k=f.k();L(null!==k,"sendTransactionQueue_: pendingPut should not be null.");k===g&&(ra(f,null),ca(a.g.O,h[d],Q(a.g.wa,h[d])))}if("ok"===e){e=[];for(d=0;d<c.length;d++)c[d].status=3,c[d].G&&(f=me(a,c[d].path),e.push(t(c[d].G,null,null,!0,f))),c[d].Oc();ac(a,P(a.$a,b));$b(a);for(d=0;d<e.length;d++)Ja(e[d])}else{if("datastale"===
e)for(d=0;d<c.length;d++)c[d].status=4===c[d].status?5:1;else for($("transaction at "+b+" failed: "+e),d=0;d<c.length;d++)c[d].status=5,c[d].Pc=e;e=Aa(a,b);pa(a.L,e,[b])}},e)}function Gf(a){for(var b={},c=0;c<a.length;c++)a[c].Rc&&(b[a[c].path.toString()]=a[c].path);a=[];for(var d in b)a.push(b[d]);return a}function Aa(b,c){var d=oe(b,c),e=d.path(),d=ne(b,d);ca(b.g.qa,e,Q(b.g.O,e));ca(b.Ja,e,Q(b.g.O,e));if(0!==d.length){for(var f=Q(b.g.qa,e),g=f,h=[],k=0;k<d.length;k++){var m=Rc(e,d[k].path),n=!1,
p;L(null!==m,"rerunTransactionsUnderNode_: relativePath should not be null.");if(5===d[k].status)n=!0,p=d[k].Pc;else if(1===d[k].status)if(25<=d[k].Xd)n=!0,p="maxretry";else{var r=f.N(m),s=d[k].update(r.X());if(a(s)){Z("transaction failed: Data returned ",s);var u=la(s);"object"===typeof s&&null!=s&&G(s,".priority")||(u=u.Ka(r.m()));f=f.Ba(m,u);d[k].Rc&&(g=g.Ba(m,u))}else n=!0,p="nodata"}n&&(d[k].status=3,setTimeout(d[k].Oc,Math.floor(0)),d[k].G&&(n=new v(b,d[k].path),m=new F(f.N(m),n),"nodata"===
p?h.push(t(d[k].G,null,null,!1,m)):h.push(t(d[k].G,null,Error(p),!1,m))))}ca(b.Ja,e,f);ca(b.g.qa,e,g);ac(b,b.$a);for(k=0;k<h.length;k++)Ja(h[k]);$b(b)}return e}function oe(a,b){for(var c,d=a.$a;null!==(c=ea(b))&&null===d.k();)d=P(d,c),b=ua(b);return d}function ne(a,b){var c=[];pe(a,b,c);c.sort(function(a,b){return a.Sd-b.Sd});return c}function pe(a,b,c){var d=b.k();if(null!==d)for(var e=0;e<d.length;e++)c.push(d[e]);b.B(function(b){pe(a,b,c)})}function ac(a,b){var c=b.k();if(c){for(var d=0,e=0;e<
c.length;e++)3!==c[e].status&&(c[d]=c[e],d++);c.length=d;ra(b,0<c.length?c:null)}b.B(function(b){ac(a,b)})}function Mc(a,b){var c=oe(a,b).path(),d=P(a.$a,b);Eb(d,function(a){Nc(a)});Nc(d);eb(d,function(a){Nc(a)});return c}function Nc(a){var b=a.k();if(null!==b){for(var c=[],d=-1,e=0;e<b.length;e++)4!==b[e].status&&(2===b[e].status?(L(d===e-1,"All SENT items should be at beginning of queue."),d=e,b[e].status=4,b[e].Pc="set"):(L(1===b[e].status),b[e].Oc(),b[e].G&&c.push(t(b[e].G,null,Error("set"),!1,
null))));-1===d?ra(a,null):b.length=d+1;for(e=0;e<c.length;e++)Ja(c[e])}}function me(a,b){var c=new v(a,b);return new F(Q(a.Ja,b),c)}function le(a,b,c,d){if(d.f())return c;if(null!=d.k())return b;var e=c;d.B(function(d){var f=d.name(),g=new O(f);d=le(a,b.N(g),c.N(g),d);e=e.K(f,d)});return e}function ga(){this.tb={}}function bc(a){var b=this;this.Ab=a;this.Jc="*";Tb()?this.Lb=this.lc=nf():(this.Lb=window.opener,this.lc=window);if(!b.Lb)throw"Unable to find relay frame";Ca(this.lc,"message",t(this.ob,
this));Ca(this.lc,"message",t(this.Pd,this));try{dc(this,{a:"ready"})}catch(c){Ca(this.Lb,"load",function(){dc(b,{a:"ready"})})}Ca(window,"unload",t(this.Ie,this))}function dc(a,b){b=D(b);Tb()?a.Lb.doPost(b,a.Jc):a.Lb.postMessage(b,a.Jc)}function aa(a,b,c){this.Wb=a;this.Z=b;this.Ha=c}function v(a,b){var c,d,e;if(a instanceof Lc)c=a,d=b;else{y("new Firebase",1,2,arguments.length);d=Kb(arguments[0]);c=d.Ve;"firebase"===d.domain&&gd(d.host+" is no longer supported. Please use \x3cYOUR FIREBASE\x3e.firebaseio.com instead");
c||gd("Cannot parse Firebase url. Please use https://\x3cYOUR FIREBASE\x3e.firebaseio.com");d.Ya||"undefined"!==typeof window&&window.location&&window.location.protocol&&-1!==window.location.protocol.indexOf("https:")&&$("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().");c=new lc(d.host,d.Ya,c,"ws"===d.scheme||"wss"===d.scheme);d=new O(d.pb);e=d.toString();var f;!(f=!g(c.host)||0===c.host.length||!R(c.Sa))&&(f=0!==e.length)&&(e&&(e=e.replace(/^\/*\.info(\/|$)/,
"/")),f=!(g(e)&&0!==e.length&&!Sc.test(e)));if(f)throw Error(C("new Firebase",1,!1)+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".');if(b)if(b instanceof ga)e=b;else if(g(b))e=ga.ib(),c.yc=b;else throw Error("Expected a valid Firebase.Context for second argument to new Firebase()");else e=ga.ib();f=c.toString();var h=H(e.tb,f);h||(h=new Lc(c),e.tb[f]=h);c=h}K.call(this,c,d)}function fd(a,b){L(!b||!0===a||!1===a,"Can't turn on custom loggers persistently.");!0===
a?("undefined"!==typeof console&&("function"===typeof console.log?Ga=t(console.log,console):"object"===typeof console.log&&(Ga=function(a){console.log(a)})),b&&ja.set("logging_enabled",!0)):a?Ga=a:(Ga=null,ja.remove("logging_enabled"))}var s,cb=this,Ce=Date.now||function(){return+new Date},hc={'"':'\\"',"\\":"\\\\","/":"\\/","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\u000b"},we=/\uffff/.test("\uffff")?/[\\\"\x00-\x1f\x7f-\uffff]/g:/[\\\"\x00-\x1f\x7f-\xff]/g,ze={},xe={},ye=/[\[\].#$\/\u0000-\u001F\u007F]/,
Sc=/[\[\].#$\u0000-\u001F\u007F]/;K.prototype.rd=function(){y("Query.ref",0,0,arguments.length);return new v(this.i,this.path)};K.prototype.ref=K.prototype.rd;K.prototype.Ta=function(a,b){y("Query.on",2,4,arguments.length);ba("Query.on",a,!1);z("Query.on",2,b,!1);var c=Pc("Query.on",arguments[2],arguments[3]);this.i.ec(this,a,b,c.cancel,c.$);return b};K.prototype.on=K.prototype.Ta;K.prototype.nb=function(a,b,c){y("Query.off",0,3,arguments.length);ba("Query.off",a,!0);z("Query.off",2,b,!0);I("Query.off",
3,c);this.i.Dc(this,a,b,c)};K.prototype.off=K.prototype.nb;K.prototype.Ke=function(a,b){function c(g){f&&(f=!1,e.nb(a,c),b.call(d.$,g))}y("Query.once",2,4,arguments.length);ba("Query.once",a,!1);z("Query.once",2,b,!1);var d=Pc("Query.once",arguments[2],arguments[3]),e=this,f=!0;this.Ta(a,c,function(b){e.nb(a,c);d.cancel&&d.cancel.call(d.$,b)})};K.prototype.once=K.prototype.Ke;K.prototype.ze=function(a){y("Query.limit",1,1,arguments.length);if(!h(a)||Math.floor(a)!==a||0>=a)throw"Query.limit: First argument must be a positive integer.";
return new K(this.i,this.path,a,this.fa,this.za,this.Ea,this.fb)};K.prototype.limit=K.prototype.ze;K.prototype.ae=function(b,c){y("Query.startAt",0,2,arguments.length);V("Query.startAt",1,b,!0);ha("Query.startAt",c);a(b)||(c=b=null);return new K(this.i,this.path,this.Ga,b,c,this.Ea,this.fb)};K.prototype.startAt=K.prototype.ae;K.prototype.Hd=function(a,b){y("Query.endAt",0,2,arguments.length);V("Query.endAt",1,a,!0);ha("Query.endAt",b);return new K(this.i,this.path,this.Ga,this.fa,this.za,a,b)};K.prototype.endAt=
K.prototype.Hd;K.prototype.se=function(a,b){y("Query.equalTo",1,2,arguments.length);V("Query.equalTo",1,a,!1);ha("Query.equalTo",b);return this.ae(a,b).Hd(a,b)};K.prototype.equalTo=K.prototype.se;K.prototype.Wa=function(){var a=oc(fc(this));return"{}"===a?"default":a};s=O.prototype;s.toString=function(){for(var a="",b=this.W;b<this.u.length;b++)""!==this.u[b]&&(a+="/"+this.u[b]);return a||"/"};s.parent=function(){if(this.W>=this.u.length)return null;for(var a=[],b=this.W;b<this.u.length-1;b++)a.push(this.u[b]);
return new O(a,0)};s.J=function(a){for(var b=[],c=this.W;c<this.u.length;c++)b.push(this.u[c]);if(a instanceof O)for(c=a.W;c<a.u.length;c++)b.push(a.u[c]);else for(a=a.split("/"),c=0;c<a.length;c++)0<a[c].length&&b.push(a[c]);return new O(b,0)};s.f=function(){return this.W>=this.u.length};s.length=function(){return this.u.length-this.W};s.contains=function(a){var b=this.W,c=a.W;if(this.length()>a.length())return!1;for(;b<this.u.length;){if(this.u[b]!==a.u[c])return!1;++b;++c}return!0};s=Da.prototype;
s.k=function(){return this.A.value};s.clear=function(){this.A.value=null;this.A.children={};this.A.gc=0;Db(this)};s.Gb=function(){return 0<this.A.gc};s.f=function(){return null===this.k()&&!this.Gb()};s.B=function(a){for(var b in this.A.children)a(new Da(b,this,this.A.children[b]))};s.path=function(){return new O(null===this.Rb?this.Ha:this.Rb.path()+"/"+this.Ha)};s.name=function(){return this.Ha};s.parent=function(){return this.Rb};s=Ea.prototype;s.ta=function(a,b){return new Ea(this.ab,this.ea.ta(a,
b,this.ab).M(null,null,!1,null,null))};s.remove=function(a){return new Ea(this.ab,this.ea.remove(a,this.ab).M(null,null,!1,null,null))};s.get=function(a){for(var b,c=this.ea;!c.f();){b=this.ab(a,c.key);if(0===b)return c.value;0>b?c=c.left:0<b&&(c=c.right)}return null};s.f=function(){return this.ea.f()};s.count=function(){return this.ea.count()};s.Mb=function(){return this.ea.Mb()};s.lb=function(){return this.ea.lb()};s.Fa=function(a){return this.ea.Fa(a)};s.Xa=function(a){return this.ea.Xa(a)};s.jb=
function(a){return new Be(this.ea,a)};s=Pa.prototype;s.M=function(a,b,c,d,e){return new Pa(null!=a?a:this.key,null!=b?b:this.value,null!=c?c:this.color,null!=d?d:this.left,null!=e?e:this.right)};s.count=function(){return this.left.count()+1+this.right.count()};s.f=function(){return!1};s.Fa=function(a){return this.left.Fa(a)||a(this.key,this.value)||this.right.Fa(a)};s.Xa=function(a){return this.right.Xa(a)||a(this.key,this.value)||this.left.Xa(a)};s.Mb=function(){return jc(this).key};s.lb=function(){return this.right.f()?
this.key:this.right.lb()};s.ta=function(a,b,c){var d,e;e=this;d=c(a,e.key);e=0>d?e.M(null,null,null,e.left.ta(a,b,c),null):0===d?e.M(null,b,null,null,null):e.M(null,null,null,null,e.right.ta(a,b,c));return kc(e)};s.remove=function(a,b){var c,d;c=this;if(0>b(a,c.key))c.left.f()||c.left.R()||c.left.left.R()||(c=Wc(c)),c=c.M(null,null,null,c.left.remove(a,b),null);else{c.left.R()&&(c=Fb(c));c.right.f()||c.right.R()||c.right.left.R()||(c=hb(c),c.left.left.R()&&(c=Fb(c),c=hb(c)));if(0===b(a,c.key)){if(c.right.f())return fb;
d=jc(c.right);c=c.M(d.key,d.value,null,null,Vc(c.right))}c=c.M(null,null,null,null,c.right.remove(a,b))}return kc(c)};s.R=function(){return this.color};s=Yc.prototype;s.M=function(){return this};s.ta=function(a,b){return new Pa(a,b,null)};s.remove=function(){return this};s.count=function(){return 0};s.f=function(){return!0};s.Fa=function(){return!1};s.Xa=function(){return!1};s.Mb=function(){return null};s.lb=function(){return null};s.R=function(){return!1};var fb=new Yc;s=Zc.prototype;s.set=function(a,
b){null==b?this.Db.removeItem(this.zc+a):this.Db.setItem(this.zc+a,D(b))};s.get=function(a){a=this.Db.getItem(this.zc+a);return null==a?null:B(a)};s.remove=function(a){this.Db.removeItem(this.zc+a)};s.Nd=!1;s.toString=function(){return this.Db.toString()};ib.prototype.set=function(a,b){null==b?delete this.zb[a]:this.zb[a]=b};ib.prototype.get=function(a){return G(this.zb,a)?this.zb[a]:null};ib.prototype.remove=function(a){delete this.zb[a]};ib.prototype.Nd=!0;var wa=$c("localStorage"),ja=$c("sessionStorage");
lc.prototype.toString=function(){var a=(this.Ya?"https://":"http://")+this.host;this.yc&&(a+="\x3c"+this.yc+"\x3e");return a};x(Gb,function(){this.ra=-1});Gb.prototype.reset=function(){this.F[0]=1732584193;this.F[1]=4023233417;this.F[2]=2562383102;this.F[3]=271733878;this.F[4]=3285377520;this.Kc=this.kb=0};Gb.prototype.update=function(b,c){a(c)||(c=b.length);for(var d=c-this.ra,e=0,f=this.Sc,h=this.kb;e<c;){if(0==h)for(;e<=d;)Hb(this,b,e),e+=this.ra;if(g(b))for(;e<c;){if(f[h]=b.charCodeAt(e),++h,
++e,h==this.ra){Hb(this,f);h=0;break}}else for(;e<c;)if(f[h]=b[e],++h,++e,h==this.ra){Hb(this,f);h=0;break}}this.kb=h;this.Kc+=c};var ma=Array.prototype,kf=ma.indexOf?function(a,b,c){return ma.indexOf.call(a,b,c)}:function(a,b,c){c=null==c?0:0>c?Math.max(0,a.length+c):c;if(g(a))return g(b)&&1==b.length?a.indexOf(b,c):-1;for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},Va=ma.forEach?function(a,b,c){ma.forEach.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=g(a)?a.split(""):a,f=0;f<d;f++)f in
e&&b.call(c,e[f],f,a)},Vd=ma.filter?function(a,b,c){return ma.filter.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=[],f=0,h=g(a)?a.split(""):a,k=0;k<d;k++)if(k in h){var m=h[k];b.call(c,m,k,a)&&(e[f++]=m)}return e},ob=ma.map?function(a,b,c){return ma.map.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=Array(d),f=g(a)?a.split(""):a,h=0;h<d;h++)h in f&&(e[h]=b.call(c,f[h],h,a));return e},Hf=ma.reduce?function(a,b,c,d){d&&(b=t(b,d));return ma.reduce.call(a,b,c)}:function(a,b,c,d){var e=c;Va(a,
function(c,f){e=b.call(d,e,c,f,a)});return e},Ef=ma.every?function(a,b,c){return ma.every.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=g(a)?a.split(""):a,f=0;f<d;f++)if(f in e&&!b.call(c,e[f],f,a))return!1;return!0},Ra;a:{var qe=cb.navigator;if(qe){var re=qe.userAgent;if(re){Ra=re;break a}}Ra=""}var If=Fa("Opera")||Fa("OPR"),se=Fa("Trident")||Fa("MSIE"),Jf=Fa("Gecko")&&-1==Ra.toLowerCase().indexOf("webkit")&&!(Fa("Trident")||Fa("MSIE")),Kf=-1!=Ra.toLowerCase().indexOf("webkit");(function(){var a=
"",b;if(If&&cb.opera)return a=cb.opera.version,k(a)?a():a;Jf?b=/rv\:([^\);]+)(\)|;)/:se?b=/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/:Kf&&(b=/WebKit\/(\S+)/);b&&(a=(a=b.exec(Ra))?a[1]:"");return se&&(b=(b=cb.document)?b.documentMode:void 0,b>parseFloat(a))?String(b):a})();var Ib=null,mc=null,Pb=function(){var a=1;return function(){return a++}}(),Ga=null,ed=!0,Ie=/^-?\d{1,10}$/;s=Ka.prototype;s.Q=function(){return!0};s.m=function(){return this.qb};s.Ka=function(a){return new Ka(this.H,a)};s.P=function(){return S};
s.N=function(a){return null===ea(a)?this:S};s.ha=function(){return null};s.K=function(a,b){return(new ka).K(a,b).Ka(this.qb)};s.Ba=function(a,b){var c=ea(a);return null===c?b:this.K(c,S.Ba(ua(a),b))};s.f=function(){return!1};s.qc=function(){return 0};s.X=function(a){return a&&null!==this.m()?{".value":this.k(),".priority":this.m()}:this.k()};s.hash=function(){var a="";null!==this.m()&&(a+="priority:"+md(this.m())+":");var b=typeof this.H,a=a+(b+":"),a="number"===b?a+jd(this.H):a+this.H;return dd(a)};
s.k=function(){return this.H};s.toString=function(){return"string"===typeof this.H?this.H:'"'+this.H+'"'};s=ka.prototype;s.Q=function(){return!1};s.m=function(){return this.qb};s.Ka=function(a){return new ka(this.o,a)};s.K=function(a,b){var c=this.o.remove(a);b&&b.f()&&(b=null);null!==b&&(c=c.ta(a,b));return b&&null!==b.m()?new lb(c,null,this.qb):new ka(c,this.qb)};s.Ba=function(a,b){var c=ea(a);if(null===c)return b;var d=this.P(c).Ba(ua(a),b);return this.K(c,d)};s.f=function(){return this.o.f()};
s.qc=function(){return this.o.count()};var Lf=/^(0|[1-9]\d*)$/;s=ka.prototype;s.X=function(a){if(this.f())return null;var b={},c=0,d=0,e=!0;this.B(function(f,g){b[f]=g.X(a);c++;e&&Lf.test(f)?d=Math.max(d,Number(f)):e=!1});if(!a&&e&&d<2*c){var f=[],g;for(g in b)f[g]=b[g];return f}a&&null!==this.m()&&(b[".priority"]=this.m());return b};s.hash=function(){var a="";null!==this.m()&&(a+="priority:"+md(this.m())+":");this.B(function(b,c){var d=c.hash();""!==d&&(a+=":"+b+":"+d)});return""===a?"":dd(a)};s.P=
function(a){a=this.o.get(a);return null===a?S:a};s.N=function(a){var b=ea(a);return null===b?this:this.P(b).N(ua(a))};s.ha=function(a){return Uc(this.o,a)};s.Jd=function(){return this.o.Mb()};s.Kd=function(){return this.o.lb()};s.B=function(a){return this.o.Fa(a)};s.$c=function(a){return this.o.Xa(a)};s.jb=function(){return this.o.jb()};s.toString=function(){var a="{",b=!0;this.B(function(c,d){b?b=!1:a+=", ";a+='"'+c+'" : '+d.toString()});return a+="}"};var S=new ka;x(lb,ka);s=lb.prototype;s.K=function(a,
b){var c=this.P(a),d=this.o,e=this.ya;null!==c&&(d=d.remove(a),e=e.remove({name:a,la:c.m()}));b&&b.f()&&(b=null);null!==b&&(d=d.ta(a,b),e=e.ta({name:a,la:b.m()},b));return new lb(d,e,this.m())};s.ha=function(a,b){var c=Uc(this.ya,{name:a,la:b.m()});return c?c.name:null};s.B=function(a){return this.ya.Fa(function(b,c){return a(b.name,c)})};s.$c=function(a){return this.ya.Xa(function(b,c){return a(b.name,c)})};s.jb=function(){return this.ya.jb(function(a,b){return{key:a.name,value:b}})};s.Jd=function(){return this.ya.f()?
null:this.ya.Mb().name};s.Kd=function(){return this.ya.f()?null:this.ya.lb().name};var Le=Math.log(2);F.prototype.X=function(){y("Firebase.DataSnapshot.val",0,0,arguments.length);return this.A.X()};F.prototype.val=F.prototype.X;F.prototype.te=function(){y("Firebase.DataSnapshot.exportVal",0,0,arguments.length);return this.A.X(!0)};F.prototype.exportVal=F.prototype.te;F.prototype.J=function(a){y("Firebase.DataSnapshot.child",0,1,arguments.length);h(a)&&(a=String(a));Bb("Firebase.DataSnapshot.child",
a);var b=new O(a),c=this.Cc.J(b);return new F(this.A.N(b),c)};F.prototype.child=F.prototype.J;F.prototype.ed=function(a){y("Firebase.DataSnapshot.hasChild",1,1,arguments.length);Bb("Firebase.DataSnapshot.hasChild",a);var b=new O(a);return!this.A.N(b).f()};F.prototype.hasChild=F.prototype.ed;F.prototype.m=function(){y("Firebase.DataSnapshot.getPriority",0,0,arguments.length);return this.A.m()};F.prototype.getPriority=F.prototype.m;F.prototype.forEach=function(a){y("Firebase.DataSnapshot.forEach",1,
1,arguments.length);z("Firebase.DataSnapshot.forEach",1,a,!1);if(this.A.Q())return!1;var b=this;return this.A.B(function(c,d){return a(new F(d,b.Cc.J(c)))})};F.prototype.forEach=F.prototype.forEach;F.prototype.Gb=function(){y("Firebase.DataSnapshot.hasChildren",0,0,arguments.length);return this.A.Q()?!1:!this.A.f()};F.prototype.hasChildren=F.prototype.Gb;F.prototype.name=function(){y("Firebase.DataSnapshot.name",0,0,arguments.length);return this.Cc.name()};F.prototype.name=F.prototype.name;F.prototype.qc=
function(){y("Firebase.DataSnapshot.numChildren",0,0,arguments.length);return this.A.qc()};F.prototype.numChildren=F.prototype.qc;F.prototype.rd=function(){y("Firebase.DataSnapshot.ref",0,0,arguments.length);return this.Cc};F.prototype.ref=F.prototype.rd;ya.prototype.Mc=function(a,b){for(var c=this.Kb[a]||[],d=0;d<c.length;d++)c[d].ca.apply(c[d].$,Array.prototype.slice.call(arguments,1))};ya.prototype.Ta=function(a,b,c){nd(this,a);this.Kb[a]=this.Kb[a]||[];this.Kb[a].push({ca:b,$:c});(a=this.cd(a))&&
b.apply(c,a)};ya.prototype.nb=function(a,b,c){nd(this,a);a=this.Kb[a]||[];for(var d=0;d<a.length;d++)if(a[d].ca===b&&(!c||c===a[d].$)){a.splice(d,1);break}};x(Mb,ya);c(Mb);Mb.prototype.cd=function(a){L("visible"===a,"Unknown event type: "+a);return[this.yb]};x(Nb,ya);c(Nb);Nb.prototype.cd=function(a){L("online"===a,"Unknown event type: "+a);return[this.Pb]};var qd="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");rd.prototype.get=function(){return pd(this.Cb)};
rc.prototype.get=function(){var a=this.qe.get(),b=pd(a);if(this.mc)for(var c in this.mc)b[c]-=this.mc[c];this.mc=a;return b};sd.prototype.Ud=function(){var a=this.Hc.get(),b={},c=!1,d;for(d in a)0<a[d]&&G(this.yd,d)&&(b[d]=a[d],c=!0);c&&(a=this.n,a.T&&(b={c:b},a.e("reportStats",b),a.Ia("s",b)));setTimeout(t(this.Ud,this),Math.floor(6E5*Math.random()))};var tc={},uc={},ec=null;"undefined"!==typeof MozWebSocket?ec=MozWebSocket:"undefined"!==typeof WebSocket&&(ec=WebSocket);var te;sa.prototype.open=
function(a,b){this.ka=b;this.Ge=a;this.e("Websocket connecting to "+this.Ca);this.Y=new ec(this.Ca);this.Eb=!1;wa.set("previous_websocket_failure",!0);var c=this;this.Y.onopen=function(){c.e("Websocket connected.");c.Eb=!0};this.Y.onclose=function(){c.e("Websocket connection was disconnected.");c.Y=null;c.Va()};this.Y.onmessage=function(a){if(null!==c.Y)if(a=a.data,c.Ma+=a.length,Sa(c.ga,"bytes_received",a.length),vc(c),null!==c.frames)td(c,a);else{a:{L(null===c.frames,"We already have a frame buffer");
if(6>=a.length){var b=Number(a);if(!isNaN(b)){c.Ad=b;c.frames=[];a=null;break a}}c.Ad=1;c.frames=[]}null!==a&&td(c,a)}};this.Y.onerror=function(a){c.e("WebSocket error.  Closing connection.");(a=a.message||a.data)&&c.e(a);c.Va()}};sa.prototype.start=function(){};sa.isAvailable=function(){var a=!1;if("undefined"!==typeof navigator&&navigator.userAgent){var b=navigator.userAgent.match(/Android ([0-9]{0,}\.[0-9]{0,})/);b&&1<b.length&&4.4>parseFloat(b[1])&&(a=!0)}return!a&&null!==ec&&!te};sa.responsesRequiredToBeHealthy=
2;sa.healthyTimeout=3E4;s=sa.prototype;s.nc=function(){wa.remove("previous_websocket_failure")};s.send=function(a){vc(this);a=D(a);this.Na+=a.length;Sa(this.ga,"bytes_sent",a.length);a=id(a,16384);1<a.length&&this.Y.send(String(a.length));for(var b=0;b<a.length;b++)this.Y.send(a[b])};s.ac=function(){this.Qa=!0;this.Ib&&(clearInterval(this.Ib),this.Ib=null);this.Y&&(this.Y.close(),this.Y=null)};s.Va=function(){this.Qa||(this.e("WebSocket is closing itself"),this.ac(),this.ka&&(this.ka(this.Eb),this.ka=
null))};s.close=function(){this.Qa||(this.e("WebSocket is being closed"),this.ac())};s=Ob.prototype;s.add=function(a,b){this.set[a]=null!==b?b:!0};s.contains=function(a){return G(this.set,a)};s.get=function(a){return this.contains(a)?this.set[a]:void 0};s.remove=function(a){delete this.set[a]};s.clear=function(){this.set={}};s.f=function(){return od(this.set)};s.count=function(){var a=this.set,b=0,c;for(c in a)b++;return b};s.keys=function(){var a=[];xa(this.set,function(b,c){a.push(c)});return a};
var ue,ve;mb.prototype.open=function(a,b){this.Ed=0;this.U=b;this.Od=new Qe(a);this.Qa=!1;var c=this;this.Oa=setTimeout(function(){c.e("Timed out trying to connect.");c.Va();c.Oa=null},Math.floor(3E4));Ge(function(){if(!c.Qa){c.na=new vd(function(a,b,d,e,f){ud(c,arguments);if(c.na)if(c.Oa&&(clearTimeout(c.Oa),c.Oa=null),c.Eb=!0,"start"==a)c.id=b,c.Td=d;else if("close"===a)b?(c.na.Fc=!1,Re(c.Od,b,function(){c.Va()})):c.Va();else throw Error("Unrecognized command received: "+a);},function(a,b){ud(c,
arguments);Se(c.Od,a,b)},function(){c.Va()},c.dc);var a={start:"t"};a.ser=Math.floor(1E8*Math.random());c.na.Nc&&(a.cb=c.na.Nc);a.v="5";c.Gc&&(a.s=c.Gc);"undefined"!==typeof location&&location.href&&-1!==location.href.indexOf("firebaseio.com")&&(a.r="f");a=c.dc(a);c.e("Connecting via long-poll to "+a);wd(c.na,a,function(){})}})};mb.prototype.start=function(){var a=this.na,b=this.Td;a.Be=this.id;a.Ce=b;for(a.Qc=!0;wc(a););a=this.id;b=this.Td;this.mb=document.createElement("iframe");var c={dframe:"t"};
c.id=a;c.pw=b;this.mb.src=this.dc(c);this.mb.style.display="none";document.body.appendChild(this.mb)};mb.isAvailable=function(){return!ve&&!("object"===typeof window&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))&&!("object"===typeof Windows&&"object"===typeof Windows.Ze)&&(ue||!0)};s=mb.prototype;s.nc=function(){};s.ac=function(){this.Qa=!0;this.na&&(this.na.close(),this.na=null);this.mb&&(document.body.removeChild(this.mb),this.mb=null);this.Oa&&(clearTimeout(this.Oa),
this.Oa=null)};s.Va=function(){this.Qa||(this.e("Longpoll is closing itself"),this.ac(),this.U&&(this.U(this.Eb),this.U=null))};s.close=function(){this.Qa||(this.e("Longpoll is being closed."),this.ac())};s.send=function(a){a=D(a);this.Na+=a.length;Sa(this.ga,"bytes_sent",a.length);a=N(a);a=bd(a,!0);a=id(a,1840);for(var b=0;b<a.length;b++){var c=this.na;c.Tb.push({Pe:this.Ed,We:a.length,Gd:a[b]});c.Qc&&wc(c);this.Ed++}};vd.prototype.close=function(){this.Qc=!1;if(this.aa){this.aa.Da.body.innerHTML=
"";var a=this;setTimeout(function(){null!==a.aa&&(document.body.removeChild(a.aa),a.aa=null)},Math.floor(0))}var b=this.ka;b&&(this.ka=null,b())};var We=[mb,sa];za.prototype.Zd=function(a){Fd(this,{t:"d",d:a})};za.prototype.tc=function(a){Cd(this);this.ob(a)};za.prototype.close=function(){2!==this.oa&&(this.e("Closing realtime connection."),this.oa=2,Bd(this),this.U&&(this.U(),this.U=null))};var $e=0,ff=0;s=La.prototype;s.Ia=function(a,b,c){var d=++this.Oe;a={r:d,a:a,b:b};this.e(D(a));L(this.T,"sendRequest_ call when we're not connected not allowed.");
this.ma.Zd(a);c&&(this.Xb[d]=c)};s.I=function(a,b,c){this.bb={re:a,Id:!1,ca:b,fc:c};this.e("Authenticating using credential: "+a);Jd(this);(b=40==a.length)||(a=xc(a).Uc,b="object"===typeof a&&!0===H(a,"admin"));b&&(this.e("Admin auth credential detected.  Reducing max reconnect time."),this.oc=3E4)};s.Bd=function(a){delete this.bb;this.T&&this.Ia("unauth",{},function(b){a(b.s,b.d)})};s.ld=function(a,b){this.T?Qb(this,"oc",a,null,b):this.Nb.push({pb:a,action:"oc",data:null,G:b})};s.put=function(a,
b,c,d){Md(this,"p",a,b,c,d)};s.tc=function(a){if("r"in a){this.e("from server: "+D(a));var b=a.r,c=this.Xb[b];c&&(delete this.Xb[b],c(a.b))}else{if("error"in a)throw"A server-side error has occurred: "+a.error;"a"in a&&(b=a.a,c=a.b,this.e("handleServerMessage",b,c),"d"===b?this.uc(c.p,c.d,!1):"m"===b?this.uc(c.p,c.d,!0):"c"===b?gf(this,c.p,c.q):"ac"===b?(a=c.s,b=c.d,c=this.bb,delete this.bb,c&&c.fc&&c.fc(a,b)):"sd"===b?this.ud?this.ud(c):"msg"in c&&"undefined"!==typeof console&&console.log("FIREBASE: "+
c.msg.replace("\n","\nFIREBASE: ")):nc("Unrecognized action received from server: "+D(b)+"\nAre you using the latest client?"))}};s.Ob=function(a){this.e("connection ready");this.T=!0;this.Jb=(new Date).getTime();this.nd({serverTimeOffset:a-(new Date).getTime()});Jd(this);for(var b in this.ja)for(var c in this.ja[b])a=this.ja[b][c],Id(this,b,c,a.rb,a.G);for(b=0;b<this.V.length;b++)this.V[b]&&Nd(this,b);for(;this.Nb.length;)b=this.Nb.shift(),Qb(this,b.action,b.pb,b.data,b.G);this.sc(!0)};s.Je=function(a){a&&
!this.yb&&this.va===this.oc&&(this.e("Window became visible.  Reducing delay."),this.va=1E3,this.ma||nb(this,0));this.yb=a};s.He=function(a){a?(this.e("Browser went online.  Reconnecting."),this.va=1E3,this.Za=!0,this.ma||nb(this,0)):(this.e("Browser went offline.  Killing connection; don't reconnect."),this.Za=!1,this.ma&&this.ma.close())};s.Qd=function(){this.e("data client disconnected");this.T=!1;this.ma=null;for(var a=0;a<this.V.length;a++){var b=this.V[a];b&&"h"in b.Vd&&b.Le&&(b.G&&b.G("disconnect"),
delete this.V[a],this.Qb--)}0===this.Qb&&(this.V=[]);if(this.Za)this.yb?this.Jb&&(3E4<(new Date).getTime()-this.Jb&&(this.va=1E3),this.Jb=null):(this.e("Window isn't visible.  Delaying reconnect."),this.va=this.oc,this.hd=(new Date).getTime()),a=Math.max(0,this.va-((new Date).getTime()-this.hd)),a*=Math.random(),this.e("Trying to reconnect in "+a+"ms"),nb(this,a),this.va=Math.min(this.oc,1.3*this.va);else for(var c in this.Xb)delete this.Xb[c];this.sc(!1)};s.Pa=function(){this.Za=!1;this.ma?this.ma.close():
(this.gb&&(clearTimeout(this.gb),this.gb=null),this.T&&this.Qd())};s.ub=function(){this.Za=!0;this.va=1E3;this.T||nb(this,0)};Ta.prototype.sb=function(a,b){if(a.f())this.H=b,this.o=null;else if(null!==this.H)this.H=this.H.Ba(a,b);else{null==this.o&&(this.o=new Ob);var c=ea(a);this.o.contains(c)||this.o.add(c,new Ta);c=this.o.get(c);a=ua(a);c.sb(a,b)}};Ta.prototype.B=function(a){null!==this.o&&ta(this.o,function(b,c){a(b,c)})};Ua.prototype.toString=function(){return this.ba.toString()};Od.prototype.set=
function(a,b){var c=this,d=[];Va(b,function(a){var b=a.path;a=a.ua;var e=Pb();ra(P(c.Sb,b),e);ca(c.O,b,a);d.push({path:b,Re:e})});return d};var rb="auth.firebase.com",lf=["remember","redirectTo"],mf={NETWORK_ERROR:"Unable to contact the Firebase server.",SERVER_ERROR:"An unknown server error occurred.",TRANSPORT_UNAVAILABLE:"There are no login transports available for the requested method.",REQUEST_INTERRUPTED:"The browser redirected the page before the login request could complete.",USER_CANCELLED:"The user cancelled authentication."};
Ya.prototype.open=function(a,b,c){function d(){c&&(c(fa("REQUEST_INTERRUPTED")),c=null)}var e=new XMLHttpRequest,f=this.options.method.toUpperCase(),g;Ca(window,"beforeunload",d);e.onreadystatechange=function(){if(c&&4===e.readyState){var a;if(200<=e.status&&300>e.status){try{a=B(e.responseText)}catch(b){}c(null,a)}else 500<=e.status&&600>e.status?c(fa("SERVER_ERROR")):c(fa("NETWORK_ERROR"));c=null;Wa(window,"beforeunload",d)}};if("GET"===f)a+=(/\?/.test(a)?"":"?")+Xa(b),g=null;else{var h=this.options.headers.content_type;
"application/json"===h&&(g=D(b));"application/x-www-form-urlencoded"===h&&(g=Xa(b))}e.open(f,a,!0);a={"X-Requested-With":"XMLHttpRequest",Accept:"application/json;text/plain"};Oe(a,this.options.headers);for(var k in a)e.setRequestHeader(k,a[k]);e.send(g)};Ya.isAvailable=function(){return!!window.XMLHttpRequest&&"string"===typeof(new XMLHttpRequest).responseType&&(!(navigator.userAgent.match(/MSIE/)||navigator.userAgent.match(/Trident/))||Tb())};Ya.prototype.Bb=function(){return"json"};sb.prototype.open=
function(a,b,c){function d(){c&&(c(fa("USER_CANCELLED")),c=null)}var e=this,f=Kb(rb),g;b.requestId=this.Yb;b.redirectTo=f.scheme+"://"+f.host+"/blank/page.html";a+=/\?/.test(a)?"":"?";a+=Xa(b);(g=window.open(a,"_blank","location\x3dno"))&&k(g.addEventListener)?(g.addEventListener("loadstart",function(a){a&&a.url&&(a=Kb(a.url),a.host===rb&&"/blank/page.html"===a.pb&&(g.removeEventListener("exit",d),g.close(),a=new Cc(null,null,{requestId:e.Yb}),e.Rd.requestWithCredential("/auth/session",a,c),c=null))}),
g.addEventListener("exit",d)):c(fa("TRANSPORT_UNAVAILABLE"))};u("fb.login.transports.CordovaInAppBrowser.prototype.open",sb.prototype.open);sb.isAvailable=function(){return Sb()};sb.prototype.Bb=function(){return"redirect"};tb.prototype.open=function(a,b,c){function d(a){g&&(document.body.removeChild(g),g=void 0);n&&(n=clearInterval(n));Wa(window,"message",e);Wa(window,"unload",d);if(m&&!a)try{m.close()}catch(b){h.postMessage("die",k)}m=h=void 0}function e(a){if(a.origin===k)try{var b=B(a.data);"ready"===
b.a?h.postMessage(p,k):"error"===b.a?(d(!1),c&&(c(b.d),c=null)):"response"===b.a&&(d(b.bf),c&&(c(null,b.d),c=null))}catch(f){}}var f=Tb(),g,h,k=Qd(a);if(k!==Qd(this.options.relay_url))c&&setTimeout(function(){c(Error("invalid arguments: origin of url and relay_url must match"))},0);else{f&&(g=document.createElement("iframe"),g.setAttribute("src",this.options.relay_url),g.style.display="none",g.setAttribute("name","__winchan_relay_frame"),document.body.appendChild(g),h=g.contentWindow);a+=(/\?/.test(a)?
"":"?")+Xa(b);var m=window.open(a,this.options.window_name,this.options.window_features);h||(h=m);var n=setInterval(function(){m&&m.closed&&(d(!1),c&&(c(fa("USER_CANCELLED")),c=null))},500),p=D({a:"request",d:b});Ca(window,"unload",d);Ca(window,"message",e)}};u("fb.login.transports.Popup.prototype.open",tb.prototype.open);tb.isAvailable=function(){return"postMessage"in window&&!/^file:\//.test(location.href)&&!(Sb()||navigator.userAgent.match(/Windows Phone/)||window.Windows&&/^ms-appx:/.test(location.href)||
navigator.userAgent.match(/CriOS/)||navigator.userAgent.match(/Twitter for iPhone/)||navigator.userAgent.match(/FBAN\/FBIOS/)||window.navigator.standalone)&&!navigator.userAgent.match(/PhantomJS/)};tb.prototype.Bb=function(){return"popup"};Za.prototype.open=function(a,b,c){function d(){c&&(c(fa("REQUEST_INTERRUPTED")),c=null)}function e(){setTimeout(function(){delete window.__firebase_login_jsonp[f];od(window.__firebase_login_jsonp)&&delete window.__firebase_login_jsonp;try{var a=document.getElementById(f);
a&&a.parentNode.removeChild(a)}catch(b){}},1);Wa(window,"beforeunload",d)}var f="fn"+(new Date).getTime()+Math.floor(99999*Math.random());b[this.options.callback_parameter]="__firebase_login_jsonp."+f;a+=(/\?/.test(a)?"":"?")+Xa(b);Ca(window,"beforeunload",d);window.__firebase_login_jsonp[f]=function(a){c&&(c(null,a),c=null);e()};of(f,a,c)};Za.isAvailable=function(){return!Sb()};Za.prototype.Bb=function(){return"json"};ub.prototype.set=function(a,b){if(!b)if(this.Ic.length)b=this.Ic[0];else throw Error("fb.login.SessionManager : No storage options available!");
b.set(this.pd,a)};ub.prototype.get=function(){var a=ob(this.Ic,t(this.we,this)),a=Vd(a,function(a){return null!==a});Ee(a,function(a,b){return Gd(b.token)-Gd(a.token)});return 0<a.length?a.shift():null};ub.prototype.we=function(a){try{var b=a.get(this.pd);if(b&&b.token)return b}catch(c){}return null};ub.prototype.clear=function(){var a=this;Va(this.Ic,function(b){b.remove(a.pd)})};vb.prototype.open=function(a,b){ja.set("redirect_request_id",this.Yb);b.requestId=this.Yb;b.redirectTo=b.redirectTo||
window.location.href;a+=(/\?/.test(a)?"":"?")+Xa(b);window.location=a};u("fb.login.transports.Redirect.prototype.open",vb.prototype.open);vb.isAvailable=function(){return!/^file:\//.test(location.href)&&!Sb()};vb.prototype.Bb=function(){return"redirect"};x(Ec,ya);s=Ec.prototype;s.bd=function(){return this.La||null};s.Xc=function(a,b){Na(this);var c=Ma(a);c.vb._method="POST";this.Zb("/users",c,function(a){W(b,a)})};s.sd=function(a,b){var c=this;Na(this);var d="/users/"+encodeURIComponent(a.email),
e=Ma(a);e.vb._method="DELETE";this.Zb(d,e,function(a,d){!a&&d&&d.uid&&c.La&&c.La.uid&&c.La.uid===d.uid&&Td(c);W(b,a)})};s.Tc=function(a,b){Na(this);var c="/users/"+encodeURIComponent(a.email)+"/password",d=Ma(a);d.vb._method="PUT";d.vb.password=a.newPassword;this.Zb(c,d,function(a){W(b,a)})};s.td=function(a,b){Na(this);var c="/users/"+encodeURIComponent(a.email)+"/password",d=Ma(a);d.vb._method="POST";this.Zb(c,d,function(a){W(b,a)})};s.Zb=function(a,b,c){Ud(this,[Ya,Za],a,b,c)};s.cd=function(a){L("auth_status"===
a,'initial event must be of type "auth_status"');return[this.La]};Wd.prototype.Vb=function(){for(var a=0;a<this.hb.length;a++)if(this.hb[a]){var b=this.hb[a];this.hb[a]=null;sf(b)}this.hb=[]};ab.prototype.Ac=function(a,b){b=this.Bc(a,b);null!=b&&$d(this,b)};ab.prototype.Vb=function(){this.Zc.Vb()};x(Wb,ab);Wb.prototype.Bc=function(a,b){this.j=a;this.Hb&&null!=b&&b.push(new U("value",this.j));return b};Wb.prototype.Fb=function(){return{}};x(Ic,Ob);s=Ic.prototype;s.setActive=function(a){this.Aa=a};
s.defaultView=function(){return Oa(this)?this.get("default"):null};s.path=function(){return this.Z};s.toString=function(){return ob(this.keys(),function(a){return"default"===a?"{}":a}).join("$")};s.rb=function(){var a=[];ta(this,function(b,c){a.push(c.S)});return a};x(yb,ab);yb.prototype.Bc=function(b,c){if(null===c)return c;var d=[],e=this.S;a(e.fa)&&(a(e.za)&&null!=e.za?d.push(function(a,b){var c=Ha(b,e.fa);return 0<c||0===c&&0<=Ia(a,e.za)}):d.push(function(a,b){return 0<=Ha(b,e.fa)}));a(e.Ea)&&
(a(e.fb)?d.push(function(a,b){var c=Ha(b,e.Ea);return 0>c||0===c&&0>=Ia(a,e.fb)}):d.push(function(a,b){return 0>=Ha(b,e.Ea)}));var f=null,g=null;if(a(this.S.Ga))if(a(this.S.fa)){if(f=ce(b,d,this.S.Ga,!1)){var h=b.P(f).m();d.push(function(a,b){var c=Ha(b,h);return 0>c||0===c&&0>=Ia(a,f)})}}else if(g=ce(b,d,this.S.Ga,!0)){var k=b.P(g).m();d.push(function(a,b){var c=Ha(b,k);return 0<c||0===c&&0<=Ia(a,g)})}for(var m=[],n=[],p=[],r=[],s=0;s<c.length;s++){var t=c[s].da,u=c[s].xa;switch(c[s].type){case "child_added":Xb(d,
t,u)&&(this.j=this.j.K(t,u),n.push(c[s]));break;case "child_removed":this.j.P(t).f()||(this.j=this.j.K(t,null),m.push(c[s]));break;case "child_changed":!this.j.P(t).f()&&Xb(d,t,u)&&(this.j=this.j.K(t,u),r.push(c[s]));break;case "child_moved":var v=!this.j.P(t).f(),w=Xb(d,t,u);v?w?(this.j=this.j.K(t,u),p.push(c[s])):(m.push(new U("child_removed",this.j.P(t),t)),this.j=this.j.K(t,null)):w&&(this.j=this.j.K(t,u),n.push(c[s]))}}var x=f||g;if(x){var y=(s=null!==g)?this.j.Jd():this.j.Kd(),z=!1,A=!1,B=this;
(s?b.$c:b.B).call(b,function(a,b){A||null!==y||(A=!0);if(A&&z)return!0;z?(m.push(new U("child_removed",B.j.P(a),a)),B.j=B.j.K(a,null)):A&&(n.push(new U("child_added",b,a)),B.j=B.j.K(a,b));y===a&&(A=!0);a===x&&(z=!0)})}for(s=0;s<n.length;s++)d=n[s],t=this.j.ha(d.da,d.xa),m.push(new U("child_added",d.xa,d.da,t));for(s=0;s<p.length;s++)d=p[s],t=this.j.ha(d.da,d.xa),m.push(new U("child_moved",d.xa,d.da,t));for(s=0;s<r.length;s++)d=r[s],t=this.j.ha(d.da,d.xa),m.push(new U("child_changed",d.xa,d.da,t));
this.Hb&&0<m.length&&m.push(new U("value",this.j));return m};yb.prototype.ed=function(a){return this.j.P(a)!==S};yb.prototype.Fb=function(a,b,c){var d={};this.j.Q()||this.j.B(function(a){d[a]=3});var e=this.j;c=Q(c,new O(""));var f=new Da;ra(P(f,this.S.path),!0);b=S.Ba(a,b);var g=this;ae(c,b,a,f,function(a,b,c){null!==c&&a.toString()===g.S.path.toString()&&g.Bc(b,c)});this.j.Q()?xa(d,function(a,b){d[b]=2}):(this.j.B(function(a){G(d,a)||(d[a]=1)}),xa(d,function(a,b){g.j.P(b).f()&&(d[b]=2)}));this.j=
e;return d};bb.prototype.ec=function(a,b,c,d,e){var f=a.path,g=P(this.pa,f),h=g.k();null===h?(h=new Ic,ra(g,h)):L(!h.f(),"We shouldn't be storing empty QueryMaps");var k=a.Wa();if(h.contains(k))a=h.get(k),Yd(a,b,c,d,e);else{var m=this.g.ba.N(f);a=zf(a,m);xf(this,g,h,k,a);Yd(a,b,c,d,e);(b=(b=Eb(P(this.pa,f),function(a){var b;if(b=a.k()&&a.k().defaultView())b=a.k().defaultView().Hb;if(b)return!0},!0))||null===this.n&&!Q(this.g,f).f())&&Gc(a)}a.Vb()};bb.prototype.Dc=function(a,b,c,d){var e=P(this.pa,
a.path).k();return null===e?null:ee(this,e,a,b,c,d)};bb.prototype.Ac=function(a,b,c){a=P(this.pa,a).k();null!==a&&ta(a,function(a,d){d.Ac(b,c)})};bb.prototype.Fb=function(a,b,c,d){function e(a){xa(a,function(a,b){f[b]=3===a?3:(H(f,b)||a)===a?a:3})}var f={};ta(b,function(b,f){e(f.Fb(a,c,d))});c.Q()||c.B(function(a){G(f,a)||(f[a]=4)});return f};s=Lc.prototype;s.toString=function(){return(this.D.Ya?"https://":"http://")+this.D.host};s.name=function(){return this.D.Sa};s.uc=function(a,b,c){this.ic++;
this.Md&&(b=this.Md(a,b));var d,e,f=[];9<=a.length&&a.lastIndexOf(".priority")===a.length-9?(d=new O(a.substring(0,a.length-9)),e=Q(this.g.wa,d).Ka(b),f.push(d)):c?(d=new O(a),e=Q(this.g.wa,d),xa(b,function(a,b){var c=new O(b);".priority"===b?e=e.Ka(a):(e=e.Ba(c,la(a)),f.push(d.J(b)))})):(d=new O(a),e=la(b),f.push(d));a=zb(this.L,d,e,this.g.O);b=!1;for(c=0;c<a.length;++c){var g=a[c];b=hf(this.g,g.path,g.ua)||b}b&&(d=Aa(this,d));pa(this.L,d,f)};s.sc=function(a){Zb(this,"connected",a);!1===a&&Af(this)};
s.nd=function(a){var b=this;pc(a,function(a,c){Zb(b,c,a)})};s.dd=function(a){a=new O(a);return Q(this.g.wa,a).hash()};s.jd=function(a){Zb(this,"authenticated",a)};s.xb=function(a,b,c,d){this.e("set",{path:a.toString(),value:b,la:c});var e=Ab(this);b=la(b,c);var e=qb(b,e),e=zb(this.L,a,e,this.g.O),f=this.g.set(a,e),g=this;this.n.put(a.toString(),b.X(!0),function(b,c){"ok"!==b&&$("set at "+a+" failed: "+b);Rb(g.g,f);pb(g.g,a);var e=Aa(g,a);pa(g.L,e,[]);Ba(d,b,c)});e=Mc(this,a);Aa(this,e);pa(this.L,
e,[a])};s.update=function(a,b,c){this.e("update",{path:a.toString(),value:b});var d=Q(this.g.qa,a),e=!0,f=[],g=Ab(this),h=[],k;for(k in b){var e=!1,m=la(b[k]),m=qb(m,g),d=d.K(k,m),n=a.J(k);f.push(n);m=zb(this.L,n,m,this.g.O);h=h.concat(this.g.set(a,m))}if(e)oa("update() called with empty data.  Don't do anything."),Ba(c,"ok");else{var p=this;df(this.n,a.toString(),b,function(b,d){"ok"!==b&&$("update at "+a+" failed: "+b);Rb(p.g,h);pb(p.g,a);var e=Aa(p,a);pa(p.L,e,[]);Ba(c,b,d)});b=Mc(this,a);Aa(this,
b);pa(p.L,b,f)}};s.vd=function(a,b,c){this.e("setPriority",{path:a.toString(),la:b});var d=Ab(this),d=Bc(b,d),d=Q(this.g.O,a).Ka(d),d=zb(this.L,a,d,this.g.O),e=this.g.set(a,d),f=this;this.n.put(a.toString()+"/.priority",b,function(b,d){"permission_denied"===b&&$("setPriority at "+a+" failed: "+b);Rb(f.g,e);pb(f.g,a);var g=Aa(f,a);pa(f.L,g,[]);Ba(c,b,d)});b=Aa(this,a);pa(f.L,b,[])};s.ld=function(a,b){var c=this;this.n.ld(a.toString(),function(d,e){"ok"===d&&zc(c.U,a);Ba(b,d,e)})};s.ec=function(a,b,
c,d,e){".info"===ea(a.path)?this.gd.ec(a,b,c,d,e):this.L.ec(a,b,c,d,e)};s.Dc=function(a,b,c,d){if(".info"===ea(a.path))this.gd.Dc(a,b,c,d);else{b=this.L.Dc(a,b,c,d);if(c=null!==b){c=this.g;d=a.path;for(var e=[],f=0;f<b.length;++f)e[f]=Q(c.wa,b[f]);ca(c.wa,d,S);for(f=0;f<b.length;++f)ca(c.wa,b[f],e[f]);c=pb(c,d)}c&&(L(this.g.qa.ba===this.L.rc,"We should have raised any outstanding events by now.  Else, we'll blow them away."),ca(this.g.qa,a.path,Q(this.g.O,a.path)),this.L.rc=this.g.qa.ba)}};s.Pa=function(){this.n.Pa()};
s.ub=function(){this.n.ub()};s.wd=function(a){if("undefined"!==typeof console){a?(this.Hc||(this.Hc=new rc(this.ga)),a=this.Hc.get()):a=this.ga.get();var b=Hf(Ne(a),function(a,b){return Math.max(b.length,a)},0),c;for(c in a){for(var d=a[c],e=c.length;e<b+2;e++)c+=" ";console.log(c+d)}}};s.xd=function(a){Sa(this.ga,a);this.be.yd[a]=!0};s.e=function(){oa("r:"+this.n.id+":",arguments)};c(ga);ga.prototype.Pa=function(){for(var a in this.tb)this.tb[a].Pa()};ga.prototype.interrupt=ga.prototype.Pa;ga.prototype.ub=
function(){for(var a in this.tb)this.tb[a].ub()};ga.prototype.resume=ga.prototype.ub;bc.prototype.ob=function(a){var b=this,c;try{c=B(a.data)}catch(d){}c&&"request"===c.a&&(Wa(window,"message",this.ob),this.Jc=a.origin,this.Ab&&setTimeout(function(){b.Ab(b.Jc,c.d,function(a,c){b.oe=!c;b.Ab=void 0;dc(b,{a:"response",d:a,forceKeepWindowOpen:c})})},0))};bc.prototype.Ie=function(){try{Wa(this.lc,"message",this.Pd)}catch(a){}this.Ab&&(dc(this,{a:"error",d:"unknown closed window"}),this.Ab=void 0);try{window.close()}catch(b){}};
bc.prototype.Pd=function(a){if(this.oe&&"die"===a.data)try{window.close()}catch(b){}};var A={xe:function(a){var b=ka.prototype.hash;ka.prototype.hash=a;var c=Ka.prototype.hash;Ka.prototype.hash=a;return function(){ka.prototype.hash=b;Ka.prototype.hash=c}}};A.hijackHash=A.xe;A.Wa=function(a){return a.Wa()};A.queryIdentifier=A.Wa;A.Ae=function(a){return a.i.n.ja};A.listens=A.Ae;A.Me=function(a){return a.i.n.ma};A.refConnection=A.Me;A.ee=La;A.DataConnection=A.ee;La.prototype.sendRequest=La.prototype.Ia;
La.prototype.interrupt=La.prototype.Pa;A.fe=za;A.RealTimeConnection=A.fe;za.prototype.sendRequest=za.prototype.Zd;za.prototype.close=za.prototype.close;A.de=lc;A.ConnectionTarget=A.de;A.ue=function(){ue=te=!0};A.forceLongPolling=A.ue;A.ve=function(){ve=!0};A.forceWebSockets=A.ve;A.Te=function(a,b){a.i.n.ud=b};A.setSecurityDebugCallback=A.Te;A.wd=function(a,b){a.i.wd(b)};A.stats=A.wd;A.xd=function(a,b){a.i.xd(b)};A.statsIncrementCounter=A.xd;A.ic=function(a){return a.i.ic};A.dataUpdateCount=A.ic;A.ye=
function(a,b){a.i.Md=b};A.interceptServerData=A.ye;A.Fe=function(a){new bc(a)};A.onPopupOpen=A.Fe;A.Qe=function(a){rb=a};A.setAuthenticationServer=A.Qe;aa.prototype.cancel=function(a){y("Firebase.onDisconnect().cancel",0,1,arguments.length);z("Firebase.onDisconnect().cancel",1,a,!0);this.Wb.ld(this.Z,a)};aa.prototype.cancel=aa.prototype.cancel;aa.prototype.remove=function(a){y("Firebase.onDisconnect().remove",0,1,arguments.length);na("Firebase.onDisconnect().remove",this.Z);z("Firebase.onDisconnect().remove",
1,a,!0);je(this.Wb,this.Z,null,a)};aa.prototype.remove=aa.prototype.remove;aa.prototype.set=function(a,b){y("Firebase.onDisconnect().set",1,2,arguments.length);na("Firebase.onDisconnect().set",this.Z);J("Firebase.onDisconnect().set",a,!1);z("Firebase.onDisconnect().set",2,b,!0);je(this.Wb,this.Z,a,b)};aa.prototype.set=aa.prototype.set;aa.prototype.xb=function(a,b,c){y("Firebase.onDisconnect().setWithPriority",2,3,arguments.length);na("Firebase.onDisconnect().setWithPriority",this.Z);J("Firebase.onDisconnect().setWithPriority",
a,!1);V("Firebase.onDisconnect().setWithPriority",2,b,!1);z("Firebase.onDisconnect().setWithPriority",3,c,!0);if(".length"===this.Ha||".keys"===this.Ha)throw"Firebase.onDisconnect().setWithPriority failed: "+this.Ha+" is a read-only object.";Bf(this.Wb,this.Z,a,b,c)};aa.prototype.setWithPriority=aa.prototype.xb;aa.prototype.update=function(a,b){y("Firebase.onDisconnect().update",1,2,arguments.length);na("Firebase.onDisconnect().update",this.Z);if(e(a)){for(var c={},d=0;d<a.length;++d)c[""+d]=a[d];
a=c;$("Passing an Array to Firebase.onDisconnect().update() is deprecated. Use set() if you want to overwrite the existing data, or an Object with integer keys if you really do want to only update some of the children.")}da("Firebase.onDisconnect().update",a);z("Firebase.onDisconnect().update",2,b,!0);Cf(this.Wb,this.Z,a,b)};aa.prototype.update=aa.prototype.update;var Mf=function(){var a=0,b=[];return function(c){var d=c===a;a=c;for(var e=Array(8),f=7;0<=f;f--)e[f]="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz".charAt(c%
64),c=Math.floor(c/64);L(0===c,"Cannot push at time \x3d\x3d 0");c=e.join("");if(d){for(f=11;0<=f&&63===b[f];f--)b[f]=0;b[f]++}else for(f=0;12>f;f++)b[f]=Math.floor(64*Math.random());for(f=0;12>f;f++)c+="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz".charAt(b[f]);L(20===c.length,"NextPushId: Length should be 20.");return c}}();x(v,K);u("Firebase",v);v.prototype.name=function(){y("Firebase.name",0,0,arguments.length);return this.path.f()?null:Qc(this.path)};v.prototype.name=v.prototype.name;
v.prototype.J=function(a){y("Firebase.child",1,1,arguments.length);if(h(a))a=String(a);else if(!(a instanceof O))if(null===ea(this.path)){var b=a;b&&(b=b.replace(/^\/*\.info(\/|$)/,"/"));Bb("Firebase.child",b)}else Bb("Firebase.child",a);return new v(this.i,this.path.J(a))};v.prototype.child=v.prototype.J;v.prototype.parent=function(){y("Firebase.parent",0,0,arguments.length);var a=this.path.parent();return null===a?null:new v(this.i,a)};v.prototype.parent=v.prototype.parent;v.prototype.root=function(){y("Firebase.ref",
0,0,arguments.length);for(var a=this;null!==a.parent();)a=a.parent();return a};v.prototype.root=v.prototype.root;v.prototype.toString=function(){y("Firebase.toString",0,0,arguments.length);var a;if(null===this.parent())a=this.i.toString();else{a=this.parent().toString()+"/";var b=this.name();a+=encodeURIComponent(String(b))}return a};v.prototype.toString=v.prototype.toString;v.prototype.set=function(a,b){y("Firebase.set",1,2,arguments.length);na("Firebase.set",this.path);J("Firebase.set",a,!1);z("Firebase.set",
2,b,!0);this.i.xb(this.path,a,null,b)};v.prototype.set=v.prototype.set;v.prototype.update=function(a,b){y("Firebase.update",1,2,arguments.length);na("Firebase.update",this.path);if(e(a)){for(var c={},d=0;d<a.length;++d)c[""+d]=a[d];a=c;$("Passing an Array to Firebase.update() is deprecated. Use set() if you want to overwrite the existing data, or an Object with integer keys if you really do want to only update some of the children.")}da("Firebase.update",a);z("Firebase.update",2,b,!0);if(G(a,".priority"))throw Error("update() does not currently support updating .priority.");
this.i.update(this.path,a,b)};v.prototype.update=v.prototype.update;v.prototype.xb=function(a,b,c){y("Firebase.setWithPriority",2,3,arguments.length);na("Firebase.setWithPriority",this.path);J("Firebase.setWithPriority",a,!1);V("Firebase.setWithPriority",2,b,!1);z("Firebase.setWithPriority",3,c,!0);if(".length"===this.name()||".keys"===this.name())throw"Firebase.setWithPriority failed: "+this.name()+" is a read-only object.";this.i.xb(this.path,a,b,c)};v.prototype.setWithPriority=v.prototype.xb;v.prototype.remove=
function(a){y("Firebase.remove",0,1,arguments.length);na("Firebase.remove",this.path);z("Firebase.remove",1,a,!0);this.set(null,a)};v.prototype.remove=v.prototype.remove;v.prototype.transaction=function(b,c,d){y("Firebase.transaction",1,3,arguments.length);na("Firebase.transaction",this.path);z("Firebase.transaction",1,b,!1);z("Firebase.transaction",2,c,!0);if(a(d)&&"boolean"!=typeof d)throw Error(C("Firebase.transaction",3,!0)+"must be a boolean.");if(".length"===this.name()||".keys"===this.name())throw"Firebase.transaction failed: "+
this.name()+" is a read-only object.";"undefined"===typeof d&&(d=!0);Df(this.i,this.path,b,c,d)};v.prototype.transaction=v.prototype.transaction;v.prototype.vd=function(a,b){y("Firebase.setPriority",1,2,arguments.length);na("Firebase.setPriority",this.path);V("Firebase.setPriority",1,a,!1);z("Firebase.setPriority",2,b,!0);this.i.vd(this.path,a,b)};v.prototype.setPriority=v.prototype.vd;v.prototype.push=function(a,b){y("Firebase.push",0,2,arguments.length);na("Firebase.push",this.path);J("Firebase.push",
a,!0);z("Firebase.push",2,b,!0);var c=ie(this.i),c=Mf(c),c=this.J(c);"undefined"!==typeof a&&null!==a&&c.set(a,b);return c};v.prototype.push=v.prototype.push;v.prototype.ka=function(){return new aa(this.i,this.path,this.name())};v.prototype.onDisconnect=v.prototype.ka;v.prototype.Ne=function(){$("FirebaseRef.removeOnDisconnect() being deprecated. Please use FirebaseRef.onDisconnect().remove() instead.");this.ka().remove();ke(this.i)};v.prototype.removeOnDisconnect=v.prototype.Ne;v.prototype.Se=function(a){$("FirebaseRef.setOnDisconnect(value) being deprecated. Please use FirebaseRef.onDisconnect().set(value) instead.");
this.ka().set(a);ke(this.i)};v.prototype.setOnDisconnect=v.prototype.Se;v.prototype.I=function(a,b,c){$("FirebaseRef.auth() being deprecated. Please use FirebaseRef.authWithCustomToken() instead.");y("Firebase.auth",1,3,arguments.length);Oc("Firebase.auth",a);z("Firebase.auth",2,b,!0);z("Firebase.auth",3,b,!0);Fc(this.i.I,a,{},{remember:"none"},b,c)};v.prototype.auth=v.prototype.I;v.prototype.Bd=function(a){y("Firebase.unauth",0,1,arguments.length);z("Firebase.unauth",1,a,!0);Td(this.i.I,a)};v.prototype.unauth=
v.prototype.Bd;v.prototype.bd=function(){y("Firebase.getAuth",0,0,arguments.length);return this.i.I.bd()};v.prototype.getAuth=v.prototype.bd;v.prototype.Ee=function(a,b){y("Firebase.onAuth",1,2,arguments.length);z("Firebase.onAuth",1,a,!1);I("Firebase.onAuth",2,b);this.i.I.Ta("auth_status",a,b)};v.prototype.onAuth=v.prototype.Ee;v.prototype.De=function(a,b){y("Firebase.offAuth",1,2,arguments.length);z("Firebase.offAuth",1,a,!1);I("Firebase.offAuth",2,b);this.i.I.nb("auth_status",a,b)};v.prototype.offAuth=
v.prototype.De;v.prototype.je=function(a,b,c){y("Firebase.authWithCustomToken",2,3,arguments.length);Oc("Firebase.authWithCustomToken",a);z("Firebase.authWithCustomToken",2,b,!1);ia("Firebase.authWithCustomToken",3,c,!0);Fc(this.i.I,a,{},c||{},b)};v.prototype.authWithCustomToken=v.prototype.je;v.prototype.ke=function(a,b,c){y("Firebase.authWithOAuthPopup",2,3,arguments.length);Cb("Firebase.authWithOAuthPopup",1,a);z("Firebase.authWithOAuthPopup",2,b,!1);ia("Firebase.authWithOAuthPopup",3,c,!0);rf(this.i.I,
a,c,b)};v.prototype.authWithOAuthPopup=v.prototype.ke;v.prototype.le=function(a,b,c){y("Firebase.authWithOAuthRedirect",2,3,arguments.length);Cb("Firebase.authWithOAuthRedirect",1,a);z("Firebase.authWithOAuthRedirect",2,b,!1);ia("Firebase.authWithOAuthRedirect",3,c,!0);var d=this.i.I;Na(d);var e=[vb],f=Ma(c);"anonymous"===a||"firebase"===a?W(b,fa("TRANSPORT_UNAVAILABLE")):(ja.set("redirect_client_options",f.hc),Vb(d,e,"/auth/"+a,f,b))};v.prototype.authWithOAuthRedirect=v.prototype.le;v.prototype.me=
function(a,b,c,d){y("Firebase.authWithOAuthToken",3,4,arguments.length);Cb("Firebase.authWithOAuthToken",1,a);z("Firebase.authWithOAuthToken",3,c,!1);ia("Firebase.authWithOAuthToken",4,d,!0);g(b)?(Cb("Firebase.authWithOAuthToken",2,b),Ub(this.i.I,a+"/token",{access_token:b},c)):(ia("Firebase.authWithOAuthToken",2,b,!1),Ub(this.i.I,a+"/token",b,c))};v.prototype.authWithOAuthToken=v.prototype.me;v.prototype.ie=function(a,b){y("Firebase.authAnonymously",1,2,arguments.length);z("Firebase.authAnonymously",
1,a,!1);ia("Firebase.authAnonymously",2,b,!0);Ub(this.i.I,"anonymous",{},a)};v.prototype.authAnonymously=v.prototype.ie;v.prototype.ne=function(a,b,c){y("Firebase.authWithPassword",2,3,arguments.length);ia("Firebase.authWithPassword",1,a,!1);qa("Firebase.authWithPassword",a,"email");qa("Firebase.authWithPassword",a,"password");z("Firebase.authAnonymously",2,b,!1);ia("Firebase.authAnonymously",3,c,!0);Ub(this.i.I,"password",a,b)};v.prototype.authWithPassword=v.prototype.ne;v.prototype.Xc=function(a,
b){y("Firebase.createUser",2,2,arguments.length);ia("Firebase.createUser",1,a,!1);qa("Firebase.createUser",a,"email");qa("Firebase.createUser",a,"password");z("Firebase.createUser",2,b,!1);this.i.I.Xc(a,b)};v.prototype.createUser=v.prototype.Xc;v.prototype.sd=function(a,b){y("Firebase.removeUser",2,2,arguments.length);ia("Firebase.removeUser",1,a,!1);qa("Firebase.removeUser",a,"email");qa("Firebase.removeUser",a,"password");z("Firebase.removeUser",2,b,!1);this.i.I.sd(a,b)};v.prototype.removeUser=
v.prototype.sd;v.prototype.Tc=function(a,b){y("Firebase.changePassword",2,2,arguments.length);ia("Firebase.changePassword",1,a,!1);qa("Firebase.changePassword",a,"email");qa("Firebase.changePassword",a,"oldPassword");qa("Firebase.changePassword",a,"newPassword");z("Firebase.changePassword",2,b,!1);this.i.I.Tc(a,b)};v.prototype.changePassword=v.prototype.Tc;v.prototype.td=function(a,b){y("Firebase.resetPassword",2,2,arguments.length);ia("Firebase.resetPassword",1,a,!1);qa("Firebase.resetPassword",
a,"email");z("Firebase.resetPassword",2,b,!1);this.i.I.td(a,b)};v.prototype.resetPassword=v.prototype.td;v.goOffline=function(){y("Firebase.goOffline",0,0,arguments.length);ga.ib().Pa()};v.goOnline=function(){y("Firebase.goOnline",0,0,arguments.length);ga.ib().ub()};v.enableLogging=fd;v.ServerValue={TIMESTAMP:{".sv":"timestamp"}};v.SDK_VERSION="1.1.0";v.INTERNAL=A;v.Context=ga})();Math.log10||(Math.log10=function(a){return Math.log(a)/Math.log(10)});String.prototype.contains||(String.prototype.contains=function(a){return-1<this.indexOf(a)});window.clone=function(a){return JSON.parse(JSON.stringify(a))};window.isInArray=function(a,b){for(var c=0;c<a.length;c++)if(a[c]==b)return!0;return!1};window.isValidInt=function(a){return 0==a.length||"NaN"===parseInt(a,10).toString()?!1:!0};window.isFunction=function(a){return"[object Function]"===Object.prototype.toString.call(a)};
window.isString=function(a){return"string"==typeof a||a instanceof String};function utf8ByteLength(a){if(!a)return 0;a=encodeURI(a);var b=a.match(/%/g);return b?a.length-2*b.length:a.length}function unicodeByteLength(a){if(!a)return 0;for(var b,c=0,d=0;d<a.length;d++){b=a.charCodeAt(d);do c++,b>>=8;while(b)}return c}function dbcsByteLength(a){if(!a)return 0;for(var b=0,c=0;c<a.length;c++)b++,a.charCodeAt(c)>>8&&b++;return b}
function bigNumberToHumanReadable_zh_cn(a){return 1E12<a?Math.round(a/1E10)/100+"\u4ebf\u4ebf":1E8<a?Math.round(a/1E6)/100+"\u4e07\u4ebf":1E4<a?Math.round(a/100)/100+"\u4ebf":Math.round(100*a)/100+"\u4e07"}function polarToXY(a,b){return{x:Math.cos(a)*b,y:Math.sin(a)*b}};var buildRichText=function(a){a=a||{};var b=a.richText||new ccui.RichText;b.ignoreContentAdaptWithSize(!1);b.width=a.width||200;b.height=a.height||30;var c=a.fontSize||16,d=a.fontColor||cc.color.WHITE,e=a.fontFamily||"Arial",f=a.opacity||255;a=(a.str||a.text||"").split(/[{|}]/);var g=1;_.each(a,function(a){var k=null;"["===a.substr(0,1)&&"]"===a.substr(a.length-1,1)&&(k=a.substr(1,a.length-2),k=cc.spriteFrameCache.getSpriteFrame(k+".png"));a=k?new ccui.RichElementImage(g,cc.color.WHITE,255,k):new ccui.RichElementText(g,
new cc.FontDefinition({fillStyle:d,fontName:e,fontSize:c,fontWeight:"normal",fontStyle:"normal"}),f,a);b.pushBackElement(a);g++});return b},blockAllTouchEvent=function(a){cc.eventManager.addListener(cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,c){return!0},onTouchMoved:function(a,c){},onTouchEnded:function(a,c){}}),a)},blockMyTouchEvent=function(a){cc.eventManager.addListener(cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,
swallowTouches:!0,onTouchBegan:function(a,c){var d=c.getCurrentTarget(),e=d.convertToNodeSpace(a.getLocation()),d=d.getContentSize(),d=cc.rect(0,0,d.width,d.height);return cc.rectContainsPoint(d,e)?!0:!1},onTouchMoved:function(a,c){},onTouchEnded:function(a,c){}}),a)};var res={game_plist:"res/game.plist",game_png:"res/game.png",ready_mp3:"res/ready.mp3",fight_mp3:"res/fight.mp3",countdown3_mp3:"res/countdown-3.mp3",countdown2_mp3:"res/countdown-2.mp3",countdown1_mp3:"res/countdown-1.mp3"},g_resources=[],i;for(i in res)g_resources.push(res[i]);
var texts={},colors={table:new cc.color(59,127,66),tableLabel:new cc.color(214,254,157),tableLabelOutline:new cc.color(64,102,29)},times={card_sort:0.1,performSkill:0.2,flip:0.2,takeCard:0.3,rotateDirection:0.1,compare:3.5,giveMoney:0.4},dimens={card_size:{width:57,height:80},card_number_position:{x:38,y:65},player1Y:95,player2Y:705,player1HandPosition:{x:225,y:25},player2HandPosition:{x:225,y:775},betRatePosition:{x:430,y:380},hand_line_card_padding:-5,hand_line_width:450};var IconSprite=cc.Sprite.extend({ctor:function(a){a=a||{};var b=a.fontSize||15,c=a.fontColor||cc.color.BLACK,d=a.text||"",e=a.offset||{x:24,y:24};this._super(a.image);this.label=new ccui.Text(d,"Arial",b);this.label.enableOutline(cc.color.WHITE,2);this.label.setTextColor(c);this.label.attr({x:e.x,y:e.y});this.addChild(this.label,1)},setIcon:function(a){a instanceof cc.Texture2D?this.setTexture(a):a instanceof cc.SpriteFrame&&this.setSpriteFrame(a)},setString:function(a){this.label.setString(a)},setFontColor:function(a){this.label.setTextColor(a)}});var PatternModel=Backbone.Model.extend({defaults:function(){return{type:"fly",list:this.generateList()}},generateList:function(){var a=0;return _.map([0,1,2,3,4,5],function(b){a+=0.5;return{time:a,start:{x:-dimens.card_size.width,y:150+40*b},end:{x:cc.winSize.width+dimens.card_size.width,y:150+40*b},moveTime:2.5}})}}),Pattern2Model=PatternModel.extend({generateList:function(){var a=0;return _.map([0,1,2,3,4,5],function(b){a+=0.5;return{time:a,start:{x:-dimens.card_size.width,y:350-40*b},end:{x:cc.winSize.width+
dimens.card_size.width,y:350-40*b},moveTime:2.5}})}}),Pattern3Model=PatternModel.extend({generateList:function(){var a=0;return _.map([0,1,2,3,4,5],function(b){a+=0.5;return{time:a,start:{x:-dimens.card_size.width,y:350-40*b},end:{x:cc.winSize.width+dimens.card_size.width,y:150+40*b},moveTime:3}})}}),Pattern4Model=PatternModel.extend({generateList:function(){var a=0;return _.map([0,1,2,3,4,5],function(b){a+=0.5;return{time:a,start:{x:-dimens.card_size.width,y:150+40*b},end:{x:cc.winSize.width+dimens.card_size.width,
y:350-40*b},moveTime:3}})}}),Pattern5Model=PatternModel.extend({generateList:function(){for(var a=[],b=0;3>b;b++)a.push({time:0.5*b,start:{x:-dimens.card_size.width,y:150+30*b},end:{x:cc.winSize.width+dimens.card_size.width,y:150+30*b},moveTime:2.5}),a.push({time:0.5*b,start:{x:-dimens.card_size.width,y:350-30*b},end:{x:cc.winSize.width+dimens.card_size.width,y:350-30*b},moveTime:2.5});return a}}),Pattern6Model=PatternModel.extend({generateList:function(){for(var a=[],b=0;3>b;b++)a.push({time:0.5*
b,start:{x:-dimens.card_size.width,y:150+30*(2-b)},end:{x:cc.winSize.width+dimens.card_size.width,y:150+30*(2-b)},moveTime:2.5}),a.push({time:0.5*b,start:{x:-dimens.card_size.width,y:350-30*(2-b)},end:{x:cc.winSize.width+dimens.card_size.width,y:350-30*(2-b)},moveTime:2.5});return a}});SUIT_NUMBER_MAP={spade:0,heart:1,club:2,diamond:3};SUIT_ARRAY=["spade","heart","club","diamond"];var PokerCardModel=Backbone.Model.extend({defaults:function(){return{number:1,suit:0}}});function newDeck(){for(var a=[],b=8;14>=b;b++)for(var c=0;3>=c;c++)a.push(new PokerCardModel({number:b,suit:c}));return _.shuffle(a)}
var MIN_SPEED=5,MAX_SPEED=20,PokerCardSprite=cc.Sprite.extend({ctor:function(a){this._super();this.model=a.model;this.reverse=a.reverse;this.setName(this.model.cid);this.numberSprite=new cc.Sprite;this.numberSprite.attr({x:dimens.card_number_position.x,y:dimens.card_number_position.y});this.addChild(this.numberSprite,0);this.numberDownSprite=new cc.Sprite;this.numberDownSprite.attr({x:dimens.card_size.width-dimens.card_number_position.x,y:dimens.card_size.height-dimens.card_number_position.y,rotation:180});
this.addChild(this.numberDownSprite,0);var b=this;this.listener=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,b){var e=b.getCurrentTarget(),f=e.convertToNodeSpace(a.getLocation()),g=e.getContentSize(),g=cc.rect(0,0,g.width,g.height);return cc.rectContainsPoint(g,f)?(e.stopAllActions(),e.speedX=0,e.speedY=e.y>=cc.winSize.height/2?1:-1,!0):!1},onTouchMoved:function(a,d){if(!d.getCurrentTarget().alreadyTaken){var e=a.getDelta();b.x+=e.x;b.y+=
e.y;b.speedX=e.x;b.speedY=e.y}},onTouchEnded:function(a,d){var e=d.getCurrentTarget();if(!e.alreadyTaken)if(e.y<dimens.player1Y)e.playerTakeCard.call(e,gameModel.player1);else if(e.y>dimens.player2Y)e.playerTakeCard.call(e,gameModel.player2);else{var f=dimens.player1Y,g=dimens.player2Y,h=Math.max(0.1,Math.sqrt(b.speedX*b.speedX+b.speedY*b.speedY)),k=30*Math.min(MAX_SPEED,Math.max(MIN_SPEED,h)),h=[];if(0<b.speedY){var m=b.getCrossPointX.call(b,g),k=Math.sqrt((e.x-m)*(e.x-m)+(e.y-g)*(e.y-g))/k;h.push(new cc.moveTo(k,
m,g));m>-dimens.card_size.width/2&&m<cc.winSize.width+dimens.card_size.width/2?h.push(new cc.callFunc(function(){e.playerTakeCard.call(e,gameModel.player2)},b)):h.push(new cc.callFunc(function(){gameModel.destroyCard(e.model)},b))}else 0>b.speedY?(m=b.getCrossPointX.call(b,f),k=Math.sqrt((e.x-m)*(e.x-m)+(e.y-f)*(e.y-f))/k,h.push(new cc.moveTo(k,m,f)),m>-dimens.card_size.width/2&&m<cc.winSize.width+dimens.card_size.width/2?h.push(new cc.callFunc(function(){e.playerTakeCard.call(e,gameModel.player1)},
b)):h.push(new cc.callFunc(function(){gameModel.destroyCard(e.model)},b))):0==b.speedY&&(0>b.speedX?(k=(e.x- -dimens.card_size.width/2)/k,h.push(new cc.moveTo(k,-dimens.card_size.width/2,e.y)),h.push(new cc.callFunc(function(){gameModel.destroyCard(e.model)},b))):0<b.speedX&&(k=(cc.winSize.width+dimens.card_size.width/2-e.x)/k,h.push(new cc.moveTo(k,cc.winSize.width+dimens.card_size.width/2,e.y)),h.push(new cc.callFunc(function(){gameModel.destroyCard(e.model)},b))));h.length&&e.runAction(new cc.sequence(h))}}})},
playerTakeCard:function(a){a.canTakeCard()?(this.isNewHand=!0,this.setTag(0),a.addHand(this.model),this.alreadyTaken=!0,cc.eventManager.removeListener(this.listener)):(this.stopAllActions(),gameModel.destroyCard(this.model))},getCrossPointX:function(a){return(a-this.y)*this.speedX/this.speedY+this.x},render:function(){this.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("card-"+SUIT_ARRAY[this.model.get("suit")]+".png"));this.numberSprite.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("number-"+
this.model.get("number")+".png"));this.numberDownSprite.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("number-"+this.model.get("number")+".png"))},onEnter:function(){this._super();this.initEvent();this.render()},onExit:function(){this.closeEvent();this._super()},initEvent:function(){cc.eventManager.addListener(this.listener,this);this.model.on("destroy",this.onDestroy,this)},closeEvent:function(){cc.eventManager.removeListener(this.listener);this.model.off("destroy",this.onDestroy)},onDestroy:function(){this.removeFromParent(!0)},
getFlipToFrontSequence:function(){return new cc.sequence(new cc.scaleTo(times.flip/2,0,1),new cc.callFunc(function(){this.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("card-"+SUIT_ARRAY[this.model.get("suit")]+".png"));this.numberSprite.setVisible(!0);this.numberDownSprite.setVisible(!0)},this),new cc.scaleTo(times.flip/2,1,1))},getFlipToBackSequence:function(){return new cc.sequence(new cc.scaleTo(times.flip/2,0,1),new cc.callFunc(function(){this.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("card-back.png"));
this.numberSprite.setVisible(!1);this.numberDownSprite.setVisible(!1)},this),new cc.scaleTo(times.flip/2,1,1))}});var STRAIGHT_MAP={"14-3-2":!0,"4-3-2":!0,"5-4-3":!0,"6-5-4":!0,"7-6-5":!0,"8-7-6":!0,"9-8-7":!0,"10-9-8":!0,"11-10-9":!0,"12-11-10":!0,"13-12-11":!0,"14-13-12":!0,"14-4-3-2":!0,"5-4-3-2":!0,"6-5-4-3":!0,"7-6-5-4":!0,"8-7-6-5":!0,"9-8-7-6":!0,"10-9-8-7":!0,"11-10-9-8":!0,"12-11-10-9":!0,"13-12-11-10":!0,"14-13-12-11":!0,"14-5-4-3-2":!0,"6-5-4-3-2":!0,"7-6-5-4-3":!0,"8-7-6-5-4":!0,"9-8-7-6-5":!0,"10-9-8-7-6":!0,"11-10-9-8-7":!0,"12-11-10-9-8":!0,"13-12-11-10-9":!0,"14-13-12-11-10":!0},PLAYER_POSITION_DOWN=
0,PLAYER_POSITION_UP=1,MAX_HAND=5,PlayerModel=Backbone.Model.extend({defaults:function(){return{money:1E3,hands:[]}},addHand:function(a){a._owned=!0;this.get("hands").push(a);this.sortHand()},sortHand:function(){var a=this.get("hands"),a=_.sortBy(a,function(a){return 100*(100-a.get("number"))+a.get("suit")},this);this.set("hands",a);this.trigger("change:hands",this)},canTakeCard:function(){return this.get("hands").length<MAX_HAND},isFlushStraight:function(a){return this.isFlush(a)&&this.isStraight(a)},
is4ofAKind:function(a){return a[0].get("number")===a[1].get("number")&&a[0].get("number")===a[2].get("number")&&a[0].get("number")===a[3].get("number")?a[0]:a[1].get("number")===a[2].get("number")&&a[1].get("number")===a[3].get("number")&&a[1].get("number")===a[4].get("number")?a[1]:!1},isFullHouse:function(a){return a[0].get("number")===a[1].get("number")&&a[0].get("number")===a[2].get("number")&&a[3].get("number")===a[4].get("number")?a[0]:a[0].get("number")===a[1].get("number")&&a[2].get("number")===
a[3].get("number")&&a[3].get("number")===a[4].get("number")?a[2]:!1},isStraight:function(a){a=_.map(a,function(a){return a.get("number")},this).join("-");return STRAIGHT_MAP[a]},is3ofAKind:function(a){return a[0].get("number")===a[1].get("number")&&a[0].get("number")===a[2].get("number")?a[0]:a[1].get("number")===a[2].get("number")&&a[1].get("number")===a[3].get("number")?a[1]:a[2].get("number")===a[3].get("number")&&a[2].get("number")===a[4].get("number")?a[2]:!1},isFlush:function(a){for(var b=a[0].get("suit"),
c=1;c<a.length;c++)if(b!=a[c].get("suit"))return!1;return!0},is2Pair:function(a){return a[0].get("number")===a[1].get("number")&&a[2].get("number")===a[3].get("number")||a[0].get("number")===a[1].get("number")&&a[3].get("number")===a[4].get("number")?a[0]:a[1].get("number")===a[2].get("number")&&a[3].get("number")===a[4].get("number")?a[1]:!1},isPair:function(a){return a[0].get("number")===a[1].get("number")?a[0]:a[1].get("number")===a[2].get("number")?a[1]:a[2].get("number")===a[3].get("number")?
a[2]:a[3].get("number")===a[4].get("number")?a[3]:!1},getFeature:function(){var a=this.get("hands"),b=[];_.each(a,function(a){b.push(a)},this);for(a=this.get("hands").length;a<MAX_HAND;a++)b.push(new PokerCardModel({number:-a,suit:4+a}));var c,d;this.isFlushStraight(b)?(a=1E4+10*b[0].get("number")+(10-b[0].get("suit")),c="\u540c\u82b1\u987a",d=50):(a=this.is4ofAKind(b))?(a=9E3+10*a.get("number")+(10-a.get("suit")),c="\u56db\u6761",d=40):(a=this.isFullHouse(b))?(a=8E3+10*a.get("number")+(10-a.get("suit")),
c="\u6ee1\u5802\u7ea2",d=30):this.isFlush(b)?(a=7E3+10*b[0].get("number")+(10-b[0].get("suit")),c="\u540c\u82b1",d=20):this.isStraight(b)?(a=6E3+10*b[0].get("number")+(10-b[0].get("suit")),c="\u987a\u5b50",d=15):(a=this.is3ofAKind(b))?(a=5E3+10*a.get("number")+(10-a.get("suit")),c="\u4e09\u6761",d=10):(a=this.is2Pair(b))?(a=4E3+10*a.get("number")+(10-a.get("suit")),c="\u4e24\u5bf9",d=4):(a=this.isPair(b))?(a=3E3+10*a.get("number")+(10-a.get("suit")),c="\u4e00\u5bf9",d=2):(0<b[0].get("number")?(a=
2E3+10*b[0].get("number")+(10-b[0].get("suit")),c="\u6563\u724c"):(a=0,c="\u6ca1\u724c"),d=1);return{power:a,type:c,rate:d}}}),PlayerSprite=cc.Sprite.extend({ctor:function(a){this._super();this.model=a.model;this.showHand=!1;this.lookHand=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("show-hand.png"));a=this.model.get("position")==PLAYER_POSITION_DOWN?dimens.player1Y/2:(dimens.player2Y+cc.winSize.height)/2;this.lookHand.attr({x:cc.winSize.width/2,y:a});this.addChild(this.lookHand,40);var b=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("player-bound.png"));
a=this.model.get("position")==PLAYER_POSITION_DOWN?dimens.player1Y:dimens.player2Y;b.attr({x:cc.winSize.width/2,y:a});this.addChild(b,0);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("money.png"));this.model.get("position")==PLAYER_POSITION_DOWN?a.attr({x:0,y:0,anchorX:0,anchorY:0}):a.attr({x:cc.winSize.width,y:cc.winSize.height,anchorX:0,anchorY:0,rotation:180});this.addChild(a);this.moneyLabel=new cc.LabelTTF(this.model.get("money"),"Arial",40);this.model.get("position")==PLAYER_POSITION_DOWN?
this.moneyLabel.attr({color:colors.tableLabel,x:45,y:25}):this.moneyLabel.attr({color:colors.tableLabel,x:405,y:775,rotation:180});this.addChild(this.moneyLabel,0);var c=this;cc.eventManager.addListener(cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,b){var c=b.getCurrentTarget(),g=c.convertToNodeSpace(a.getLocation()),c=c.getContentSize(),c=cc.rect(0,0,c.width,c.height);return cc.rectContainsPoint(c,g)?!0:!1},onTouchMoved:function(a,b){},
onTouchEnded:function(a,b){b.getCurrentTarget();c.toggleHand()}}),this.lookHand)},onEnter:function(){this._super();this.initEvent();this.render()},onExit:function(){this.closeEvent();this._super()},initEvent:function(){this.model.on("change:hands",this.onHandChange,this);this.model.on("change:money",this.onMoneyChange,this)},closeEvent:function(){this.model.off("change:hands",this.onHandChange);this.model.off("change:money",this.onMoneyChange)},renderMoney:function(){this.moneyLabel.setString(this.model.get("money"))},
onMoneyChange:function(){this.renderMoney()},onHandChange:function(){var a=this.model.get("hands");if(0!=a.length){var b=dimens.player1HandPosition.y,c=a.length*dimens.card_size.width+(a.length-1)*dimens.hand_line_card_padding,d,e;c<dimens.hand_line_width?(d=(dimens.hand_line_width-c)/2+dimens.card_size.width/2,e=dimens.card_size.width+dimens.hand_line_card_padding):(d=dimens.card_size.width/2,e=(dimens.hand_line_width-dimens.card_size.width)/(a.length-1));var f=0;_.each(a,function(a){a=this.getParent().getChildByName(a.cid);
var c,k,m;m=(d-cc.winSize.width/2)/400;c=400*Math.sin(m)+cc.winSize.width/2;k=400*Math.cos(m)+b-400+20;m*=50;this.model.get("position")==PLAYER_POSITION_UP&&(k=cc.winSize.height-k,c=cc.winSize.width-c);!a||a.x==d&&a.y==b||(a.movingAction&&a.stopAction(a.movingAction),a.movingAction=new cc.spawn(new cc.moveTo(times.card_sort,c,k),new cc.rotateTo(times.card_sort,m)),a.isNewHand&&(this.showHand||a.runAction(a.getFlipToBackSequence()),a.isNewHand=!1),a.runAction(a.movingAction));a.zIndex=f;f++;d+=e},
this);a.length==MAX_HAND&&gameModel.trigger("start-countdown",gameModel)}},toggleHand:function(){if("compare"!==gameModel.get("status")){this.showHand=!this.showHand;var a=this.model.get("hands");_.each(a,function(a){a=this.getParent().getChildByName(a.cid);this.showHand?a.runAction(a.getFlipToFrontSequence()):a.runAction(a.getFlipToBackSequence())},this)}},forceShowHand:function(){var a=this.model.get("hands");_.each(a,function(a){a=this.getParent().getChildByName(a.cid);a.numberSprite.isVisible()||
a.runAction(a.getFlipToFrontSequence())},this)},render:function(){}});var GENERATE_CARD_INTERVAL=5,MainLayer=cc.LayerColor.extend({sprite:null,ctor:function(a){this._super(colors.table);this.need_read_fight=a.need_read_fight;this.initAudio();this.model=a.model;this.player1=this.model.player1;this.player2=this.model.player2;this.addChild(this.player1Sprite=new PlayerSprite({model:this.player1}));this.addChild(this.player2Sprite=new PlayerSprite({model:this.player2}));a=new cc.MenuItemImage(cc.spriteFrameCache.getSpriteFrame("pause-default.png"),cc.spriteFrameCache.getSpriteFrame("pause-press.png"),
function(){},this);a.attr({x:0,y:cc.winSize.height/2,anchorX:0,anchorY:0.5});a=new cc.Menu([a]);a.x=0;a.y=0;this.addChild(a);this.betRateLabel1=new cc.LabelTTF("","Arial",30);this.betRateLabel1.attr({color:colors.tableLabel,x:cc.winSize.width,y:cc.winSize.height/2-18,anchorX:1});this.addChild(this.betRateLabel1,0);this.betRateLabel2=new cc.LabelTTF("","Arial",30);this.betRateLabel2.attr({color:colors.tableLabel,x:cc.winSize.width,y:cc.winSize.height/2+18,rotation:180,anchorX:0});this.addChild(this.betRateLabel2,
0);this.handTypeLabel1=new cc.LabelTTF("","Arial",50);this.handTypeLabel1.attr({color:colors.tableLabel,x:cc.winSize.width/2,y:120});this.addChild(this.handTypeLabel1,0);this.handTypeLabel1.setVisible(!1);this.handTypeLabel2=new cc.LabelTTF("","Arial",50);this.handTypeLabel2.attr({color:colors.tableLabel,x:cc.winSize.width/2,y:cc.winSize.height-120,rotation:180});this.addChild(this.handTypeLabel2,0);this.handTypeLabel2.setVisible(!1);this.winLoseLabel1=new cc.LabelTTF("","Arial",80);this.winLoseLabel1.attr({color:colors.tableLabel,
x:cc.winSize.width/2,y:250});this.addChild(this.winLoseLabel1,0);this.winLoseLabel1.setVisible(!1);this.winLoseLabel2=new cc.LabelTTF("","Arial",80);this.winLoseLabel2.attr({color:colors.tableLabel,x:cc.winSize.width/2,y:cc.winSize.height-250,rotation:180});this.addChild(this.winLoseLabel2,0);this.winLoseLabel2.setVisible(!1);this.countDownLabel=new cc.LabelTTF("","Arial",70);this.countDownLabel.attr({color:colors.tableLabel,x:cc.winSize.width/2,y:cc.winSize.height/2});this.addChild(this.countDownLabel,
50);this.countDownLabel.setVisible(!1);this.need_read_fight?(this.chipSprite=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("ready.png")),this.chipSprite.attr({x:cc.winSize.width/2,y:cc.winSize.height/2}),this.addChild(this.chipSprite),this.chipSprite.runAction(new cc.sequence(new cc.callFunc(function(){cc.audioEngine.playEffect(res.ready_mp3,!1)},this),new cc.delayTime(0.4),new cc.scaleTo(0.2,1,0),new cc.callFunc(function(){this.chipSprite.setSpriteFrame(cc.spriteFrameCache.getSpriteFrame("fight.png"))},
this),new cc.scaleTo(0.2,1,1),new cc.callFunc(function(){cc.audioEngine.playEffect(res.fight_mp3,!1)},this),new cc.delayTime(0.5),new cc.callFunc(function(){this.chipSprite.removeFromParent(!0);this.startNewRound()},this)))):this.startNewRound();this.initEvent();this.renderBetRate();return!0},renderBetRate:function(){this.betRateLabel1.setString("\u00d7"+this.model.get("betRate"));this.betRateLabel2.setString("\u00d7"+this.model.get("betRate"))},renderMoney:function(){},onBetRateChange:function(){var a=
new cc.sequence(new cc.scaleTo(0.2,2,2),new cc.scaleTo(0.2,1,1));this.betRateLabel1.runAction(a.clone());this.betRateLabel2.runAction(a.clone());this.renderBetRate()},initEvent:function(){this.model.on("change:betRate",this.onBetRateChange,this);this.model.on("start-countdown",this.startRoundCountDown,this)},startRoundCountDown:function(){if("countDown"!=gameModel.get("status")){gameModel.set("status","countDown");var a;a=gameModel.player1.canTakeCard()?0:180;this.countDownLabel.setVisible(!0);this.countDownLabel.setString(3);
this.countDownLabel.attr({rotation:a,scaleX:1,scaleY:1});this.countDownLabel.runAction(new cc.sequence(new cc.callFunc(function(){cc.audioEngine.playEffect(res.countdown3_mp3,!1)},this),new cc.scaleTo(1,3,3),new cc.callFunc(function(){cc.audioEngine.playEffect(res.countdown2_mp3,!1);this.countDownLabel.setString(2);this.countDownLabel.attr({scaleX:1,scaleY:1})},this),new cc.scaleTo(1,3,3),new cc.callFunc(function(){cc.audioEngine.playEffect(res.countdown1_mp3,!1);this.countDownLabel.setString(1);
this.countDownLabel.attr({scaleX:1,scaleY:1})},this),new cc.scaleTo(1,3,3),new cc.callFunc(function(){this.countDownLabel.setVisible(!1);this.model.clearNotOwnedCards();this.compareHands()},this)))}},compareHands:function(){this.model.set("status","compare");this.unschedule(this.schedulePerSec);this.player1Sprite.forceShowHand();this.player2Sprite.forceShowHand();var a=this.player1.getFeature(),b=this.player2.getFeature();this.handTypeLabel1.setVisible(!0);this.handTypeLabel1.setString(a.type);this.handTypeLabel2.setVisible(!0);
this.handTypeLabel2.setString(b.type);this.winLoseLabel1.setVisible(!0);this.winLoseLabel2.setVisible(!0);var c=this.model.get("betRate")*(a.rate+b.rate);a.power>b.power?(this.winLoseLabel1.setString("WIN"),this.winLoseLabel2.setString("LOSE"),this.giveMoney(c,this.player2Sprite,this.player1Sprite)):(this.winLoseLabel1.setString("LOSE"),this.winLoseLabel2.setString("WIN"),this.giveMoney(c,this.player1Sprite,this.player2Sprite));this.scheduleOnce(function(){this.model.set("betRate",this.model.get("betRate")+
1);this.startNewRound()},times.compare)},giveMoney:function(a,b,c){var d=Math.min(10,Math.floor(a/100)),e=0;10>d&&(e=Math.min(10,a%100/10));var f=0;10>e+d&&(f=Math.min(10,a%10));var g=a-f-10*e-100*d,h=0;for(a=0;a<d;a++){var k=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("token-black.png"));k.attr({x:b.moneyLabel.x+20*Math.random()-10,y:b.moneyLabel.y+20*Math.random()-10});this.addChild(k,h);(function(a){a.runAction(new cc.sequence(new cc.delayTime(h),new cc.callFunc(function(){b.model.set("money",
b.model.get("money")-100)},this),new cc.moveTo(times.giveMoney,c.moneyLabel.x,c.moneyLabel.y),new cc.callFunc(function(){c.model.set("money",c.model.get("money")+100);a.removeFromParent(!0)},this)))})(k,h);h+=0.1}for(a=0;a<e;a++)k=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("token-red.png")),k.attr({x:b.moneyLabel.x+20*Math.random()-10,y:b.moneyLabel.y+20*Math.random()-10}),this.addChild(k,h),function(a){a.runAction(new cc.sequence(new cc.delayTime(h),new cc.callFunc(function(){b.model.set("money",
b.model.get("money")-10)},this),new cc.moveTo(times.giveMoney,c.moneyLabel.x,c.moneyLabel.y),new cc.callFunc(function(){c.model.set("money",c.model.get("money")+10);a.removeFromParent(!0)},this)))}(k,h),h+=0.1;for(a=0;a<f;a++)k=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("token-green.png")),k.attr({x:b.moneyLabel.x+20*Math.random()-10,y:b.moneyLabel.y+20*Math.random()-10}),this.addChild(k,h),function(a){a.runAction(new cc.sequence(new cc.delayTime(h),new cc.callFunc(function(){b.model.set("money",
b.model.get("money")-1)},this),new cc.moveTo(times.giveMoney,c.moneyLabel.x,c.moneyLabel.y),new cc.callFunc(function(){c.model.set("money",c.model.get("money")+1);a.removeFromParent(!0)},this)))}(k,h),h+=0.1;this.scheduleOnce(function(){b.model.set("money",b.model.get("money")-g);c.model.set("money",c.model.get("money")+g)},h)},startNewRound:function(){this.model.set("status","game");this.model.generateCardCountDown=0;this.handTypeLabel1.setVisible(!1);this.handTypeLabel2.setVisible(!1);this.winLoseLabel1.setVisible(!1);
this.winLoseLabel2.setVisible(!1);this.player1.set("hands",[]);this.player2.set("hands",[]);this.model.clearCards();this.model.newDeck();var a=this;null==this.schedulePerSec&&(this.schedulePerSec=function(){"game"==a.model.get("status")&&(0>=a.model.generateCardCountDown&&(a.generateCards.call(a),a.model.generateCardCountDown=GENERATE_CARD_INTERVAL),a.model.generateCardCountDown--,a.model.totalTime++)});this.schedule(this.schedulePerSec,1)},generateCards:function(){var a=this.model.getPattern(),b=
_.sample([0,1]),c=_.sample([0,1]),a=a.get("list");_.each(a,function(a){var e=this.model.drawCard();if(null!=e){var f=new PokerCardSprite({model:e});f.attr({x:b?cc.winSize.width-a.start.x:a.start.x,y:a.start.y});this.addChild(f);var g=a.moveTime;14===e.get("number")&&(g/=2);f.runAction(new cc.sequence(new cc.delayTime(a.time),new cc.moveTo(g,b?cc.winSize.width-a.end.x:a.end.x,a.end.y),new cc.callFunc(function(){gameModel.destroyCard(e)},this)));var h=this.model.drawCard();if(null!=h){var f=new PokerCardSprite({model:h}),
k,m;c?(f.attr({x:a.start.x,y:cc.winSize.height-a.start.y}),k=a.end.x):(f.attr({x:cc.winSize.width-a.start.x,y:cc.winSize.height-a.start.y}),k=cc.winSize.width-a.end.x);m=cc.winSize.height-a.end.y;this.addChild(f);g=a.moveTime;14===h.get("number")&&(g/=2);f.runAction(new cc.sequence(new cc.delayTime(a.time),new cc.moveTo(g,k,m),new cc.callFunc(function(){gameModel.destroyCard(h)},this)))}}},this)},initAudio:function(){var a=cc.sys.localStorage.getItem("sound");this.sound=null!=a?a:0.5;cc.audioEngine.setEffectsVolume(this.sound)}}),
GameModel=Backbone.Model.extend({initialize:function(){this.countDown=this.maxCountDown=60;this.generateCardCountDown=0;this.set("betRate",1);this.set("status","ready");this.totalTime=0;this.cidToModel={};this.player1=new PlayerModel({position:PLAYER_POSITION_DOWN,playerType:"player"});this.player2=new PlayerModel({position:PLAYER_POSITION_UP,playerType:"player"});this.patternPool=[new PatternModel,new Pattern2Model,new Pattern3Model,new Pattern4Model,new Pattern5Model,new Pattern6Model]},newDeck:function(){this.deck=
newDeck();this.discardDeck=[]},drawCard:function(){var a=this.deck.pop();a||(this.deck=_.shuffle(this.discardDeck),this.discardDeck=[],a=this.deck.pop());a&&(this.cidToModel[a.cid]=a,a._owned=!1);return a},clearNotOwnedCards:function(){var a=[];_.each(this.cidToModel,function(b){null==b||b._owned||a.push(b)},this);_.each(a,function(a){this.destroyCard(a)},this)},clearCards:function(){var a=[];_.each(this.cidToModel,function(b){null!=b&&a.push(b)},this);_.each(a,function(a){this.destroyCard(a)},this);
this.cidToModel={}},destroyCard:function(a){this.discardDeck.push(new PokerCardModel({number:a.get("number"),suit:a.get("suit")}));a.destroy();delete this.cidToModel[a.cid]},getPattern:function(){return _.sample(this.patternPool)}}),MainScene=cc.Scene.extend({onEnter:function(){this._super();if(!window.gameModel){window.gameModel=new GameModel;var a=new MainLayer({model:gameModel,need_read_fight:!0});this.addChild(a)}}});cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(!1);cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(450,800,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.spriteFrameCache.addSpriteFrames(res.game_plist);cc.director.runScene(new MainScene)},this)};cc.game.run();